            ...
            request_model = create_model(
                ...
                **{
                    k: (
                        ...
                        None if v.default is ... else (v.default if v.default is not _empty else None),
                    )
    ...
    def _wrap(
        ...
        async def wrapped(*args: Any, **kwargs: Any) -> Any:
            ...
            if instance._client is not None:
                ...
                print("Client is None, call:", full_method_name, params.model_dump(exclude_unset=True))
