...
def create_fl_component_from_func(
    ...
    """
    print(f"DEBUG: output_component_file={output_component_file} (type={type(output_component_file)})")
    if output_component_file and not isinstance(output_component_file, (str, bytes, os.PathLike)):
