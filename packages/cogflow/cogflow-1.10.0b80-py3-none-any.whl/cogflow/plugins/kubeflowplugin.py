...
output_component_file = "/home/jovyan/output/component.yaml"
...
class KubeflowPlugin:
    ...
    def create_fl_component_from_func(
        ...
        if output_component_file:
            print(type(output_component_file))
            if not isinstance(output_component_file, (str, bytes, os.PathLike)):
                raise TypeError("output_component_file must be a str, bytes, or os.PathLike object")
            os.makedirs(os.path.dirname(output_component_file), exist_ok=True)
