...
class FabricOpenAI(OpenAI):
    ...
    def __init__(
        ...
        **kwargs: t.Any,
        ...
        host = get_fabric_env_config().fabric_env_config.wl_host
        #TODO: Change when base_url is modified
        base_url = f"{host}/webapi/capacities/{self.capacity_id}/workloads/ML/AISkill/Automatic/v1/workspaces/{self.workspace_id}/artifacts/{self.artifact_id}/aiassistant/openai"
