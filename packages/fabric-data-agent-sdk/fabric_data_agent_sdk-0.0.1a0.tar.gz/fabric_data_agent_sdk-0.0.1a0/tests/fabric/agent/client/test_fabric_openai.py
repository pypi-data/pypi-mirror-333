...
class TestFabricOpenAI(unittest.TestCase):
    ...
    @patch('fabric.agent.client._fabric_openai.get_fabric_env_config')
    @patch('fabric.agent.client._fabric_openai.get_artifact_by_id_or_name')
    @patch('fabric.agent.client._fabric_openai.get_workspace_capacity_id')
    @patch('fabric.agent.client._fabric_openai.resolve_workspace_name_and_id')
    def setUp(
        self,
    ...
    @patch('fabric.agent.client._fabric_openai.SynapseTokenProvider')
