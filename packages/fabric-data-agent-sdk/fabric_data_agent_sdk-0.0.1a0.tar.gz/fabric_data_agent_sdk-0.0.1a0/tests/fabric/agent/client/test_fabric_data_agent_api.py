...
class TestFabricDataAgentAPI(unittest.TestCase):
    ...
    @patch('fabric.agent.client._fabric_data_agent_api.get_artifact_by_id_or_name')
    @patch('fabric.agent.client._fabric_data_agent_api.get_workspace_capacity_id')
    @patch('fabric.agent.client._fabric_data_agent_api.resolve_workspace_name_and_id')
