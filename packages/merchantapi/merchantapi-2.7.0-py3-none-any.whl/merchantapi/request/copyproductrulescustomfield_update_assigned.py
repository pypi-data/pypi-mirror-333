...
class CopyProductRulesCustomFieldUpdateAssigned(merchantapi.abstract.Request):
	...
	def set_copy_product_rules_id(self, copy_product_rules_id: int) -> 'CopyProductRulesCustomFieldUpdateAssigned':
		"""
	...
	def set_copy_product_rules_name(self, copy_product_rules_name: str) -> 'CopyProductRulesCustomFieldUpdateAssigned':
		"""
	...
	def set_module_code(self, module_code: str) -> 'CopyProductRulesCustomFieldUpdateAssigned':
		"""
		Set Module_Code.
	...
	def set_field_code(self, field_code: str) -> 'CopyProductRulesCustomFieldUpdateAssigned':
		"""
		Set Field_Code.

		:param field_code: str
		:returns: CopyProductRulesCustomFieldUpdateAssigned
		"""
	...
	def set_assigned(self, assigned: bool) -> 'CopyProductRulesCustomFieldUpdateAssigned':
		"""
		Set Assigned.
	...
	def send(self) -> 'merchantapi.response.CopyProductRulesCustomFieldUpdateAssigned':
		return super().send()

	def create_response(self, http_response: HttpResponse, data) -> 'CopyProductRulesCustomFieldUpdateAssigned':
		"""
		...
		return merchantapi.response.CopyProductRulesCustomFieldUpdateAssigned(self, http_response, data)
	...
	def to_dict(self) -> dict:
		...
		data['Field_Code'] = self.field_code
