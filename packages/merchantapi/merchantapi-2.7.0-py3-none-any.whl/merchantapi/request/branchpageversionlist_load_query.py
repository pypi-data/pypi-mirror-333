...
class BranchPageVersionListLoadQuery(ListQueryRequest):
	...
	def set_branch_id(self, branch_id: int) -> 'BranchPageVersionListLoadQuery':
		"""
		Set Branch_ID.
	...
	def set_edit_branch(self, edit_branch: str) -> 'BranchPageVersionListLoadQuery':
		"""
		Set Edit_Branch.
	...
	def set_branch_name(self, branch_name: str) -> 'BranchPageVersionListLoadQuery':
		"""
		Set Branch_Name.
	...
	def set_changeset_id(self, changeset_id: int) -> 'BranchPageVersionListLoadQuery':
		"""
		Set Changeset_ID.
	...
	def send(self) -> 'merchantapi.response.BranchPageVersionListLoadQuery':
		return super().send()

	def create_response(self, http_response: HttpResponse, data) -> 'BranchPageVersionListLoadQuery':
		"""
		...
		return merchantapi.response.BranchPageVersionListLoadQuery(self, http_response, data)
