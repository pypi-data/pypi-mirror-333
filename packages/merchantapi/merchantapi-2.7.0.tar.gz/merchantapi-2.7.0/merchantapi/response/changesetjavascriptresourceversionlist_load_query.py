...
class ChangesetJavaScriptResourceVersionListLoadQuery(ListQueryResponse):
	...
	def get_changeset_javascript_resource_versions(self):
		"""
		Get changeset_javascript_resource_versions.
	...
	def get_changeset_java_script_resource_versions(self):
		# Alias of get_changeset_javascript_resource_versions
		return self.get_changeset_javascript_resource_versions()
