...
from app.middleware import ws_message_handler_manager
from core.base.schema import Breakpoint
from core.tool.rpc.base import RpcTool
from infrastructure.event_driven.ws.ws_message_handler_manager import WsMessageHandlerManager
from infrastructure.rpc.message import RpcToolCallResponseMessage, RpcMessageTypeEnum
from infrastructure.rpc.message_handler import RpcToolCallResponseMessageHandler
...
class ToolCallWsInterruptGraph(ToolCallInterruptGraph, RpcToolCallResponseMessageHandler):
    ...
    def _on_tool_call(self, selected_tool: BaseTool, tool_call: ToolCall, task: Any):
        ...
        if isinstance(selected_tool, RpcTool):
            ...
            ws_message_handler_manager.add_message_handler(
