...
from core.pattern.rewoo import CotReWooGraph
from scenario.prebuilt.tools.samplas.simulator import abc_music_tool
from scenario.prebuilt.tools.samplas.simulator.eval_tool import eval_tool
...
class MyTestCase(unittest.TestCase):
    def test_cot_rewoo_graph(self):
        ...
        tools = [abc_music_tool, eval_tool]
