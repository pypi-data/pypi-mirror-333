...
if TYPE_CHECKING:
    ...
    from ..models.send_message_to_user_response_icons import (
        SendMessageToUserResponseIcons,
    )
    from ..models.send_message_to_user_response_root import (
        SendMessageToUserResponseRoot,
    )


T = TypeVar("T", bound="SendMessageToUserResponse")
...
class SendMessageToUserResponse:
    ...
    Attributes:
        ...
        blocks (Union[Unset, list['SendMessageToUserResponseBlocksArrayItemRef']]):
        channel (Union[Unset, str]): User Example: C02CAP3LAAG.
        icons (Union[Unset, SendMessageToUserResponseIcons]):
        message (Union[Unset, SendMessageToUserResponseMessage]):
        metadata (Union[Unset, SendMessageToUserResponseMetadata]):
        ok (Union[Unset, bool]):  Example: True.
        response_metadata (Union[Unset, SendMessageToUserResponseResponseMetadata]):
        root (Union[Unset, SendMessageToUserResponseRoot]):
    ...
    blocks: Union[Unset, list["SendMessageToUserResponseBlocksArrayItemRef"]] = UNSET
    channel: Union[Unset, str] = UNSET
    icons: Union[Unset, "SendMessageToUserResponseIcons"] = UNSET
    message: Union[Unset, "SendMessageToUserResponseMessage"] = UNSET
    metadata: Union[Unset, "SendMessageToUserResponseMetadata"] = UNSET
    ok: Union[Unset, bool] = UNSET
    response_metadata: Union[Unset, "SendMessageToUserResponseResponseMetadata"] = UNSET
    root: Union[Unset, "SendMessageToUserResponseRoot"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.blocks, Unset):
            blocks = []
            for (
                componentsschemas_send_message_to_user_response_blocks_item_data
            ) in self.blocks:
                componentsschemas_send_message_to_user_response_blocks_item = componentsschemas_send_message_to_user_response_blocks_item_data.to_dict()
                blocks.append(
                    componentsschemas_send_message_to_user_response_blocks_item
                )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for componentsschemas_send_message_to_user_response_blocks_item_data in (
            _blocks or []
        ):
            componentsschemas_send_message_to_user_response_blocks_item = (
                SendMessageToUserResponseBlocksArrayItemRef.from_dict(
                    componentsschemas_send_message_to_user_response_blocks_item_data
                )
            )

            blocks.append(componentsschemas_send_message_to_user_response_blocks_item)
        ...
        if isinstance(_icons, Unset):
            ...
            icons = SendMessageToUserResponseIcons.from_dict(_icons)
        ...
        if isinstance(_message, Unset):
            ...
            message = SendMessageToUserResponseMessage.from_dict(_message)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SendMessageToUserResponseMetadata.from_dict(_metadata)
        ...
        if isinstance(_response_metadata, Unset):
            ...
            response_metadata = SendMessageToUserResponseResponseMetadata.from_dict(
                _response_metadata
            )
        ...
        if isinstance(_root, Unset):
            ...
            root = SendMessageToUserResponseRoot.from_dict(_root)
        ...
        send_message_to_user_response = cls(
            app_id=app_id,
            blocks=blocks,
            channel=channel,
            icons=icons,
        ...
        send_message_to_user_response.additional_properties = d
        return send_message_to_user_response
