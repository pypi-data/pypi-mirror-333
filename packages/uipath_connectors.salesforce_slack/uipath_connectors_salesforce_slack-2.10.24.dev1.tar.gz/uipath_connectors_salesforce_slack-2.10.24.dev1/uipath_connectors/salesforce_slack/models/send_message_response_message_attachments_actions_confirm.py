...
T = TypeVar("T", bound="SendMessageResponseMessageAttachmentsActionsConfirm")


@_attrs_define
class SendMessageResponseMessageAttachmentsActionsConfirm:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        send_message_response_message_attachments_actions_confirm = cls(
        ...
        send_message_response_message_attachments_actions_confirm.additional_properties = d
        return send_message_response_message_attachments_actions_confirm
