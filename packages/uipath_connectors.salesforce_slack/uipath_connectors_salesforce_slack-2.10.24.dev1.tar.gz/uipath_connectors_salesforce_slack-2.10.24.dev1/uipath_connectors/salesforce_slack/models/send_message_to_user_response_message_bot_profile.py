...
T = TypeVar("T", bound="SendMessageToUserResponseMessageBotProfile")


@_attrs_define
class SendMessageToUserResponseMessageBotProfile:
    """
    Attributes:
        app_id (Union[Unset, str]):  Example: A44S6RJ2V.
        deleted (Union[Unset, bool]):
        icons (Union[Unset, SendMessageToUserResponseMessageBotProfileIcons]):
    ...
    icons: Union[Unset, "SendMessageToUserResponseMessageBotProfileIcons"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_icons, Unset):
            ...
            icons = SendMessageToUserResponseMessageBotProfileIcons.from_dict(_icons)
        ...
        send_message_to_user_response_message_bot_profile = cls(
            app_id=app_id,
            deleted=deleted,
            icons=icons,
            id=id,
        ...
        send_message_to_user_response_message_bot_profile.additional_properties = d
        return send_message_to_user_response_message_bot_profile
