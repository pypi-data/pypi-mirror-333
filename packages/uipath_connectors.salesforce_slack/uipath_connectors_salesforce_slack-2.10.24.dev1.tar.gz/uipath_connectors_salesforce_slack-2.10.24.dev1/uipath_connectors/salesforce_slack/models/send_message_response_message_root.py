...
T = TypeVar("T", bound="SendMessageResponseMessageRoot")


@_attrs_define
class SendMessageResponseMessageRoot:
    """
    Attributes:
        app_id (Union[Unset, str]):  Example: A02CEJTE85R.
        blocks (Union[Unset, list['SendMessageResponseMessageRootBlocksArrayItemRef']]):
        bot_id (Union[Unset, str]):  Example: B02DYM5F1ST.
        icons (Union[Unset, SendMessageResponseMessageRootIcons]):
        is_locked (Union[Unset, bool]):
        latest_reply (Union[Unset, str]):  Example: 1675233584.607969.
        metadata (Union[Unset, SendMessageResponseMessageRootMetadata]):
    ...
    icons: Union[Unset, "SendMessageResponseMessageRootIcons"] = UNSET
    is_locked: Union[Unset, bool] = UNSET
    latest_reply: Union[Unset, str] = UNSET
    metadata: Union[Unset, "SendMessageResponseMessageRootMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.blocks, Unset):
            blocks = []
            for (
                componentsschemas_send_message_response_message_root_blocks_item_data
            ) in self.blocks:
                componentsschemas_send_message_response_message_root_blocks_item = componentsschemas_send_message_response_message_root_blocks_item_data.to_dict()
                blocks.append(
                    componentsschemas_send_message_response_message_root_blocks_item
                )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for componentsschemas_send_message_response_message_root_blocks_item_data in (
            _blocks or []
        ):
            componentsschemas_send_message_response_message_root_blocks_item = SendMessageResponseMessageRootBlocksArrayItemRef.from_dict(
                componentsschemas_send_message_response_message_root_blocks_item_data
            )
        ...
        if isinstance(_icons, Unset):
            ...
            icons = SendMessageResponseMessageRootIcons.from_dict(_icons)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SendMessageResponseMessageRootMetadata.from_dict(_metadata)
        ...
        send_message_response_message_root = cls(
            app_id=app_id,
            blocks=blocks,
            bot_id=bot_id,
            icons=icons,
        ...
        send_message_response_message_root.additional_properties = d
        return send_message_response_message_root
