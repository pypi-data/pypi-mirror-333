...
T = TypeVar("T", bound="SetChannelTopicResponsePurpose")


@_attrs_define
class SetChannelTopicResponsePurpose:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        set_channel_topic_response_purpose = cls(
            creator=creator,
            last_set=last_set,
            value=value,
        )

        set_channel_topic_response_purpose.additional_properties = d
        return set_channel_topic_response_purpose
