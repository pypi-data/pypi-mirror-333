...
if TYPE_CHECKING:
    ...
    from ..models.conversations_join_response_topic import (
        ConversationsJoinResponseTopic,
    )


T = TypeVar("T", bound="ConversationsJoinResponse")
...
class ConversationsJoinResponse:
    ...
    Attributes:
        ...
        purpose (Union[Unset, ConversationsJoinResponsePurpose]):
        topic (Union[Unset, ConversationsJoinResponseTopic]):
    ...
    purpose: Union[Unset, "ConversationsJoinResponsePurpose"] = UNSET
    topic: Union[Unset, "ConversationsJoinResponseTopic"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_purpose, Unset):
            ...
            purpose = ConversationsJoinResponsePurpose.from_dict(_purpose)
        ...
        if isinstance(_topic, Unset):
            ...
            topic = ConversationsJoinResponseTopic.from_dict(_topic)

        unlinked = d.pop("unlinked", UNSET)

        conversations_join_response = cls(
            created=created,
            creator=creator,
            id=id,
        ...
        conversations_join_response.additional_properties = d
        return conversations_join_response
