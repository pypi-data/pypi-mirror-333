...
T = TypeVar("T", bound="SendMessageToUserRequestAttachmentsActionsConfirm")


@_attrs_define
class SendMessageToUserRequestAttachmentsActionsConfirm:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        send_message_to_user_request_attachments_actions_confirm = cls(
        ...
        send_message_to_user_request_attachments_actions_confirm.additional_properties = d
        return send_message_to_user_request_attachments_actions_confirm
