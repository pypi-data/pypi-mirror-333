...
T = TypeVar("T", bound="SendMessageToUserRequest")
...
class SendMessageToUserRequest:
    ...
    Attributes:
        ...
        message_to_send (str): The formatted text of the message to be sent. This is also the main 'block' section text
            Example: string.
        attachments (Union[Unset, list['SendMessageToUserRequestAttachmentsArrayItemRef']]):
        ...
        metadata (Union[Unset, SendMessageToUserRequestMetadata]):
        mrkdwn (Union[Unset, bool]):  Example: True.
        parse (Union[Unset, SendMessageToUserRequestFormattingOptionsParse]): Change how messages are treated. Pass
    ...
    message_to_send: str
    attachments: Union[
        Unset, list["SendMessageToUserRequestAttachmentsArrayItemRef"]
    ] = UNSET
    ...
    metadata: Union[Unset, "SendMessageToUserRequestMetadata"] = UNSET
    mrkdwn: Union[Unset, bool] = UNSET
    parse: Union[Unset, SendMessageToUserRequestFormattingOptionsParse] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.attachments, Unset):
            attachments = []
            for (
                componentsschemas_send_message_to_user_request_attachments_item_data
            ) in self.attachments:
                componentsschemas_send_message_to_user_request_attachments_item = componentsschemas_send_message_to_user_request_attachments_item_data.to_dict()
                attachments.append(
                    componentsschemas_send_message_to_user_request_attachments_item
                )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for componentsschemas_send_message_to_user_request_attachments_item_data in (
            _attachments or []
        ):
            componentsschemas_send_message_to_user_request_attachments_item = (
                SendMessageToUserRequestAttachmentsArrayItemRef.from_dict(
                    componentsschemas_send_message_to_user_request_attachments_item_data
                )
            )
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SendMessageToUserRequestMetadata.from_dict(_metadata)

        mrkdwn = d.pop("mrkdwn", UNSET)

        _parse = d.pop("parse", UNSET)
        parse: Union[Unset, SendMessageToUserRequestFormattingOptionsParse]
        if isinstance(_parse, Unset):
            parse = UNSET
        else:
            parse = SendMessageToUserRequestFormattingOptionsParse(_parse)
        ...
        send_message_to_user_request = cls(
            channel=channel,
        ...
        send_message_to_user_request.additional_properties = d
        return send_message_to_user_request
