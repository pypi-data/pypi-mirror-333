...
T = TypeVar("T", bound="SendReplyRequestAttachmentsActionsConfirm")


@_attrs_define
class SendReplyRequestAttachmentsActionsConfirm:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        send_reply_request_attachments_actions_confirm = cls(
        ...
        send_reply_request_attachments_actions_confirm.additional_properties = d
        return send_reply_request_attachments_actions_confirm
