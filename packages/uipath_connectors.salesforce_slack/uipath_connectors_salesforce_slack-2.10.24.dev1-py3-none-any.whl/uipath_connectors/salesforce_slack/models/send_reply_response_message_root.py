...
T = TypeVar("T", bound="SendReplyResponseMessageRoot")


@_attrs_define
class SendReplyResponseMessageRoot:
    """
    Attributes:
        app_id (Union[Unset, str]):  Example: A02CEJTE85R.
        blocks (Union[Unset, list['SendReplyResponseMessageRootBlocksArrayItemRef']]):
        bot_id (Union[Unset, str]):  Example: B02DYM5F1ST.
        icons (Union[Unset, SendReplyResponseMessageRootIcons]):
        is_locked (Union[Unset, bool]):
        latest_reply (Union[Unset, str]):  Example: 1675233584.607969.
        metadata (Union[Unset, SendReplyResponseMessageRootMetadata]):
    ...
    blocks: Union[Unset, list["SendReplyResponseMessageRootBlocksArrayItemRef"]] = UNSET
    bot_id: Union[Unset, str] = UNSET
    icons: Union[Unset, "SendReplyResponseMessageRootIcons"] = UNSET
    is_locked: Union[Unset, bool] = UNSET
    latest_reply: Union[Unset, str] = UNSET
    metadata: Union[Unset, "SendReplyResponseMessageRootMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.blocks, Unset):
            blocks = []
            for (
                componentsschemas_send_reply_response_message_root_blocks_item_data
            ) in self.blocks:
                componentsschemas_send_reply_response_message_root_blocks_item = componentsschemas_send_reply_response_message_root_blocks_item_data.to_dict()
                blocks.append(
                    componentsschemas_send_reply_response_message_root_blocks_item
                )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for componentsschemas_send_reply_response_message_root_blocks_item_data in (
            _blocks or []
        ):
            componentsschemas_send_reply_response_message_root_blocks_item = (
                SendReplyResponseMessageRootBlocksArrayItemRef.from_dict(
                    componentsschemas_send_reply_response_message_root_blocks_item_data
                )
            )
        ...
        if isinstance(_icons, Unset):
            ...
            icons = SendReplyResponseMessageRootIcons.from_dict(_icons)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SendReplyResponseMessageRootMetadata.from_dict(_metadata)
        ...
        send_reply_response_message_root = cls(
            app_id=app_id,
            blocks=blocks,
            bot_id=bot_id,
            icons=icons,
        ...
        send_reply_response_message_root.additional_properties = d
        return send_reply_response_message_root
