...
T = TypeVar("T", bound="SendReplyResponseMessageBotProfileIcons")


@_attrs_define
class SendReplyResponseMessageBotProfileIcons:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        send_reply_response_message_bot_profile_icons = cls(
            image_36=image_36,
            image_48=image_48,
            image_72=image_72,
        )

        send_reply_response_message_bot_profile_icons.additional_properties = d
        return send_reply_response_message_bot_profile_icons
