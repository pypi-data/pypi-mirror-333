...
T = TypeVar("T", bound="SendReplyResponseMessageAttachmentsActionsConfirm")


@_attrs_define
class SendReplyResponseMessageAttachmentsActionsConfirm:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        send_reply_response_message_attachments_actions_confirm = cls(
        ...
        send_reply_response_message_attachments_actions_confirm.additional_properties = d
        return send_reply_response_message_attachments_actions_confirm
