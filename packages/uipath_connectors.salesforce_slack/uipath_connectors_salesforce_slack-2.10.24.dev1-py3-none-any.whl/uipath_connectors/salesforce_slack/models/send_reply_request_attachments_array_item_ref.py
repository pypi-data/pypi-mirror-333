...
T = TypeVar("T", bound="SendReplyRequestAttachmentsArrayItemRef")


@_attrs_define
class SendReplyRequestAttachmentsArrayItemRef:
    """
    Attributes:
        actions (Union[Unset, list['SendReplyRequestAttachmentsActionsArrayItemRef']]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.actions, Unset):
            actions = []
            for (
                componentsschemas_send_reply_request_attachments_actions_item_data
            ) in self.actions:
                componentsschemas_send_reply_request_attachments_actions_item = componentsschemas_send_reply_request_attachments_actions_item_data.to_dict()
                actions.append(
                    componentsschemas_send_reply_request_attachments_actions_item
                )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for componentsschemas_send_reply_request_attachments_actions_item_data in (
            _actions or []
        ):
            componentsschemas_send_reply_request_attachments_actions_item = (
                SendReplyRequestAttachmentsActionsArrayItemRef.from_dict(
                    componentsschemas_send_reply_request_attachments_actions_item_data
                )
            )
        ...
        send_reply_request_attachments_array_item_ref = cls(
            actions=actions,
        ...
        send_reply_request_attachments_array_item_ref.additional_properties = d
        return send_reply_request_attachments_array_item_ref
