...
T = TypeVar("T", bound="SendReplyResponseBlocksText")


@_attrs_define
class SendReplyResponseBlocksText:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        send_reply_response_blocks_text = cls(
            emoji=emoji,
            text=text,
            type_=type_,
        )

        send_reply_response_blocks_text.additional_properties = d
        return send_reply_response_blocks_text
