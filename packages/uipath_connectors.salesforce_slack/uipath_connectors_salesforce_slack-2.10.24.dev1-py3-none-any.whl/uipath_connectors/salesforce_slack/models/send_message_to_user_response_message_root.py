...
T = TypeVar("T", bound="SendMessageToUserResponseMessageRoot")


@_attrs_define
class SendMessageToUserResponseMessageRoot:
    """
    Attributes:
        app_id (Union[Unset, str]):  Example: A02CEJTE85R.
        blocks (Union[Unset, list['SendMessageToUserResponseMessageRootBlocksArrayItemRef']]):
        bot_id (Union[Unset, str]):  Example: B02DYM5F1ST.
        icons (Union[Unset, SendMessageToUserResponseMessageRootIcons]):
        is_locked (Union[Unset, bool]):
        latest_reply (Union[Unset, str]):  Example: 1675233584.607969.
        metadata (Union[Unset, SendMessageToUserResponseMessageRootMetadata]):
    ...
    blocks: Union[
        Unset, list["SendMessageToUserResponseMessageRootBlocksArrayItemRef"]
    ] = UNSET
    bot_id: Union[Unset, str] = UNSET
    icons: Union[Unset, "SendMessageToUserResponseMessageRootIcons"] = UNSET
    is_locked: Union[Unset, bool] = UNSET
    latest_reply: Union[Unset, str] = UNSET
    metadata: Union[Unset, "SendMessageToUserResponseMessageRootMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.blocks, Unset):
            blocks = []
            for componentsschemas_send_message_to_user_response_message_root_blocks_item_data in self.blocks:
                componentsschemas_send_message_to_user_response_message_root_blocks_item = componentsschemas_send_message_to_user_response_message_root_blocks_item_data.to_dict()
                blocks.append(
                    componentsschemas_send_message_to_user_response_message_root_blocks_item
                )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for componentsschemas_send_message_to_user_response_message_root_blocks_item_data in (
            _blocks or []
        ):
            componentsschemas_send_message_to_user_response_message_root_blocks_item = SendMessageToUserResponseMessageRootBlocksArrayItemRef.from_dict(
                componentsschemas_send_message_to_user_response_message_root_blocks_item_data
            )
        ...
        if isinstance(_icons, Unset):
            ...
            icons = SendMessageToUserResponseMessageRootIcons.from_dict(_icons)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SendMessageToUserResponseMessageRootMetadata.from_dict(_metadata)
        ...
        send_message_to_user_response_message_root = cls(
            app_id=app_id,
            blocks=blocks,
            bot_id=bot_id,
            icons=icons,
        ...
        send_message_to_user_response_message_root.additional_properties = d
        return send_message_to_user_response_message_root
