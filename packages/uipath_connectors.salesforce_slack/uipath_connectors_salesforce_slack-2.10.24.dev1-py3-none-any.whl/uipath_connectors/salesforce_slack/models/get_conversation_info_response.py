...
T = TypeVar("T", bound="GetConversationInfoResponse")
...
class GetConversationInfoResponse:
    """
    Attributes:
        created (Union[Unset, int]):  Example: 1.629792267E9.
        creator (Union[Unset, str]):  Example: UCUFVVCKS.
        id (Union[Unset, str]):  Example: C02C4TL46CT.
        ...
        last_read (Union[Unset, str]):  Example: 1631093304.000300.
        locale (Union[Unset, str]):  Example: en-US.
        name (Union[Unset, str]):  Example: periodic-test-3.
        name_normalized (Union[Unset, str]):  Example: periodic-test-3.
        num_members (Union[Unset, int]):  Example: 1.0.
        purpose (Union[Unset, GetConversationInfoResponsePurpose]):
        shared_team_ids (Union[Unset, list[str]]):  Example: ['TCU0VUNLT'].
        topic (Union[Unset, GetConversationInfoResponseTopic]):
    ...
    purpose: Union[Unset, "GetConversationInfoResponsePurpose"] = UNSET
    shared_team_ids: Union[Unset, list[str]] = UNSET
    topic: Union[Unset, "GetConversationInfoResponseTopic"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_purpose, Unset):
            ...
            purpose = GetConversationInfoResponsePurpose.from_dict(_purpose)
        ...
        if isinstance(_topic, Unset):
            ...
            topic = GetConversationInfoResponseTopic.from_dict(_topic)

        unlinked = d.pop("unlinked", UNSET)

        get_conversation_info_response = cls(
            created=created,
            creator=creator,
            id=id,
        ...
        get_conversation_info_response.additional_properties = d
        return get_conversation_info_response
