...
T = TypeVar("T", bound="SendReplyResponseRoot")


@_attrs_define
class SendReplyResponseRoot:
    """
    Attributes:
        app_id (Union[Unset, str]):  Example: A02CEJTE85R.
        blocks (Union[Unset, list['SendReplyResponseRootBlocksArrayItemRef']]):
        bot_id (Union[Unset, str]):  Example: B02DYM5F1ST.
        icons (Union[Unset, SendReplyResponseRootIcons]):
        is_locked (Union[Unset, bool]):
        latest_reply (Union[Unset, str]):  Example: 1675233584.607969.
        metadata (Union[Unset, SendReplyResponseRootMetadata]):
    ...
    blocks: Union[Unset, list["SendReplyResponseRootBlocksArrayItemRef"]] = UNSET
    bot_id: Union[Unset, str] = UNSET
    icons: Union[Unset, "SendReplyResponseRootIcons"] = UNSET
    is_locked: Union[Unset, bool] = UNSET
    latest_reply: Union[Unset, str] = UNSET
    metadata: Union[Unset, "SendReplyResponseRootMetadata"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.blocks, Unset):
            blocks = []
            for (
                componentsschemas_send_reply_response_root_blocks_item_data
            ) in self.blocks:
                componentsschemas_send_reply_response_root_blocks_item = componentsschemas_send_reply_response_root_blocks_item_data.to_dict()
                blocks.append(componentsschemas_send_reply_response_root_blocks_item)
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        from ..models.send_reply_response_root_icons import SendReplyResponseRootIcons
        from ..models.send_reply_response_root_metadata import (
        ...
        for componentsschemas_send_reply_response_root_blocks_item_data in (
            _blocks or []
        ):
            componentsschemas_send_reply_response_root_blocks_item = (
                SendReplyResponseRootBlocksArrayItemRef.from_dict(
                    componentsschemas_send_reply_response_root_blocks_item_data
                )
            )
        ...
        if isinstance(_icons, Unset):
            ...
            icons = SendReplyResponseRootIcons.from_dict(_icons)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SendReplyResponseRootMetadata.from_dict(_metadata)
        ...
        send_reply_response_root.additional_properties = d
        return send_reply_response_root
