...
class SendReplyResponse(BaseModel):
    ...
    blocks: Optional[list["SendReplyResponseBlocksArrayItemRef"]] = None
    channel: Optional[str] = None
    icons: Optional["SendReplyResponseIcons"] = None
    message: Optional["SendReplyResponseMessage"] = None
    metadata: Optional["SendReplyResponseMetadata"] = None
    ok: Optional[bool] = None
    response_metadata: Optional["SendReplyResponseResponseMetadata"] = None
    root: Optional["SendReplyResponseRoot"] = None
