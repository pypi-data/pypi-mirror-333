...
class SendMessageToUserResponseRoot(BaseModel):
    ...
    blocks: Optional[list["SendMessageToUserResponseRootBlocksArrayItemRef"]] = None
    bot_id: Optional[str] = None
    icons: Optional["SendMessageToUserResponseRootIcons"] = None
    is_locked: Optional[bool] = None
    latest_reply: Optional[str] = None
    metadata: Optional["SendMessageToUserResponseRootMetadata"] = None
