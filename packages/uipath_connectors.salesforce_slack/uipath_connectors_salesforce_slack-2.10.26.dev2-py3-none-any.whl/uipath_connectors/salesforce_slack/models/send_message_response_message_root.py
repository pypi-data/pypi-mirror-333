...
class SendMessageResponseMessageRoot(BaseModel):
    ...
    blocks: Optional[list["SendMessageResponseMessageRootBlocksArrayItemRef"]] = None
    bot_id: Optional[str] = None
    icons: Optional["SendMessageResponseMessageRootIcons"] = None
    is_locked: Optional[bool] = None
    latest_reply: Optional[str] = None
    metadata: Optional["SendMessageResponseMessageRootMetadata"] = None
