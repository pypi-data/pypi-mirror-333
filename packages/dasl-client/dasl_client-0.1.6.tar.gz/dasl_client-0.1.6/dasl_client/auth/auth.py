...
from dasl_api import api, WorkspaceV1AuthenticateRequest, ApiClient, WorkspaceV1BeginAuthenticateRequest
...
class DatabricksSecretAuth(Authorization):
    ...
    def refresh(self):
        ...
        req = WorkspaceV1BeginAuthenticateRequest(
        ...
        for tries in range(3):
            try:
                secret_value = WorkspaceClient().secrets.get_secret(secret_name,"token")
                break
