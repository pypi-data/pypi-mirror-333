...
from dasl_api import api, WorkspaceV1AuthenticateRequest, ApiClient, WorkspaceV1RequestSecretRequest
...
class DatabricksSecretAuth(Authorization):
    ...
    def refresh(self):
        ...
        for tries in range(3):
            try:
                secret_value = base64.b64decode(WorkspaceClient().secrets.get_secret(secret_name,"token").value).decode('utf8')
                break
