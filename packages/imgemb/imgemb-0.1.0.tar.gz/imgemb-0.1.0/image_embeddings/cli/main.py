...
def parse_args(args: List[str]) -> argparse.Namespace:
    ...
    compare_parser.add_argument(
        "--method", choices=ImageEmbedder.VALID_METHODS, default='grid',
        help="Embedding method to use"
    )
    compare_parser.add_argument(
        "--grid-size", nargs=2, type=int, default=(4, 4),
    ...
    generate_parser.add_argument(
        "--output", help="Output JSON file to save embeddings"
    )
    generate_parser.add_argument(
        "--method", choices=ImageEmbedder.VALID_METHODS, default='grid',
        help="Embedding method to use"
    ...
    similar_parser.add_argument("image_dir", help="Directory containing images to search")
    ...
    try:
        if parsed_args.command == "compare":
            ...
            embedder = ImageEmbedder(
                ...
                grid_size=tuple(parsed_args.grid_size)
            )
