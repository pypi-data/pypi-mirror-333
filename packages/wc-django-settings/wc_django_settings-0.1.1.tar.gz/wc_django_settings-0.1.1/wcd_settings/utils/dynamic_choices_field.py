...
__all__ = (
    'DynamicChoicesMixin',
    'DynamicCharChoicesField',
    'DynamicIntegerChoicesField',
    'DynamicChoicesField',
)
...
class DynamicCharChoicesField(DynamicChoicesMixin, models.CharField):
    pass


class DynamicIntegerChoicesField(DynamicChoicesMixin, models.IntegerField):
    pass


DynamicChoicesField = DynamicCharChoicesField
