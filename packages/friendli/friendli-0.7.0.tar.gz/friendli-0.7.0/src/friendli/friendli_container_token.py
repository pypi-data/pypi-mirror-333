...
class BaseFriendliContainerToken(BaseSDK):
    pass


class SyncFriendliContainerToken(BaseFriendliContainerToken, SyncSDK):
    def tokenization(
        self,
        *,
        prompt: str,
...
class AsyncFriendliContainerToken(BaseFriendliContainerToken, AsyncSDK):
