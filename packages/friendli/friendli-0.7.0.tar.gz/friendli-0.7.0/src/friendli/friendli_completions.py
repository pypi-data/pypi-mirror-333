...
class BaseFriendliCompletions(BaseSDK):
    pass


class SyncFriendliCompletions(BaseFriendliCompletions, SyncSDK):
    def complete(
        self,
        *,
...
class AsyncFriendliCompletions(BaseFriendliCompletions, AsyncSDK):
    async def complete(
        self,
        *,
        dedicated_completions_body: Union[
