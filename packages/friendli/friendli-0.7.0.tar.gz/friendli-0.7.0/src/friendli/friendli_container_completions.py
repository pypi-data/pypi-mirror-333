...
from friendli.types import UNSET, BaseModel, OptionalNullable
from friendli.utils import eventstreaming, get_security_from_env

from .basesdk import AsyncSDK, BaseSDK, SyncSDK


class BaseFriendliContainerCompletions(BaseSDK):
    pass


class SyncFriendliContainerCompletions(BaseFriendliContainerCompletions, SyncSDK):
    def complete(
        self,
        *,
        request: Union[
...
class AsyncFriendliContainerCompletions(BaseFriendliContainerCompletions, AsyncSDK):
    async def complete(
        self,
        *,
        request: Union[
