...
class ContainerChatCompletionStreamBodyLogitBiasTypedDict(TypedDict):
...
class ContainerChatCompletionStreamBodyLogitBias(BaseModel):
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
...
class ContainerChatCompletionStreamBodyTypedDict(TypedDict):
    ...
    logit_bias: NotRequired[
        Nullable[ContainerChatCompletionStreamBodyLogitBiasTypedDict]
    ]
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
...
class ContainerChatCompletionStreamBody(BaseModel):
    ...
    logit_bias: OptionalNullable[ContainerChatCompletionStreamBodyLogitBias] = UNSET
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
