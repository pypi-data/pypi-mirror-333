...
CompletionsStreamDedicatedModelBodyWithPromptPromptTypedDict = TypeAliasType(
...
CompletionsStreamDedicatedModelBodyWithPromptPrompt = TypeAliasType(
    "CompletionsStreamDedicatedModelBodyWithPromptPrompt", Union[str, List[str]]
)
r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""


CompletionsStreamDedicatedModelBodyWithPromptSeedTypedDict = TypeAliasType(
    "CompletionsStreamDedicatedModelBodyWithPromptSeedTypedDict", Union[List[int], int]
)
...
CompletionsStreamDedicatedModelBodyWithPromptSeed = TypeAliasType(
    "CompletionsStreamDedicatedModelBodyWithPromptSeed", Union[List[int], int]
)
r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""


class CompletionsStreamDedicatedModelBodyWithPromptTypedDict(TypedDict):
    model: str
    ...
    prompt: CompletionsStreamDedicatedModelBodyWithPromptPromptTypedDict
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: NotRequired[
        Nullable[CompletionsStreamDedicatedModelBodyWithPromptSeedTypedDict]
    ]
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
...
class CompletionsStreamDedicatedModelBodyWithPrompt(BaseModel):
    model: str
    r"""ID of target endpoint. If you want to send request to specific adapter, use the format \"YOUR_ENDPOINT_ID:YOUR_ADAPTER_ROUTE\". Otherwise, you can just use \"YOUR_ENDPOINT_ID\" alone."""

    prompt: CompletionsStreamDedicatedModelBodyWithPromptPrompt
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: OptionalNullable[CompletionsStreamDedicatedModelBodyWithPromptSeed] = UNSET
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
