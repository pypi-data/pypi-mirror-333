...
CompletionsStreamServerlessModelBodyWithPromptPromptTypedDict = TypeAliasType(
...
CompletionsStreamServerlessModelBodyWithPromptPrompt = TypeAliasType(
    "CompletionsStreamServerlessModelBodyWithPromptPrompt", Union[str, List[str]]
)
r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""


CompletionsStreamServerlessModelBodyWithPromptSeedTypedDict = TypeAliasType(
    "CompletionsStreamServerlessModelBodyWithPromptSeedTypedDict", Union[List[int], int]
)
...
CompletionsStreamServerlessModelBodyWithPromptSeed = TypeAliasType(
    "CompletionsStreamServerlessModelBodyWithPromptSeed", Union[List[int], int]
)
r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""


class CompletionsStreamServerlessModelBodyWithPromptTypedDict(TypedDict):
    model: str
    ...
    prompt: CompletionsStreamServerlessModelBodyWithPromptPromptTypedDict
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: NotRequired[
        Nullable[CompletionsStreamServerlessModelBodyWithPromptSeedTypedDict]
    ]
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
...
class CompletionsStreamServerlessModelBodyWithPrompt(BaseModel):
    model: str
    r"""Code of the model to use. See [available model list](https://friendli.ai/docs/guides/serverless_endpoints/pricing#text-generation-models)."""

    prompt: CompletionsStreamServerlessModelBodyWithPromptPrompt
    r"""The prompt (i.e., input text) to generate completions for. Either `prompt` or `tokens` field is required."""
    ...
    **This field is unsupported when `response_format` is specified.**
    ...
    seed: OptionalNullable[CompletionsStreamServerlessModelBodyWithPromptSeed] = UNSET
    r"""Seed to control random procedure. If nothing is given, the API generate the seed randomly, use it for sampling, and return the seed along with the generated result. When using the `n` argument, you can pass a list of seed values to control all of the independent generations."""
