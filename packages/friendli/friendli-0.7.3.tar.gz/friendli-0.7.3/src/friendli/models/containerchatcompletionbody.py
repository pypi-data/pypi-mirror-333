...
class ContainerChatCompletionBodyLogitBiasTypedDict(TypedDict):
...
class ContainerChatCompletionBodyLogitBias(BaseModel):
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
...
class ContainerChatCompletionBodyTypedDict(TypedDict):
    ...
    logit_bias: NotRequired[Nullable[ContainerChatCompletionBodyLogitBiasTypedDict]]
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
...
class ContainerChatCompletionBody(BaseModel):
    ...
    logit_bias: OptionalNullable[ContainerChatCompletionBodyLogitBias] = UNSET
    r"""Accepts a JSON object that maps tokens to an associated bias value. Mathematically, the bias is added to the logits generated by the model prior to sampling. The exact effect will vary per model."""
