...
class BaseFriendliContainerChat(BaseSDK):
    pass


class SyncFriendliContainerChat(BaseFriendliContainerChat, SyncSDK):
    def complete(
        self,
        *,
        ...
        request = models.ContainerChatCompletionBody(
            ...
            logit_bias=utils.get_pydantic_model(
                logit_bias,
                OptionalNullable[models.ContainerChatCompletionBodyLogitBias],
            ),
            logprobs=logprobs,
    ...
    def stream(
        ...
        *,
        ...
        request = models.ContainerChatCompletionStreamBody(
            ...
            logit_bias=utils.get_pydantic_model(
                logit_bias,
                OptionalNullable[models.ContainerChatCompletionStreamBodyLogitBias],
            ),
            logprobs=logprobs,
            max_tokens=max_tokens,
            min_p=min_p,
...
class AsyncFriendliContainerChat(BaseFriendliContainerChat, AsyncSDK):
    async def complete(
        self,
        *,
        messages: Union[List[models.Message], List[models.MessageTypedDict]],
