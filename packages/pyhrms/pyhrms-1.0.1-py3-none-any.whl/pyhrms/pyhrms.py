...
# 20250224
（1）修复了重要的bug，峰提取过程中做alignment的时候，峰面积不太对，需要把按intensity排序改成按area排序

# 20250305
(1) 更新了peak_picking算法，提升20%效率
（2） 更新了split_peak_picking算法，降低了50%的内存消耗；
（3） 更新了peak_checking_split算法，降低了50%的内存消耗；
