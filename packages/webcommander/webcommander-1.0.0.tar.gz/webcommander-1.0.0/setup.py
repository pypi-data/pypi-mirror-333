...
def get_dependencies():
    return ["requests==2.31.0", "setuptools"]


setup(
    name='webcommander',
    version='1.0.0',
    description='Webcommander SDK',
    long_description=long_description,
    long_description_content_type='text/markdown',
    author='Ashiq Rahman',
    author_email='ashiq@webalive.com.au',
    url='https://github.com/WebCommanderCMS/wc_python_sdk',
    ...
    project_urls={
        'Documentation': 'https://developers.webcommander.com/',
    },
)
