...
class Core(Protocol):
    ...
    @abstractmethod
    def postprocess(self, input_data) -> Any:
        """
...
class PipelineStart(Protocol):

    def get_solution_quality_unit(self) -> str:
        """
        Returns the unit of the solution quality metric.

        :return: The unit of the solution quality metric
        """
        ...
