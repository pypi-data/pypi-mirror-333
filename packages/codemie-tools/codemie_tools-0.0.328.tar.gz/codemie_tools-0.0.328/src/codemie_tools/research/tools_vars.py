...
WEB_SCRAPPER_TOOL = ToolMetadata(
    ...
    label="Web Scraper",
    description="""
    A tool to scrape the web. Use this when you need to scrape a website. Input should be a url. The output will be the text content of the website.
    """.strip(),
    user_description="""
    Extracts text content from a specified web page.
