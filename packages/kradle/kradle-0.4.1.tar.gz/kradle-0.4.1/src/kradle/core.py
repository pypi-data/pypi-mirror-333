...
class MinecraftAgent:
    ...
    def __init__(
        ...
        memory: Optional[StandardMemory] = StandardMemory(),
    ...
    def _display_state(self, state: Observation) -> None:
        ...
        table = Table(box=box.ROUNDED, show_header=False, padding=(0, 1), border_style=self.color)
    ...
    def log(self, message: str, level: str = "info"):
        ...
        self._internal_api_client.logs.create(
            run_id=self.run_id, participant_id=self.participant_id, level=level, message=message
        )
