...
class Phone(CustomBaseModel):
    phone_number: Optional[str] = (Field(None, max_length=1000),)
    phone_type: Optional[str] = (Field(None, max_length=1000),)
    caller_name: Optional[str] = Field(None, max_length=100)


class Person(CustomBaseModel):
    tahoeId: Optional[str] = Field(None, max_length=100, alias="tahoe_id")
    ...
    person_type: Optional[str] = Field(
        "Owner", max_length=100, pattern="^(Owner|Relative|Neighbor|Associate)$"
    )
    relationship_to_owner: Optional[str] = Field(None, max_length=100)
...
class Mortgage(CustomBaseModel):
    ...
    recording_book: Optional[str] = Field(None, max_length=100)
    recording_page: Optional[str] = Field(None, max_length=100)
    lender_name: Optional[str] = Field(None, max_length=255)
    term_type: Optional[str] = Field(None, max_length=100)
    term: Optional[str] = Field(None, max_length=100)
    document_code: Optional[str] = Field(None, max_length=100)
...
class Loan(CustomBaseModel):
    ...
    financing_type: Optional[str] = Field(None, max_length=100)
...
class Foreclosure(CustomBaseModel):
    ...
    original_document_number: Optional[str] = Field(None, max_length=100)
    original_recording_book: Optional[str] = Field(None, max_length=100)
    original_recording_page: Optional[str] = Field(None, max_length=100)
...
class Lien(CustomBaseModel):
    ...
    fips: Optional[str] = Field(None, max_length=100)
    apn_unformatted: Optional[str] = Field(None, max_length=100)
    block: Optional[str] = Field(None, max_length=100)
    range: Optional[str] = Field(None, max_length=100)
    township: Optional[str] = Field(None, max_length=100)
    district: Optional[str] = Field(None, max_length=100)
    district_suffix: Optional[str] = Field(None, max_length=100)
    land_lot: Optional[str] = Field(None, max_length=100)
    lot_number: Optional[str] = Field(None, max_length=100)
    damar_document_code: Optional[str] = Field(None, max_length=100)
    document_type: Optional[str] = Field(None, max_length=100)
    document_number: Optional[str] = Field(None, max_length=100)
    recording_book: Optional[str] = Field(None, max_length=100)
    recording_page: Optional[str] = Field(None, max_length=100)
    tax_type: Optional[str] = Field(None, max_length=100)
    ...
    recording_book_page: Optional[str] = Field(None, max_length=100)
