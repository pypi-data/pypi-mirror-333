...
from ...interfaces import StructureInterface, MeshInterface
...
class MeshGeometry(BaseGeometry):
    ...
    def set_buffer(self, buffer: float, units: LENGTH_UNITS = None) -> None:
        ...
        """
        if self._parent_object._structure is None:
    ...
    def set_based_on_a_structure(self, structure: StructureInterface, buffer: float = None,
        ...
        self._set("structure", structure._name)

        # Assign the structure this mesh and the structure to the mesh
        if not isinstance(structure, StructureInterface):  # Check correct type without importing. All structures have this.
            raise ValueError("The 'structure' parameter must be an instance of StructureBase or a subclass.")
        structure._bulk_mesh = self._parent_object
        self._parent_object._structure = structure
    ...
    def set_directly_defined(self) -> None:
        ...
        """
        self._parent_object._structure = None
