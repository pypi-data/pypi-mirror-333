...
class Circle(Structure):
    ...
    def _get_trimesh(self, absolute: bool = False) -> trimesh.Trimesh:
        ...
        cylinder = trimesh.creation.cylinder(radius=1.0, height=self.z_span, sections=64)

        # Scale the cylinder to have the desired radii in x and y directions
        scale_matrix = np.diag([self.radius, self.radius_2, 1.0, 1.0])  # Scaling along x, y, and keep z unchanged
