...
class FDTDream:
    ...
    @classmethod
    def new_simulation(cls, filename: str = None, units: LENGTH_UNITS = "nm", variable_name: str = "sim") -> Simulation:
        """
        ...
        if print_declarations:
            print(f"\033[4mReplace the new_simulation() call with this to do exactly the same without "
                  ...
                  f"{variable_name} = FDTDream.new_simulation(r'{filename}', '{units}')\n\n")
    ...
    @classmethod
    def load_simulation(cls, path: str = None, units: LENGTH_UNITS = "nm", variable_name: str = "sim") -> Simulation:
        """
        ...
        if print_declarations:
            ...
            print(f"\033[4mReplace the load_simulation() call with this to do exactly the same without "
                  f"calling the file explorer.\033[0m\n\n"
                  f"{variable_name} = FDTDream.load_simulation(r'{path}', '{units}')\n")
    ...
    def load_base(cls, base_path: str = None, save_path: str = None, units: LENGTH_UNITS = "nm",
                  variable_name: str = "sim") -> Simulation:
        """
