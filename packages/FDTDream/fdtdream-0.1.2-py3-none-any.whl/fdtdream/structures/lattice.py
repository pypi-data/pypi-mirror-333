...
class Lattice(Structure):
    ...
    def _get_trimesh(self, absolute: bool = False) -> Polygon | MultiPolygon:
        ...
        if self._base_structure is None:
            ...
            base_poly = self._base_structure._get_trimesh(absolute)
            base_poly: Trimesh = base_poly.apply_translation(-self._base_structure._get_position(absolute))
