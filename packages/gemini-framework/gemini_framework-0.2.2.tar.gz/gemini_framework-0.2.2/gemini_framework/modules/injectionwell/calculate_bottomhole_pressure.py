...
class CalculateBottomholePressure(UnitModuleAbstract):
    ...
    def update_model_parameter(self, timestamp):
        ...
        well_param['friction_correlation'] = self.unit.parameters['property'][well_index][
            'injectionwell_friction_correlation']
        well_param['friction_correlation_2p'] = self.unit.parameters['property'][well_index][
            'injectionwell_friction_correlation_2p']
        well_param['correction_factors'] = self.unit.parameters['property'][well_index][
