...
class NativeInboundWithCustomTypesAsyncBase(AbstractPipelineStep):
    ...
    def check_and_apply_encryption_policy(self, inbound: Set[PersonWithOneToMRelation]) -> None:
        """
    ...
    def apply_encryption_to_dataset(self, inbound: Set[PersonWithOneToMRelation], fields_to_update: List[str], algorithm: str) -> Set[PersonWithOneToMRelation]:
        '''
    ...
    def get_fields_list(self, inbound: Set[PersonWithOneToMRelation]) -> List[str]:
        '''
            This method gets the field names from the given data type
        '''
        return [p for p in dir(PersonWithOneToMRelation) if isinstance(getattr(PersonWithOneToMRelation,p),property)]
