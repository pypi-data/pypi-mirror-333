...
class RecordWithNonRequiredValidationField(Enum):
    ...
    INTEGER_VALIDATION = 0, None, None, None
    STRING_VALIDATION = 1, None, None, None
    STRING_SIMPLE = 2, None, None, None
    ...
    @classmethod
    def get_fields_with_protection_policy(cls) -> List[RecordWithNonRequiredValidationField]:
        """
