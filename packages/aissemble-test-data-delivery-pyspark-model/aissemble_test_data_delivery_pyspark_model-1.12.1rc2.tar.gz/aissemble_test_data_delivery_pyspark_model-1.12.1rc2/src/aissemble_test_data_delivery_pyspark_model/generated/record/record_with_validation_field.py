...
class RecordWithValidationField(Enum):
    ...
    STRING_VALIDATION = 0, None, None, None
    INTEGER_VALIDATION = 1, None, None, None
    DECIMAL_VALIDATION = 2, None, None, None
    FLOAT_VALIDATION = 3, None, None, None
    REQUIRED_SIMPLE_TYPE = 4, None, None, None
    REQUIRED_COMPLEX_TYPE = 5, None, None, None
    ...
    @classmethod
    def get_fields_with_protection_policy(cls) -> List[RecordWithValidationField]:
        """
