...
try:
    ...
    pyacomms_version = _version.version
except ImportError:
    pyacomms_version = "unknown"
...
class Micromodem(object):
    def __init__(self, name='modem', unified_log=None, log_path=None, log_level='INFO',
        ...
        # Use this to determine if we respond to uplink requests (unsolicited CADRQ meessages)
        self.respond_to_uplinks = respond_to_uplinks
        ...
        self._daemon_log.info(f"pyacomms version {pyacomms_version}")
    ...
    def send_uplink_frame(self, drqparams):
        if not self.respond_to_uplinks:
            return
