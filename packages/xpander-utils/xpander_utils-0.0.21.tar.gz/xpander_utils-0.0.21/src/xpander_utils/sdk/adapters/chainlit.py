...
class ChainlitAdapter(SDKAdapter):
    ...
    async def process_tool_calls(self, tool_calls: Dict[int, ToolCall], on_tool_call: Optional[Callable], local_tools: Dict[str, Callable] = None) -> str | None:
        """
        ...
        is_debug_mode_active = True if 'debug_mode' in user_settings and user_settings['debug_mode'] == True else False
