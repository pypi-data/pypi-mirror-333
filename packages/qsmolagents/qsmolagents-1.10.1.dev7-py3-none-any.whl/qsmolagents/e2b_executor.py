...
class E2BExecutor:
    def __init__(self, additional_imports: List[str], logger):
        ...
        try:
            ...
            raise ModuleNotFoundError(
                """Please install 'e2b' extra to use E2BExecutor: `pip install "qsmolagents[e2b]"`"""
            )
        self.logger = logger
        ...
        #     "pip install git+https://github.com/huggingface/qsmolagents.git",
        #     timeout=300
        # )
        # print("Installation of agents package finished.")
        additional_imports = additional_imports + ["qsmolagents"]
    ...
    def update_tools(self, tools: Dict[str, Tool]):
        ...
        for tool in tools.values():
            ...
            tool_code = tool_code.replace("from qsmolagents.tools import Tool", "")
