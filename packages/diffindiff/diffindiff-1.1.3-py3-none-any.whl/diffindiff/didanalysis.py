...
class did_model:
    ...
    def summary(self):
        ...
        if not model_config["FE_unit"] and not model_config["FE_time"] and not model_config["GTE"]:
            if model_config["DDD"]:
        ...
        if not model_config["FE_unit"] and model_config["TG_col"] is not None and not model_config["GTE"]:
...
def did_analysis(
    ...
    if not FE_time and not FE_unit and not GTE:
