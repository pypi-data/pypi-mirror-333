            ...
            if nodes:
                ...
                if edges:
                    ...
                    if len(dct_arg_structure['relation'])>0:
                        ...
                        # Debugging step: Check the content of existing_pairs
                        print(f"Existing pairs in df: {existing_pairs}")
                        ...
                        # Debugging step: Check the content of none_df_filtered after filtering
                        print(f"Filtered pairs in none_df: {none_df_filtered}")

                        # Add the filtered new pairs to df
                        df = pd.concat([df, none_df_filtered], ignore_index=True)

                        # Debugging step: Check the updated df
                        print(f"Updated df with new pairs: {df}")
