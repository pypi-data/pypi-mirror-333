...
class RestbusRequest(_message.Message):
    __slots__ = ("clientId", "namespace")
    CLIENTID_FIELD_NUMBER: _ClassVar[int]
    NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    clientId: _common_pb2.ClientId
    namespace: _common_pb2.NameSpace
    def __init__(self, clientId: _Optional[_Union[_common_pb2.ClientId, _Mapping]] = ..., namespace: _Optional[_Union[_common_pb2.NameSpace, _Mapping]] = ...) -> None: ...
...
class FrameRemoveRequest(_message.Message):
    __slots__ = ("clientId", "namespace", "frames")
    CLIENTID_FIELD_NUMBER: _ClassVar[int]
    NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    FRAMES_FIELD_NUMBER: _ClassVar[int]
    clientId: _common_pb2.ClientId
    ...
    def __init__(self, clientId: _Optional[_Union[_common_pb2.ClientId, _Mapping]] = ..., namespace: _Optional[_Union[_common_pb2.NameSpace, _Mapping]] = ..., frames: _Optional[_Iterable[str]] = ...) -> None: ...

class SignalUpdateRequest(_message.Message):
    __slots__ = ("clientId", "namespace", "items")
    CLIENTID_FIELD_NUMBER: _ClassVar[int]
    NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, clientId: _Optional[_Union[_common_pb2.ClientId, _Mapping]] = ..., namespace: _Optional[_Union[_common_pb2.NameSpace, _Mapping]] = ..., items: _Optional[_Iterable[_Union[FrameWithSignals, _Mapping]]] = ...) -> None: ...

class ResetRequest(_message.Message):
    __slots__ = ("clientId", "namespace", "busReset", "signalReset")
    CLIENTID_FIELD_NUMBER: _ClassVar[int]
    NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, clientId: _Optional[_Union[_common_pb2.ClientId, _Mapping]] = ..., namespace: _Optional[_Union[_common_pb2.NameSpace, _Mapping]] = ..., busReset: _Optional[_Union[BusResetRequest, _Mapping]] = ..., signalReset: _Optional[_Union[SignalResetRequest, _Mapping]] = ...) -> None: ...
