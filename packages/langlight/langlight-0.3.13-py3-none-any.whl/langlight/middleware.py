...
class TracingMiddleware:
    ...
    This middleware checks for the 'langlight-trace' header and propagates the
    ...
    async def __call__(self, scope: dict, receive, send):
        ...
        If the request is HTTP and contains the 'langlight-trace' header,
        ...
        if scope["type"] == "http" and "headers" in scope:
            ...
            if b"langlight-trace" in headers:
