...
def test(*args: Any, **kwargs: Any) -> Callable:
    ...
    Environment:
        - LANGSMITH_TEST_CACHE: If set, API calls will be cached to disk to
            ...
            Requires the 'langlight[vcr]' package to be installed.
        - LANGSMITH_TEST_TRACKING: Set this variable to the path of a directory
            to enable caching of test results. This is useful for re-running tests
             without re-executing the code. Requires the 'langlight[vcr]' package.

    Example:
        For basic usage, simply decorate a test function with `@pytest.mark.langlight`.
        ...
        .. code-block:: python
            ...
            # from langlight import test
            # @test
            @pytest.mark.langlight
            def test_addition():
                assert 3 + 4 == 7
        ...
        .. code-block:: python
            ...
            import pytest
            from langlight import traceable
        ...
        Note that this will require that you install langlight with the `vcr` extra:

        `pip install -U "langlight[vcr]"`
        ...
        .. code-block:: python
            ...
            import openai
            import pytest
            from langlight import wrappers
        ...
        LLMs are stochastic. Naive assertions are flakey. You can use langlight's
        `expect` to score and make approximate assertions on your results.

        .. code-block:: python

            import pytest
            from langlight import expect
        ...
        .. code-block:: python
            ...
            @pytest.mark.langlight(output_keys=["expected"])
        ...
        .. code-block:: python
            ...
            @pytest.mark.langlight(id=str(example_id))
        ...
        .. code-block:: python
            ...
            @pytest.mark.langlight(output_keys=["expected_output"])
...
def log_inputs(inputs: dict, /) -> None:
    ...
    Should only be used in pytest tests decorated with @pytest.mark.langlight.
    ...
    Example:
        .. code-block:: python
            ...
            from langlight import testing as t
    ...
    if not run_tree or not test_case:
        msg = (
            ...
            "@pytest.mark.langlight, and with tracing enabled (by setting the "
...
def log_reference_outputs(reference_outputs: dict, /) -> None:
    ...
    if not test_case:
        msg = (
            ...
            "decorated with @pytest.mark.langlight."
        )
        raise ValueError(msg)
