...
def evaluate(
    ...
    **kwargs: Any,
    ...
    Examples:
        ...
        >>> from langlight import Client
        >>> from langlight.evaluation import evaluate
        >>> from langlight.schemas import Example, Run
        >>> client = Client()
        ...
        >>> from langlight.evaluation import LangChainStringEvaluator
    ...
    if isinstance(target, (str, uuid.UUID, schemas.TracerSession)):
        ...
        msg = (
            ...
            "from langlight import aevaluate\n\n"
            "await aevaluate(\n"
...
def evaluate_existing(
    ...
    Examples:
        >>> from langlight.evaluation import evaluate, evaluate_existing
        >>> dataset_name = "Evaluate Examples"
        >>> def predict(inputs: dict) -> dict:
        ...     # This can be any function or just an API call to your app.
        ...     return {"output": "Yes"}
...
def evaluate_comparative(
    ...
    Examples:
        ...
        >>> import openai
        >>> from langlight.evaluation import evaluate
        >>> from langlight.wrappers import wrap_openai
        ...
        >>> import json
        >>> from langlight.evaluation import evaluate_comparative
        >>> from langlight import schemas
