...
class Client:
    ...
    def _headers(self) -> Dict[str, str]:
        ...
        """
        headers = {
            "User-Agent": f"langlight-py/{langsmith.__version__}",
    ...
    def clone_public_dataset(
        ...
        *,
        ...
        """Clone a public dataset to your own langlight tenant.
        ...
        Args:
            ...
            source_api_url (Optional[str]): The URL of the langlight server where the data is hosted.
    ...
    async def arun_on_dataset(
        ...
        **kwargs: Any,
        ...
        .. deprecated:: 0.1.0
           ...
           This method is deprecated. Use :func:`langlight.aevaluate` instead.
        """  # noqa: E501
        warnings.warn(
