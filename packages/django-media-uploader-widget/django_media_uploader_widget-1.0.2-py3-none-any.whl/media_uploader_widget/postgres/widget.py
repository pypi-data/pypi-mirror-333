...
class MediaUploaderArrayWidget(SplitArrayWidget):
    template_name = "media_uploader_widget/postgres/media_array.html"
    drop_text = ""
    empty_text = ""
    empty_icon = ""
    drop_icon = ""
    ...
    def get_context(self, name, value, attrs=None):
        ...
        context = super(MediaUploaderArrayWidget, self).get_context(name, value, attrs)
        if not context:
            context = {}
    ...
    def media(self):
        return forms.Media(
            ...
            css={
                "screen": ("media_uploader_widget/css/media-uploader-inline.css",),
            },
        )
