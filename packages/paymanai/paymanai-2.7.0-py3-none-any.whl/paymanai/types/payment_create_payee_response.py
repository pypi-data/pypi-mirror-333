...
__all__ = ["PaymentCreatePayeeResponse", "ContactDetails", "ContactDetailsAddress"]


class ContactDetailsAddress(BaseModel):
...
class ContactDetails(BaseModel):
    address: Optional[ContactDetailsAddress] = None
