...
class IScheduleGroup(_aws_cdk_ceddda9d.IResource, typing_extensions.Protocol):
    '''(experimental) Interface representing a created or an imported ``ScheduleGroup``.
...
class Schedule(
    ...
    def __init__(
        ...
        *,
        ...
        :param schedule_group: (experimental) The schedule's group. Default: - By default a schedule will be associated with the ``default`` group.
    ...
    def from_schedule_arn(
        ...
        '''(experimental) Import an existing schedule using the ARN.
...
class ScheduleGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param id: -
        :param removal_policy: (experimental) The removal policy for the group. If the group is removed also all schedules are removed. Default: RemovalPolicy.RETAIN
        :param schedule_group_name: (experimental) The name of the schedule group. Up to 64 letters (uppercase and lowercase), numbers, hyphens, underscores and dots are allowed. Default: - A unique name will be generated
    ...
    def from_schedule_group_arn(
        ...
        '''(experimental) Import an external schedule group by ARN.
    ...
    def from_schedule_group_name(
        ...
        '''(experimental) Import an existing schedule group with a given name.
    ...
    def grant(
        ...
        *actions: builtins.str,
        ...
        '''(experimental) Grant the indicated permissions on this schedule group to the given principal.
    ...
    def metric(
        ...
        *,
        ...
        '''(experimental) Return the given named metric for this schedule group.
...
class ScheduleGroupProps:
    def __init__(
        ...
        *,
        ...
        '''(experimental) Properties for a Schedule Group.
...
class ScheduleTargetConfig:
    def __init__(
        ...
        *,
        ...
        :param dead_letter_config: (experimental) An object that contains information about an Amazon SQS queue that EventBridge Scheduler uses as a dead-letter queue for your schedule. If specified, EventBridge Scheduler delivers failed events that could not be successfully delivered to a target to the queue. Default: - No dead-letter queue
        :param ecs_parameters: (experimental) The templated target type for the Amazon ECS RunTask API Operation. Default: - No parameters
        :param event_bridge_parameters: (experimental) The templated target type for the EventBridge PutEvents API operation. Default: - No parameters
        :param input: (experimental) What input to pass to the target. Default: - No input
        :param kinesis_parameters: (experimental) The templated target type for the Amazon Kinesis PutRecord API operation. Default: - No parameters
        :param retry_policy: (experimental) A ``RetryPolicy`` object that includes information about the retry policy settings, including the maximum age of an event, and the maximum number of times EventBridge Scheduler will try to deliver the event to a target. Default: - Maximum retry attempts of 185 and maximum age of 86400 seconds (1 day)
        :param sage_maker_pipeline_parameters: (experimental) The templated target type for the Amazon SageMaker StartPipelineExecution API operation. Default: - No parameters
        :param sqs_parameters: (experimental) The templated target type for the Amazon SQS SendMessage API Operation. Default: - No parameters
