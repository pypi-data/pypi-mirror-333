...
class BaseStage:
    ...
    def __init__(self):
        ...
        :ivar self.consecutive_failures: Number of consecutive failed tasks.
        :ivar self.stop_after_time: If set, looping will stop after this time.
        """
    ...
    def _stop_time_reached(self):
        """Check if desginated stop time is reached."""
        if self.stop_after_time is None:
            return False
        return datetime.datetime.now() > self.stop_after_time
