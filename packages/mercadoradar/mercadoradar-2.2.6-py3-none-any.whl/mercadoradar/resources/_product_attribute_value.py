...
class ProductAttributeValue:
    ...
    def create(self, product_id: Optional[int] = None, value: Optional[str] = None, value_type: Optional[Any] = None,
    ...
    def update(self, id: int, product_id: Optional[int] = None, value: Optional[str] = None,
