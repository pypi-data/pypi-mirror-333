...
class Product:
    ...
    def create(self, name: Optional[str] = None, sku_code: Optional[str] = None, url: Optional[str] = None,
               ...
               brand_verified_at: Optional[datetime] = None, regular_price: Optional[float] = None,
               sales_price: Optional[float] = None, installment_price: Optional[float] = None,
               previous_regular_price: Optional[float] = None, previous_sales_price: Optional[float] = None,
               previous_installment_price: Optional[float] = None, price_updated_at: Optional[datetime] = None,
               is_international_order: Optional[bool] = None, is_kit: Optional[bool] = None,
               is_kit_verified_at: Optional[datetime] = None, is_kit_same_product: Optional[bool] = None,
               is_kit_same_product_verified_at: Optional[datetime] = None, units_per_kit: Optional[int] = None,
