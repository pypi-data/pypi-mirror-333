...
class itkImageVF82(itk.itkImagePython.itkImageBase2):
    ...
    def GetPixelContainer(self, *args):
        r"""
        GetPixelContainer(self) -> itk::ImportImageContainer< unsigned long long,itk::Vector< float,8 > >
        GetPixelContainer(self) -> itk::ImportImageContainer< unsigned long long,itk::Vector< float,8 > > const *
        """
    ...
    def SetPixelContainer(self, container):
        ...
        Parameters
        ----------
        container: itk::ImportImageContainer< unsigned long long,itk::Vector< float,8 > > *
