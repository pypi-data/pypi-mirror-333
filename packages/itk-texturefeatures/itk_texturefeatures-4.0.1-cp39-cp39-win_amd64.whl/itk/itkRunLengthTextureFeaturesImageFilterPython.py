...
class itkImageVF102(itk.itkImagePython.itkImageBase2):
    ...
    def GetPixelContainer(self, *args):
        r"""
        GetPixelContainer(self) -> itk::ImportImageContainer< unsigned long long,itk::Vector< float,10 > >
        GetPixelContainer(self) -> itk::ImportImageContainer< unsigned long long,itk::Vector< float,10 > > const *
        """
    ...
    def SetPixelContainer(self, container):
        ...
        Parameters
        ----------
        container: itk::ImportImageContainer< unsigned long long,itk::Vector< float,10 > > *
