...
from postfiat.nodes.task.models.messages import Message, Direction, NodeInitiationRewardMessage, NodeProposalMessage, NodeChallengeMessage, NodeRewardMessage, NodeBlacklistMessage, NodeRefusalMessage
    ...
    if msg.direction == Direction.NODE_TO_USER:
        ...
        match msg:
            ...
            case NodeRefusalMessage():
                return [Transaction(**params,
                                    memo_type=msg.task_id,
                                    memo_data=f'{TaskTypeLabels.REFUSAL} ___ msg.message')]
