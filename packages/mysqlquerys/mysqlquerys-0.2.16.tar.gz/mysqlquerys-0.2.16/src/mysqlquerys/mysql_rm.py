...
class DataBase:
    ...
    def backup_profile_with_files(self, tables, user_id, output_dir=None, export_files=None):
        if not output_dir:
...
if __name__ == '__main__':
    ...
    testrrrr = Table(conf.credentials, 'all_cars')
