...
lamp1 =  Lamp("Lamp1", filename=fname).move(room.x/3,room.y/3,2.5)#.aim(room.x/2,room.y/2,2)
lamp2 =  Lamp("Lamp2", filename=fname).move(room.x*2/3,room.y*2/3,2.5)#.aim(room.x/2,room.y/2,2)
...
room.add(lamp1,lamp2,plane,vol).calculate()
# plane.plot_plane()
# plt.show()
