...
class LialUserBdd:
    ...
    def get_user_for_app(self,role_name=None,app_id_kalilab=None):
        ...
        if app_id_kalilab is None:
            app_id_kalilab = self.app_id
        with self.connection.cursor() as cursor:
            sql = f"""SELECT id as user_id,user_id_kalilab, heritage_id FROM autorisation_heritage where id_kalilab = {app_id_kalilab}"""
    ...
    def check_user_right(self,user_id, app_id_kalilab, role_name, sous_role_id=None, sous_role_value_id=None,source=None):
        ...
        params = [user_id, app_id_kalilab, role_name]
        params.append(sous_role_id if sous_role_id is not None else 'NULL')
        params.append(sous_role_value_id if sous_role_value_id is not None else 'NULL')
        params.append(source if source is not None else 'NULL')
