...
from src.structure.body_health import (BodyMetricsEvent, BloodGlucoseEvent,
                                       BloodPressureEvent, HeartRateBodyEvent,
                                       HydrationEvent, MoodEvent, MenstruationEvent,
...
class Summary(StructureBase):
    ...
    def summary_data(cls, _data: dict) -> dict:
        ...
        return {
            ...
            'heart_rate': HeartRateBodyEvent.heart_rate_data(_data),
            ...
            'oxygenation': OxygenationBodyEvent.oxygenation_data(_data),
