...
from src.structure.body_health import (BloodGlucoseEvent, BloodPressureEvent,
                                       BodyMetricsEvent, HeartRateBodyEvent,
                                       HydrationEvent, MenstruationEvent, MoodEvent,
                                       NutritionEvent, OxygenationBodyEvent,
                                       TemperatureEvent)

from src.structure.physical_health import (CaloriesEvent, HeartRatePhysicalEvent,
                                           OxygenationPhysicalEvent, StepsEvent,
                                           StressEvent)


from tests.factory_json import (blood_glucose_event_json, blood_pressure_event_json,
                                body_metrics_event_json, heart_rate_event_body_json,
                                hydration_event_json, menstruation_event_json, mood_event_json,
                                nutrition_event_json, oxygenation_event_body_json,
                                temperature_event_json, calories_event_json,
                                heart_rate_physical_event_json, oxygenation_event_physical_json,
                                steps_event_json, stress_event_json)

from tests.factory_schemas import (expectative_blood_glucose_event,
...
class TestJsonStructure(BaseTestClass):
    ...
    def setUpClass(cls):
        cls.seeds = [
            ...
            (heart_rate_event_body_event(), heart_rate_event_body_json(), HeartRateBodyEvent,
            ...
            (oxygenation_event_body(), oxygenation_event_body_json(), OxygenationBodyEvent,
            ...
            (heart_rate_physical_event(), heart_rate_physical_event_json(), HeartRatePhysicalEvent,
             'physical_health', 'heart_rate_event', 'events', 'heart_rate'),
            (oxygenation_physical_event(), oxygenation_event_physical_json(),
             OxygenationPhysicalEvent,
    ...
    def test_json_structure_without_params(self):
        expectative = ['', None]
