...
from src.rook_helper.structure.body_health import (BloodGlucoseEvent, BloodPressureEvent,
...
from src.rook_helper.structure.physical_health import (ActivityEvents, CaloriesEvent,
                                                       HeartRateEvent, OxygenationEvent,
                                                       StepsEvent, StressEvent)
