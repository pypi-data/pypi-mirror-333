...
class ImageLoader:
    ...
    def __init__(self, parent, console, script_dir):
        self.parent = parent
    ...
    def _load_geometry_data(self, base_name):
        """Load and display geometry data"""
        geometry_file = os.path.join(self.script_dir, 'GEOMETRY', f'{base_name}.geometry')
...
class ROIManager:
    ...
    def __init__(self, parent, console, image_canvas, script_dir,
