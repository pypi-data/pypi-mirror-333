import { i as Xr, a as zt, r as Gr, b as qr, w as tt, g as Kr, c as G, d as Yr, o as Zr } from "./Index-XomSjDtQ.js";
...
function We(n) {
  var e = R.useRef(!1), t = R.useState(n), r = te(t, 2), i = r[0], o = r[1];
...
function rn(n, e) {
  ...
  }), u = te(a, 2), l = u[0], c = u[1], d = i !== void 0 ? i : l, f = s ? s(d) : d, m = ye(o), v = We([d]), g = te(v, 2), p = g[0], y = g[1];
  _n(function() {
    var x = p[0];
    l !== x && m(l, x);
  }, [p]), _n(function() {
...
function Ao(n) {
  return (
    // Base object type
    n && Q(n) === "object" && // React Element type
...
function Wo(n) {
  return n && Q(n) === "object" && Pn(n.nativeElement) ? n.nativeElement : Pn(n) ? n : null;
}
function Fo(n) {
  var e = Wo(n);
  if (e)
...
function Vo(n) {
  var e = R.useReducer(function(a) {
    return a + 1;
  }, 0), t = te(e, 2), r = t[1], i = R.useRef(n), o = ye(function() {
    return i.current;
  }), s = ye(function(a) {
...
var be = "none", Xe = "appear", Ge = "enter", qe = "leave", On = "none", ce = "prepare", Ce = "start", Ee = "active", an = "end", pr = "prepared";
function An(n, e) {
  var t = {};
...
var Yo = [ce, Ce, Ee, an], Zo = [ce, pr], Er = !1, Qo = !0;
function _r(n) {
  return n === Ee || n === an;
}
const Jo = function(n, e, t) {
  var r = We(On), i = te(r, 2), o = i[0], s = i[1], a = Ko(), u = te(a, 2), l = u[0], c = u[1];
  function d() {
    s(ce, !0);
  }
  var f = e ? Zo : Yo;
...
function es(n, e, t, r) {
  ...
  var J = ye(function(Y) {
    ...
    if (A !== be) {
      var V = F();
      if (!(Y && !Y.deadline && Y.target !== V)) {
        var de = H.current, Ue;
        A === Xe && de ? Ue = _ == null ? void 0 : _(V, Y) : A === Ge && de ? Ue = C == null ? void 0 : C(V, Y) : A === qe && de && (Ue = E == null ? void 0 : E(V, Y)), de && Ue !== !1 && K();
      }
    }
  }), se = qo(J), he = te(se, 1), pe = he[0], ee = function(A) {
    switch (A) {
      case Xe:
        return z(z(z({}, ce, f), Ce, g), Ee, S);
      case Ge:
        return z(z(z({}, ce, m), Ce, p), Ee, x);
      case qe:
        return z(z(z({}, ce, v), Ce, y), Ee, b);
      default:
        return {};
    }
  }, ie = R.useMemo(function() {
    return ee(M);
  }, [M]), ve = Jo(M, !n, function(Y) {
    if (Y === ce) {
      var A = ie[ce];
      return A ? A(F()) : Er;
    }
    if (me in ie) {
      var V;
      U(((V = ie[me]) === null || V === void 0 ? void 0 : V.call(ie, F(), null)) || null);
    }
    return me === Ee && M !== be && (pe(F()), c > 0 && (clearTimeout(j.current), j.current = setTimeout(function() {
      J({
        deadline: !0
      });
    }, c))), me === pr && K(), Qo;
  }), ze = te(ve, 2), Me = ze[0], me = ze[1], Pt = _r(me);
  H.current = Pt;
  var Ve = oe(null);
  wr(function() {
    if (!(O.current && Ve.current === e)) {
      P(e);
      var Y = O.current;
      O.current = !0;
      var A;
      !Y && e && a && (A = Xe), Y && e && o && (A = Ge), (Y && !e && l || !Y && d && !e && l) && (A = qe);
      var V = ee(A);
      A && (n || V[ce]) ? (D(A), Me()) : D(be), Ve.current = e;
    }
  }, [e]), ge(function() {
    // Cancel appear
    (M === Xe && !a || // Cancel enter
  ...
  var Le = R.useRef(!1);
  ge(function() {
    N && (Le.current = !0), N !== void 0 && M === be && ((Le.current || N) && (T == null || T(N)), Le.current = !0);
  }, [N, M]);
  var Oe = re;
  return ie[ce] && me === Ce && (Oe = $({
    transition: "none"
  }, Oe)), [M, me, Oe, N ?? e];
}
function ts(n) {
  var e = n;
  Q(n) === "object" && (e = n.transitionSupport);
  function t(i, o) {
    return !!(i.motionName && e && o !== !1);
  }
  var r = /* @__PURE__ */ R.forwardRef(function(i, o) {
    var s = i.visible, a = s === void 0 ? !0 : s, u = i.removeOnLeave, l = u === void 0 ? !0 : u, c = i.forceRender, d = i.children, f = i.motionName, m = i.leavedClassName, v = i.eventProps, g = R.useContext(Bo), p = g.motion, y = t(i, p), S = oe(), x = oe();
    function b() {
      try {
    ...
    var _ = es(y, a, b, i), C = te(_, 4), E = C[0], T = C[1], I = C[2], W = C[3], N = R.useRef(W);
    W && (N.current = !0);
    var P = R.useCallback(function(X) {
      S.current = X, ko(o, X);
    }, [o]), L, w = $($({}, v), {}, {
      visible: a
    });
    if (!d)
      ...
      var k;
      T === ce ? k = "prepare" : _r(T) ? k = "active" : T === Ce && (k = "start");
      var D = In(f, "".concat(E, "-").concat(k));
      L = d($($({}, w), {}, {
        className: G(In(f, E), z(z({}, D, D && k), f, typeof f == "string")),
        style: I
      }), P);
    }
...
function ns(n) {
  var e;
  return n && Q(n) === "object" && "key" in n ? e = n : e = {
    key: n
  }, $($({}, e), {}, {
    key: String(e.key)
  });
  ...
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Rr, t = /* @__PURE__ */ function(r) {
    ...
    function o() {
      ...
      for (var a = arguments.length, u = new Array(a), l = 0; l < a; l++)
        u[l] = arguments[l];
      return s = i.call.apply(i, [this].concat(u)), z(we(s), "state", {
        keyEntities: []
      }), z(we(s), "removeKey", function(c) {
    ...
    return Pe(o, [{
      ...
      value: function() {
        ...
        return ss.forEach(function(p) {
          ...
          return /* @__PURE__ */ R.createElement(e, ue({}, g, {
            key: x.key,
            visible: b,
            eventProps: x,
...
function cs(n, e) {
  ...
  return h.useImperativeHandle(e, () => o.current), /* @__PURE__ */ h.createElement(er, ue({}, r, {
    showUploadList: !1,
    rootClassName: i,
    ref: o
  }), t);
...
var ds = /* @__PURE__ */ function(n) {
  ...
  function t(r, i) {
    var o;
    Te(this, t), o = e.call(this), z(we(o), "result", ""), z(we(o), "unitlessCssVar", void 0), z(we(o), "lowPriority", void 0);
    var s = Q(r);
  ...
  function t(r) {
    var i;
    return Te(this, t), i = e.call(this), z(we(i), "result", 0), r instanceof t ? i.result = r.result : typeof r == "number" && (i.result = r), i;
  }
  return Pe(t, [{
    key: "add",
    value: function(i) {
...
var ms = function(e) {
  ...
  return Lr && typeof Proxy < "u" && (t = /* @__PURE__ */ new Set(), r = new Proxy(e, {
    ...
    Fn[s] = {
      global: Array.from(t),
      component: $($({}, (u = Fn[s]) === null || u === void 0 ? void 0 : u.component), a)
    };
  }), {
    token: r,
    keys: t,
...
var vs = 1e3 * 60 * 10, bs = /* @__PURE__ */ function() {
  function n() {
    Te(this, n), z(this, "map", /* @__PURE__ */ new Map()), z(this, "objectIDMap", /* @__PURE__ */ new WeakMap()), z(this, "nextID", 0), z(this, "lastAccessBeat", /* @__PURE__ */ new Map()), z(this, "accessBeat", 0);
  }
  return Pe(n, [{
    key: "set",
    value: function(t, r) {
    ...
    value: function(t) {
      var r = this, i = t.map(function(o) {
        return o && Q(o) === "object" ? "obj_".concat(r.getObjectID(o)) : "".concat(Q(o), "_").concat(o);
      });
      return i.join("|");
    }
  }, {
...
function Ss(n) {
  ...
  function u(f, m, v, g) {
    ...
    var S = (g == null ? void 0 : g.unitless) || {}, x = typeof a == "function" ? a(f) : {}, b = $($({}, x), {}, z({}, y("zIndexPopup"), !0));
    ...
    return function(T) {
      var I = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : T, W = C(T, I), N = te(W, 2), P = N[1], L = E(I), w = te(L, 2), k = w[0], D = w[1];
      return [k, P, D];
    };
  }
  function l(f, m, v) {
  ...
  function c(f, m, v) {
    var g = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, p = Array.isArray(f) ? f : [f, f], y = te(p, 1), S = y[0], x = p.join("-"), b = n.layer || {
      name: "antd"
    };
    return function(_) {
      var C = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : _, E = r(), T = E.theme, I = E.realToken, W = E.hashId, N = E.token, P = E.cssVar, L = i(), w = L.rootPrefixCls, k = L.iconPrefixCls, D = t(), q = P ? "css" : "js", X = ys(function() {
        var F = /* @__PURE__ */ new Set();
        return P && Object.keys(g.unitless || {}).forEach(function(H) {
          F.add(Lt(H, P.prefix)), F.add(Lt(H, Nn(S, P.prefix)));
        }), hs(q, F);
      }, [q, S, P == null ? void 0 : P.prefix]), re = gs(q), U = re.max, M = re.min, O = {
        theme: T,
        token: N,
        hashId: W,
        nonce: function() {
      ...
      var j = fn($($({}, O), {}, {
        ...
        if (g.injectStyle === !1)
          return [];
        var F = ms(N), H = F.token, K = F.flush, J = jn(S, I, v), se = ".".concat(_), he = Wn(S, I, J, {
          deprecatedTokens: g.deprecatedTokens
        });
        P && J && Q(J) === "object" && Object.keys(J).forEach(function(ve) {
          J[ve] = "var(".concat(Lt(ve, Nn(S, P.prefix)), ")");
        });
        var pe = _t(H, {
          componentCls: se,
          prefixCls: _,
        ...
        K(S, he);
        var ie = typeof s == "function" ? s(pe, _, C, g.resetFont) : null;
        return [g.resetStyle === !1 ? null : ie, ee];
      });
      return [j, W];
    };
  }
  function d(f, m, v) {
    var g = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, p = c(f, m, v, $({
      resetStyle: !1,
...
class fe {
  ...
  onBackground(e) {
    const t = this._c(e), r = this.a + t.a * (1 - this.a), i = (o) => Z((this[o] * this.a + t[o] * t.a * (1 - this.a)) / r);
    return this._c({
      r: i("r"),
      g: i("g"),
      b: i("b"),
  ...
  /** CSS support color pattern */
  toHslString() {
    const e = this.getHue(), t = Z(this.getSaturation() * 100), r = Z(this.getLightness() * 100);
  ...
  fromHsl({
    ...
    const d = r - l / 2;
    this.r = Z((o + d) * 255), this.g = Z((s + d) * 255), this.b = Z((a + d) * 255);
  }
  fromHsv({
    h: e,
    s: t,
    ...
    if (this.r = o, this.g = o, this.b = o, t <= 0)
      return;
    const s = e / 60, a = Math.floor(s), u = s - a, l = Z(r * (1 - t) * 255), c = Z(r * (1 - t * u) * 255), d = Z(r * (1 - t * (1 - u)) * 255);
    switch (a) {
      case 0:
        this.g = d, this.b = l;
        break;
...
const {
  ...
  return {
    colorBgPlaceholderHover: new fe(e).setA(0.85).toRgbString()
  };
}, kr = Ar("Attachments", (n) => {
  const e = _t(n, {});
...
function Vs(n, e) {
  const {
    ...
    getPrefixCls: v
  } = Ne(), g = v("attachment", t), p = `${g}-list-card`, [y, S, x] = kr(g), [b, _] = h.useMemo(() => {
    const k = l || "", D = k.match(/^(.*)\.[^.]+$/);
    return D ? [D[1], k.slice(D[1].length)] : [k, ""];
  }, [l]), C = h.useMemo(() => zn(_, $r), [_]), E = h.useMemo(() => m || (f === "uploading" ? `${d || 0}%` : f === "error" ? r.response || Ft : c ? zs(c) : Ft), [f, d]), [T, I] = h.useMemo(() => {
    for (const {
      ext: k,
      icon: D,
      color: q
  ...
  let P = null;
  const L = r.thumbUrl || r.url || W, w = C && (r.originFileObj || L);
...
function Xs(n, e) {
  ...
  return /* @__PURE__ */ h.createElement("div", {
    ...
    "aria-hidden": l,
    style: s
  }, /* @__PURE__ */ h.createElement(er.Dragger, ue({
    showUploadList: !1
  }, i, {
    ref: e,
    style: {
...
function qs(n, e) {
  ...
  h.useImperativeHandle(e, () => ({
    ...
    upload: (U) => {
      var O, j;
      const M = (j = (O = T.current) == null ? void 0 : O.nativeElement) == null ? void 0 : j.querySelector('input[type="file"]');
      if (M) {
        const F = new DataTransfer();
        F.items.add(U), M.files = F.files, M.dispatchEvent(new Event("change", {
          bubbles: !0
        }));
      }
    }
  }));
  const [I, W, N] = kr(x), P = G(W, N), [L, w] = rn([], {
    value: a
  }), k = ye((U) => {
    w(U.fileList), d == null || d(U);
  }), D = {
    ...p,
    fileList: L,
    onChange: k
  }, q = (U) => {
    const M = L.filter((O) => O.uid !== U.uid);
    k({
      file: U,
      fileList: M
    });
  ...
  let X;
  const re = (U, M, O) => {
    const j = typeof c == "function" ? c(U) : c;
    return /* @__PURE__ */ h.createElement(Gs, {
      placeholder: j,
      upload: D,
      prefixCls: x,
      className: G(_.placeholder, v.placeholder),
      style: {
        ...C.placeholder,
        ...g.placeholder,
  ...
  if (u)
    X = /* @__PURE__ */ h.createElement(h.Fragment, null, /* @__PURE__ */ h.createElement(Tr, {
      upload: D,
      rootClassName: r,
      ref: T
...
function na(n) {
  ...
  return /* @__PURE__ */ R.createElement(Rr, {
    ...
    className: G(`${f}-content`, a.content),
    style: {
      ...u.content
    }
  }, i)));
...
function ra(n, e) {
  ...
  return /* @__PURE__ */ R.createElement(_e, ue({
    type: "text"
  }, o, {
    ref: e,
    onClick: (d) => {
...
function ia(n, e) {
  return /* @__PURE__ */ R.createElement(Tt, ue({
...
function aa(n, e) {
  ...
  return /* @__PURE__ */ R.createElement(Tt, ue({
    ...
    className: G(r, `${t}-loading-button`),
    action: "onCancel",
    ref: e
...
function ua(n, e) {
  ...
  }) : r ? o = /* @__PURE__ */ R.createElement(mi, null) : o = /* @__PURE__ */ R.createElement(gi, null), /* @__PURE__ */ R.createElement(Tt, ue({
    icon: o,
    color: "primary",
    variant: "text"
  }, n, {
...
const ba = /* @__PURE__ */ h.forwardRef((n, e) => {
  const {
    ...
    direction: N,
    getPrefixCls: P
  } = Ne(), L = P("sender", t), w = h.useRef(null), k = h.useRef(null);
  ta(e, () => {
    var A, V;
    return {
      nativeElement: w.current,
      focus: (A = k.current) == null ? void 0 : A.focus,
      blur: (V = k.current) == null ? void 0 : V.blur
    };
  });
  const D = lr("sender"), q = `${L}-input`, [X, re, U] = ma(L), M = G(L, D.className, o, s, re, U, {
    [`${L}-rtl`]: N === "rtl",
    [`${L}-disabled`]: b
  }), O = `${L}-actions-btn`, j = `${L}-actions-list`, [F, H] = rn(u || "", {
    value: l
  }), K = (A, V) => {
    H(A), p && p(A, V);
  }, [J, se, he] = ga((A) => {
    K(`${F} ${A}`);
  }, _), pe = va(v, ["input"], Si.TextArea), ie = {
    ...ea(W, {
      attr: !0,
      aria: !0,
      data: !0
    ...
    const V = A.key === "Enter" && !Me.current;
    switch (d) {
      case "enter":
        V && !A.shiftKey && (A.preventDefault(), ve());
        break;
      case "shiftEnter":
        V && A.shiftKey && (A.preventDefault(), ve());
        break;
    ...
    var de;
    const V = (de = A.clipboardData) == null ? void 0 : de.files[0];
    V && I && (I(V), A.preventDefault()), T == null || T(A);
  }, Oe = (A) => {
    var V, de;
    A.target !== ((V = w.current) == null ? void 0 : V.querySelector(`.${q}`)) && A.preventDefault(), (de = k.current) == null || de.focus();
  };
  let Y = /* @__PURE__ */ h.createElement(tr, {
    className: `${j}-presets`
  }, _ && /* @__PURE__ */ h.createElement(da, null), m ? /* @__PURE__ */ h.createElement(qn, null) : /* @__PURE__ */ h.createElement(Kn, null));
  return typeof y == "function" ? Y = y(Y, {
    components: {
      SendButton: Kn,
      ClearButton: oa,
      LoadingButton: qn
    }
  }) : y && (Y = y), X(/* @__PURE__ */ h.createElement("div", {
    ref: w,
    className: M,
    style: {
      ...D.style,
    ...
    className: G(`${L}-prefix`, D.classNames.prefix, i.prefix),
    style: {
      ...D.styles.prefix,
      ...r.prefix
    }
  }, C), /* @__PURE__ */ h.createElement(pe, ue({}, ie, {
    disabled: b,
    style: {
      ...D.styles.input,
      ...r.input
    },
    className: G(q, D.classNames.input, i.input),
    autoSize: {
      maxRows: 8
    },
    value: F,
    onChange: (A) => {
      K(A.target.value, A), se(!0);
    },
    onPressEnter: Ve,
    ...
    className: G(j, D.classNames.actions, i.actions),
    style: {
      ...D.styles.actions,
      ...r.actions
    }
...
const Ha = (n) => !!n.name, Ie = (n) => {
  ...
  const [_, C] = De(!1), E = Jr(), T = oe(null), {
    ...
    container: T.current,
    async onStop(M) {
      const O = new File([await Ba(M)], `${Date.now()}_recording_result.wav`, {
        type: "audio/wav"
      });
      D(O);
    }
    ...
    onValueChange: n,
    value: x
  }), w = un(() => Yr(S), [S]), k = v || (w == null ? void 0 : w.disabled) || m || f, D = ot(async (M) => {
    if (k)
      return;
    const O = w == null ? void 0 : w.maxCount;
    if (typeof O == "number" && O > 0 && X.length >= O)
      return;
    const j = await l(Array.isArray(M) ? M : [M]);
    r == null || r(j.map((H) => H.path));
    const F = {
      ...P,
      files: [...X, ...j]
    };
    return e == null || e(Ie(F)), L(F), j;
  }), q = oe(!1), [X, re] = De(() => (P == null ? void 0 : P.files) || []);
  ge(() => {
  ...
  const U = un(() => {
    ...
    return X.map((O) => {
      if (!Ha(O)) {
        const j = O.url || O.path;
        return M[j] || (M[j] = 0), M[j]++, {
          ...O,
  ...
  return /* @__PURE__ */ ne.jsxs(ne.Fragment, {
    children: [/* @__PURE__ */ ne.jsx("div", {
      style: {
        display: "none"
      },
      ref: T
      ...
      onPasteFile: async (M) => {
        if (!((w == null ? void 0 : w.allowPasteFile) ?? !0))
          return;
        const O = await D(M);
        O && (t == null || t(O.map((j) => j.path)));
      },
      prefix: /* @__PURE__ */ ne.jsxs(ne.Fragment, {
        children: [/* @__PURE__ */ ne.jsx(xi, {
          title: w == null ? void 0 : w.uploadButtonTooltip,
          children: /* @__PURE__ */ ne.jsx(Ci, {
            count: ((w == null ? void 0 : w.showCount) ?? !0) && !_ ? U.length : 0,
            children: /* @__PURE__ */ ne.jsx(_e, {
              onClick: () => {
                C(!_);
              },
              color: "default",
              variant: "text",
              icon: /* @__PURE__ */ ne.jsx(bi, {})
            })
          })
        }), y.prefix ? /* @__PURE__ */ ne.jsx(bo, {
          slot: y.prefix
        }) : null]
      }),
      header: /* @__PURE__ */ ne.jsx(nn.Header, {
        title: (w == null ? void 0 : w.title) || "Attachments",
        open: _,
        onOpenChange: C,
        children: /* @__PURE__ */ ne.jsx(Dr, {
          ...
          placeholder: (M) => {
            ...
            const O = M === "drop";
            return {
              title: O ? ((j = w == null ? void 0 : w.placeholder) == null ? void 0 : j.drop.title) ?? "Drop file here" : ((F = w == null ? void 0 : w.placeholder) == null ? void 0 : F.inline.title) ?? "Upload files",
              description: O ? ((H = w == null ? void 0 : w.placeholder) == null ? void 0 : H.drop.description) ?? void 0 : ((K = w == null ? void 0 : w.placeholder) == null ? void 0 : K.inline.description) ?? "Click or drag files to this area to upload",
              icon: O ? ((J = w == null ? void 0 : w.placeholder) == null ? void 0 : J.drop.icon) ?? void 0 : ((se = w == null ? void 0 : w.placeholder) == null ? void 0 : se.inline.icon) ?? /* @__PURE__ */ ne.jsx(vi, {})
            };
          },
          onDownload: s,
          onPreview: u,
          onDrop: a,
          onChange: async (M) => {
            const O = M.file, j = M.fileList, F = U.findIndex((H) => H.uid === O.uid);
            if (F !== -1) {
              if (q.current)
                return;
              o == null || o(O);
              ...
              if (q.current)
                return;
              q.current = !0;
              let H = j.filter((ee) => ee.status !== "done");
              const K = w == null ? void 0 : w.maxCount;
              if (K === 1)
                H = H.slice(0, 1);
              else if (H.length === 0) {
                q.current = !1;
                ...
                const ee = K - X.length;
                H = H.slice(0, ee < 0 ? 0 : ee);
              }
              const J = X;
              re((ee) => [...K === 1 ? [] : ee, ...H.map((ie) => ({
                ...ie,
                size: ie.size,
                uid: ie.uid,
                name: ie.name,
              ...
              const se = (await l(H.map((ee) => ee.originFileObj))).filter(Boolean), he = K === 1 ? se : [...J, ...se];
              r == null || r(se.map((ee) => ee.path)), q.current = !1;
              const pe = {
                ...P,
                files: he
              };
              re(he), n == null || n(pe), e == null || e(Ie(pe));
            }
          },
          customRequest: Ii
        })
