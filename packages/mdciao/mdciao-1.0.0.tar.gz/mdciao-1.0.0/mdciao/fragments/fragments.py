...
def fragment_reorder(traj : _md.Trajectory, fragments, keys_or_idxs=None, verbose=True) -> _md.Trajectory:
    r"""

    Reorder a geometry using arbitrary fragment definitions

    Note
    ----
    Contrary to Regardless of the order in which the selection
