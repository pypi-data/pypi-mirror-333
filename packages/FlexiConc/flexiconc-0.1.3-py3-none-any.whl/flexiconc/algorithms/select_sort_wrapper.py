...
def select_by_sort(conc, **args):
    ...
    Parameters:
        ...
        args (dict): Arguments include:
            - active_node (object): The active node containing an ordering_result with 'sort_keys'.
    ...
    select_by_sort._algorithm_metadata = {
        ...
        "args_schema": {
            ...
            "properties": {
                "active_node": {
                    "description": "The active node containing the ordering_result with 'sort_keys'."
                },
                "comparison_operator": {
                    "type": "string",
                    "enum": ["==", "<=", ">=", "<", ">"],
