def kwic_patterns(conc, **args):
    ...
    kwic_patterns._algorithm_metadata = {
        "name": "KWIC Patterns",
        "description": "Extracts ngram patterns from specified positions and partitions the concordance according to their frequency in the concordance lines. See Anthony (2018) and subsequent work for more information.",
