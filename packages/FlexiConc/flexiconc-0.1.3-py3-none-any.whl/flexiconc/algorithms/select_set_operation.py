def select_set_operation(conc, **args):
    ...
    - args (dict): Arguments include:
        ...
        - active_node (object): The active node, which must be included in the list of nodes.
    ...
    select_set_operation._algorithm_metadata = {
        ...
        "args_schema": {
            ...
            "properties": {
                ...
                "active_node": {
                    "description": "The active node, which must be included in the list of nodes."
                }
            },
            "required": ["operation_type", "nodes", "active_node"]
        }
    }
