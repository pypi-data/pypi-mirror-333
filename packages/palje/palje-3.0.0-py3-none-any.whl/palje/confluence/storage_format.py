...
def objects_list():
    ...
    return ET.tostring(h1, encoding="unicode") + ET.tostring(p, encoding="unicode")
...
def description_header(description):
    ...
    p1.append(macro)
    return ET.tostring(h1, encoding="unicode") + ET.tostring(p1, encoding="unicode")
...
def column_table(columns):
    ...
    return ET.tostring(h1, encoding="unicode") + ET.tostring(table, encoding="unicode")
