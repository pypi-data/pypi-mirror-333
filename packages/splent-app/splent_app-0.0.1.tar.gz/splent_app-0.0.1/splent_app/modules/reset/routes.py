...
from splent_app.modules.reset import reset_bp
from splent_app.modules.reset.services import ResetService
...
def forgot():
    if request.method == "POST":
        ...
        try:
            ...
            flash(
                f"An error occurred while trying to reset the password: {exc}",
                "danger",
            )
