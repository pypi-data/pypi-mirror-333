...
class CriterionSetsResource(BaseResource):
    ...
    def create(self, name: str, prompt_template: PromptTemplate, criteria: List[str] | None = None) -> CriterionSet:
        """Create a new criterion set and associate it with a prompt template.
