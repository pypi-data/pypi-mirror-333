...
from ..shared_params.screenshot_request_config import ScreenshotRequestConfig

__all__ = ["AsyncScreenshotParams"]


class AsyncScreenshotParams(TypedDict, total=False):
    ...
    configuration: ScreenshotRequestConfig
