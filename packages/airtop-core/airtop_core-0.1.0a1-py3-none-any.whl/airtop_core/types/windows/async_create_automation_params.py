...
from ..shared_params.async_config import AsyncConfig
from ..shared_params.create_automation_request import CreateAutomationRequest

__all__ = ["AsyncCreateAutomationParams"]


class AsyncCreateAutomationParams(TypedDict, total=False):
    session_id: Required[Annotated[str, PropertyInfo(alias="sessionId")]]
    """The session id for the window."""

    async_: Annotated[AsyncConfig, PropertyInfo(alias="async")]
    """Async configuration options."""

    client_request_id: Annotated[str, PropertyInfo(alias="clientRequestId")]

    configuration: CreateAutomationRequest
