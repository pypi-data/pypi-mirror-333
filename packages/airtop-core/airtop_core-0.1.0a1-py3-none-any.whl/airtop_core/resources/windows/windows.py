...
class WindowsResource(SyncAPIResource):
    ...
    def monitor(
        ...
        *,
        ...
        """Monitor a specific browser window for a condition using AI (e.g.
...
class WindowsResourceWithRawResponse:
    ...
    def async_(self) -> AsyncResourceWithRawResponse:
        return AsyncResourceWithRawResponse(self._windows.async_)
...
class AsyncWindowsResourceWithRawResponse:
    ...
    def async_(self) -> AsyncAsyncResourceWithRawResponse:
        return AsyncAsyncResourceWithRawResponse(self._windows.async_)
...
class WindowsResourceWithStreamingResponse:
    ...
    def async_(self) -> AsyncResourceWithStreamingResponse:
        return AsyncResourceWithStreamingResponse(self._windows.async_)
...
class AsyncWindowsResourceWithStreamingResponse:
    ...
    def async_(self) -> AsyncAsyncResourceWithStreamingResponse:
        return AsyncAsyncResourceWithStreamingResponse(self._windows.async_)
