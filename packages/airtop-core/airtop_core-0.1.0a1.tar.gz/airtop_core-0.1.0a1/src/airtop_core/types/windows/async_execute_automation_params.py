...
__all__ = ["AsyncExecuteAutomationParams"]


class AsyncExecuteAutomationParams(TypedDict, total=False):
    session_id: Required[Annotated[str, PropertyInfo(alias="sessionId")]]
    """The session id for the window."""

    automation_id: Required[Annotated[str, PropertyInfo(alias="automationId")]]
