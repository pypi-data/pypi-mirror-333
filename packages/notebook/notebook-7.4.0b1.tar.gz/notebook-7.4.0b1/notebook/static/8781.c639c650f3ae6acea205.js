...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48247);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(19284),
    __webpack_require__(19091),
    __webpack_require__(87116),
    __webpack_require__(86122),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(59664),
  __webpack_require__(1918),
  __webpack_require__(18144),
  __webpack_require__(27938),
  __webpack_require__(86639),
  __webpack_require__(32681),
  __webpack_require__(46242),
  
      (__webpack_require__(84281)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(23784)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      (__webpack_require__(36043)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(35848)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(30760),
  
      (__webpack_require__(93282)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(37138)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(33717)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(30204)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(28807)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(65498),
  __webpack_require__(90330),
  __webpack_require__(81568),
  
      (__webpack_require__(90828)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(37574),
  __webpack_require__(45659),
  __webpack_require__(2903),
  
      (__webpack_require__(56678)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(32897),
  __webpack_require__(44879),
  __webpack_require__(96868),
  __webpack_require__(73715),
  __webpack_require__(72258),
  __webpack_require__(51054),
  __webpack_require__(60630),
  __webpack_require__(52675),
  __webpack_require__(35611),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      (__webpack_require__(60432)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(57800),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(52986),
  __webpack_require__(89911),
  
      (__webpack_require__(81718)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(57453)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(72162)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(10006).NotebookApp);
...
/* harmony import */ var _node_modules_jupyterlab_builder_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11368);
/* harmony import */ var _node_modules_jupyterlab_builder_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_jupyterlab_builder_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _node_modules_jupyterlab_builder_node_modules_css_loader_dist_cjs_js_variables_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32031);
// Imports
...
//# sourceMappingURL=8781.c639c650f3ae6acea205.js.map?v=c639c650f3ae6acea205