...
class SpinFreeEnergyExtractor(extto.BetweenExtractor):
    '''
    Extracts Spin-Free TRANSITION ENERGIES block
    '''
...
class SpinOrbitEnergyExtractor(extto.BetweenExtractor):
    '''
    Extracts Spin-Orbit Energies block
    '''
