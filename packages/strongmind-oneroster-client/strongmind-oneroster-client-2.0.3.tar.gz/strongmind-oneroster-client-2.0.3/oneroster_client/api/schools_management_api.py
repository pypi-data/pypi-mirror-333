...
class SchoolsManagementApi(object):
    ...
    def get_school(self, sourced_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_school_with_http_info(sourced_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_school_with_http_info(sourced_id, **kwargs)  # noqa: E501
            return data

    def get_school_with_http_info(self, sourced_id, **kwargs):  # noqa: E501
        """The REST read request message for the getSchool() API call.  # noqa: E501

        ...not supplied...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_school_with_http_info(sourced_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('sourced_id' not in params or
            ...
            raise ValueError("Missing the required parameter `sourced_id` when calling `get_school`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='SingleOrgType',  # noqa: E501
    ...
    def get_schools_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='OrgsType',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
