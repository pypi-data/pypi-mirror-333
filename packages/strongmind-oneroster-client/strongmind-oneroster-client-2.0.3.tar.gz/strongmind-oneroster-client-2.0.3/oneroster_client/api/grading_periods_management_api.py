...
class GradingPeriodsManagementApi(object):
    ...
    def get_grading_period(self, sourced_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_grading_period_with_http_info(sourced_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_grading_period_with_http_info(sourced_id, **kwargs)  # noqa: E501
            return data

    def get_grading_period_with_http_info(self, sourced_id, **kwargs):  # noqa: E501
        """The REST read request message for the getGradingPeriod() API call.  # noqa: E501

        ...not supplied...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_grading_period_with_http_info(sourced_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_grading_period" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('sourced_id' not in params or
            ...
            raise ValueError("Missing the required parameter `sourced_id` when calling `get_grading_period`")  # noqa: E501
    ...
    def get_grading_periods_for_term(self, term_sourced_id, **kwargs):  # noqa: E501
        """The REST read request message for the getGradingPeriodsForTerm() API call.  # noqa: E501

        ...not supplied...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_grading_periods_for_term(term_sourced_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_grading_periods_for_term_with_http_info(term_sourced_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_grading_periods_for_term_with_http_info(term_sourced_id, **kwargs)  # noqa: E501
            return data

    def get_grading_periods_for_term_with_http_info(self, term_sourced_id, **kwargs):  # noqa: E501
        """The REST read request message for the getGradingPeriodsForTerm() API call.  # noqa: E501

        ...not supplied...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_grading_periods_for_term_with_http_info(term_sourced_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_grading_periods_for_term" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('term_sourced_id' not in params or
            ...
            raise ValueError("Missing the required parameter `term_sourced_id` when calling `get_grading_periods_for_term`")  # noqa: E501
