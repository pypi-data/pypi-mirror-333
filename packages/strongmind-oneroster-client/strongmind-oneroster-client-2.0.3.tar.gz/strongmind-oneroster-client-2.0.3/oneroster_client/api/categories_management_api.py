...
class CategoriesManagementApi(object):
    ...
    def delete_category(self, sourced_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.delete_category_with_http_info(sourced_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_category_with_http_info(sourced_id, **kwargs)  # noqa: E501
            return data

    def delete_category_with_http_info(self, sourced_id, **kwargs):  # noqa: E501
        """The REST delete request message for the deleteCategory() API call.  # noqa: E501

        ...not supplied...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_category_with_http_info(sourced_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('sourced_id' not in params or
            ...
            raise ValueError("Missing the required parameter `sourced_id` when calling `delete_category`")  # noqa: E501
    ...
    def get_categories_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CategoriesType',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_category(self, sourced_id, **kwargs):  # noqa: E501
        """The REST read request message for the getCategory() API call.  # noqa: E501

        ...not supplied...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_category(sourced_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_category_with_http_info(sourced_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_category_with_http_info(sourced_id, **kwargs)  # noqa: E501
            return data

    def get_category_with_http_info(self, sourced_id, **kwargs):  # noqa: E501
        """The REST read request message for the getCategory() API call.  # noqa: E501

        ...not supplied...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_category_with_http_info(sourced_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('sourced_id' not in params or
                params['sourced_id'] is None):
            raise ValueError("Missing the required parameter `sourced_id` when calling `get_category`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SingleCategoryType',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def put_category(self, body, sourced_id, **kwargs):  # noqa: E501
        """The REST create request message for the putCategory() API call.  # noqa: E501

        ...not supplied...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_category(body, sourced_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SingleCategoryType body: ...tbd... (required)
        :param str sourced_id: ...tbd... (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_category_with_http_info(body, sourced_id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_category_with_http_info(body, sourced_id, **kwargs)  # noqa: E501
            return data

    def put_category_with_http_info(self, body, sourced_id, **kwargs):  # noqa: E501
        """The REST create request message for the putCategory() API call.  # noqa: E501

        ...not supplied...  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_category_with_http_info(body, sourced_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_category`")  # noqa: E501
        # verify the required parameter 'sourced_id' is set
        if ('sourced_id' not in params or
                params['sourced_id'] is None):
            raise ValueError("Missing the required parameter `sourced_id` when calling `put_category`")  # noqa: E501
