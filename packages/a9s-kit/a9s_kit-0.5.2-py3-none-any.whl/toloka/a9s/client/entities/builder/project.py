...
class ProjectBuilder(Generic[MCFOpt, GTFOpt, QMFOpt, QRMOpt, SWOpt, ResMC, ResGT, ResQM, ResQRM, ResSW]):
    ...
    * `ResSW`: `Status annotation process workflow` config view type after build
    ...
    def with_status_workflow_money_config(
        self: ProjectBuilderWithoutMoneyConfig[GTFOpt, QMFOpt, QRMOpt, StatusWorkflowForm, ResGT, ResQM, ResQRM, ResSW],
        **kwargs: Unpack[StatusWorkflowMoneyConfigFormParams],
    ) -> ProjectBuilderWithMoneyConfig[GTFOpt, QMFOpt, QRMOpt, StatusWorkflowForm, ResGT, ResQM, ResQRM, ResSW]:
