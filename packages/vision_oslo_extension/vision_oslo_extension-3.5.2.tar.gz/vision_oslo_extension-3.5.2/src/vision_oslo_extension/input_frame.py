...
class S04(BasePage):
    def __init__(self, parent, controller):
        ...
        choice7 = tk.Radiobutton(master=self.optionframe, text = 'Option 7: Remove Specific Platform at a TIPLOC (Use with caution) - [REQUIRE: CIF_selection.csv]', value="7", variable=option1)
