...
class IterationService:
    ...
    def save_autolog_assets(self, cells: list[dict[str, str]], prefix: str | None = None):
        if self._client.is_feature_flag_enabled_without_message("spike-autolog-llm"):
            self._client.save_autolog_cells(self._iteration.id, cells, prefix)
