...
class IterationApi(GqlApi):
    ...
    def save_autolog_cells(self, iteration_id: str, cells: list[dict[str, str]], prefix: str | None = None):
        ...
        variable_types = "$cells:[AutologCellInput!]!, $iterationId:VecticeId!, $prefix: String"
        variables: dict[str, Any] = {"cells": cells, "iterationId": iteration_id, "prefix": prefix}
        kw = "cells:$cells, iterationId:$iterationId, prefix:$prefix"
        query = GqlApi.build_query(
            gql_query=gql_query,
            variable_types=variable_types,
            keyword_arguments=kw,
