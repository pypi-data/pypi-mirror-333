...
from src.tecton_gen_ai.utils._cache import CacheProtocol, get_cache
from src.tecton_gen_ai.utils.config_wrapper import from_json_config, to_json_config
from src.tecton_gen_ai.utils.runtime import RuntimeVar
from src.tecton_gen_ai.utils.structured_outputs import (
    BatchProcessor,
    T_OutputType,
    batch_generate,
...
def test_cache_behavior(func, schema):
    ...
    with patch(
        "src.tecton_gen_ai.utils._cache.get_cache",
