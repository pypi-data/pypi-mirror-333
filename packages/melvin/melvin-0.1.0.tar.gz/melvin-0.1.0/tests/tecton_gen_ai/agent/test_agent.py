...
import pandas as pd
from src.tecton_gen_ai.agent.base import AgentInputModel
from src.tecton_gen_ai.api import (
    Agent,
    prompt,
    tool,
    emitter,
...
def test_resources(set_default_llm):
    ...
    def tecon_number_of_employees() -> int:
        ...
        from src.tecton_gen_ai.utils.runtime import get_runtime_context
...
def test_session(set_default_llm):
    ...
    def get_color_in_the_bag() -> str:
        ...
        """
        from src.tecton_gen_ai.api import set_session_var
    ...
    def get_nubmer_of_gifts(color: str) -> int:
        ...
        Args:
            ...
            color: The color
        """
        from src.tecton_gen_ai.api import get_session_var
...
def test_vector_search(set_default_llm, tecton_vector_db_test_config):
    from src.tecton_gen_ai.factories.vector_db import make_vector_db
