...
def _str_to_type(s: str) -> Type:
    ...
    # Fix for relative imports - if the module doesn't start with 'src.' and it's a tecton_gen_ai module,
    # prepend 'src.' to make it an absolute import
    if "tecton_gen_ai" in mod and not mod.startswith("src."):
        mod = f"src.{mod}"
