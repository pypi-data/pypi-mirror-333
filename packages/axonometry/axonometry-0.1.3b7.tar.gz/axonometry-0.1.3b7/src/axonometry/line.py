...
class Line:
    ...
    def project_into_axo_surface(self, distance: float, length: float) -> None:
        ...
        new_line_1 = self.start.project_into_axo_line(distance=distance, length=length)
        aux_planes = _get_projection_planes(new_line_1)
        new_line_2 = self.end.project_into_axo_line(
            distance=distance,
            length=length,
            ref_plane_keys=aux_planes,
        )
        self.plane.axo.add_line(Line(new_line_1.start, new_line_2.start))
        self.plane.axo.add_line(Line(new_line_1.end, new_line_2.end))
    ...
    def random_line(key: Literal["xy", "yz", "zx", "xyz"] = "xyz") -> Line:
        ...
        if key == "xy":
            start = Point.random_point("xy")
                ...
                [
                    Point.from_xy(start.x + random.randint(10, 50), start.y),  # noqa: S311
                    Point.from_xy(start.x, start.y + random.randint(10, 50)),  # noqa: S311
                ],
            )
        elif key == "yz":
            start = Point.random_point("yz")
                ...
                [
                    Point.from_yz(start.y, start.z + random.randint(10, 50)),  # noqa: S311
                    Point.from_yz(start.y + random.randint(10, 50), start.z),  # noqa: S311
                ],
            )
        elif key == "zx":
            start = Point.random_point("zx")
                ...
                [
                    Point.from_zx(start.z + random.randint(10, 50), start.x),  # noqa: S311
                    Point.from_zx(start.z, start.x + random.randint(10, 50)),  # noqa: S311
                ],
            )
        elif key == "xyz":
            start = Point.random_point()
                ...
                [
                    Point.from_xyz(start.x, start.y, start.z + random.randint(10, 50)),  # noqa: S311
                    Point.from_xyz(start.x + random.randint(10, 50), start.y, start.z),  # noqa: S311
                    Point.from_xyz(start.x, start.y + random.randint(10, 50), start.z),  # noqa: S311
                ],
            )
