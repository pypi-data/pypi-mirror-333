...
class Point:
    ...
    def project_into_axo_line(
        ...
        self.plane.axo.add_line(new_line, ref_plane_keys=ref_plane_keys)
    ...
    def random_point(key: Literal["xy", "yz", "zx", "xyz"] = "xyz") -> Point:
        ...
        """
        return {
            "xy": Point.from_xy(random.randint(-20, 50), random.randint(-20, 50)),  # noqa: S311
            "yz": Point.from_yz(random.randint(-20, 50), random.randint(0, 60)),  # noqa: S311
            "zx": Point.from_zx(random.randint(0, 60), random.randint(-20, 50)),  # noqa: S311
            "xyz": Point.from_xyz(
                random.randint(-20, 50),  # noqa: S311
                random.randint(-20, 50),  # noqa: S311
