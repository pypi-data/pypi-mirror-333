...
class DefaultErrorRoute:
    ...
    def add_default_exceptions_handler(fs_app, debug=False, excs_to_status_codes=None):
        excs_to_status_codes = DefaultErrorRoute.DEFAULT_STATUS_CODE_MAPPINGS if excs_to_status_codes is None else excs_to_status_codes
