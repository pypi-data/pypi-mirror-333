...
from eis.partner-portal import rest
from eis.partner-portal.configuration import Configuration
from eis.partner-portal.exceptions import ApiTypeError, ApiValueError, ApiException, UnauthorizedException
from eis.partner-portal.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = IntermediaryApi()
        api_instance.get_lead  # this is an instance of the class Endpoint
        api_instance.get_lead()  # this invokes api_instance.get_lead.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_lead.callable or self.callable in this class
