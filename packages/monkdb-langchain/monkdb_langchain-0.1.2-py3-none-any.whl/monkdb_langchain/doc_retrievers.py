...
class MonkDBRetriever(BaseRetriever):
    ...
    Setup:
        Install ``monkdb-langchain`` and set environment variable
        ``MONKDB_API_KEY``.

        .. code-block:: bash

            pip install -U monkdb-langchain
    ...
    Instantiate:
        .. code-block:: python
            ...
            from monkdb-langchain import MonkDBRetriever

            retriever = MonkDBRetriever(
                # ...
            )
    ...
    def __init__(self, *args: List[Any], **kwargs: Dict[Any, Any]) -> None:
        raise NotImplementedError("MonkDBRetriever is not completely implemented yet")
