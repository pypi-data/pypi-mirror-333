...
from monkdb_langchain.vector_datastores.main import (
...
class MonkDBVectorStoreMultiCollection(MonkDBVectorStore):
    """
    Provide functionality for searching multiple collections.
    It can not be used for indexing documents.

    To use it, you should have the ``monk_orm`` Python package installed.

    Synopsis::

        from langchain_community.vectorstores.Monkdb import MonkDBVectorStoreMultiCollection

        multisearch = MonkDBVectorStoreMultiCollection(
        ...
        *,
        ...
        Args:
            ...
            use_jsonb: Only provided for compatibility with the PostgreSQL adapter.
                On MonkDB, metadata is stored as OBJECT.
        ...
        if isinstance(connection, str):
            ...
            raise ValueError(
                "A connection must be a connection string or an instance of "
    ...
    def get_collections(self, session: sa.orm.Session) -> Any:
        if self.CollectionStore is None:
            raise RuntimeError(
                "The requested collection can't be accessed without specifying "
    ...
    def similarity_search_with_score_by_vector(
        ...
        assert not self._async_engine, "This method (similarity_search_with_score_by_vector) must be called without async_mode"  # noqa: S101
    ...
    def max_marginal_relevance_search_with_score_by_vector(
        ...
        **kwargs: Any,
        ...
        assert not self._async_engine, "This method (max_marginal_relevance_search_with_score_by_vector) must be called without async_mode"  # noqa: S101
    ...
    def __query_collection(
        ...
        with self._make_sync_session() as session:
            ...
            if not collections:
                raise ValueError("No collections have been found")
    ...
    @classmethod
    def from_texts(
        cls: Type["MonkDBVectorStoreMultiCollection"],
        texts: List[str],
        ...
        **kwargs: Any,
        ...
        raise NotImplementedError(
            "The adapter that you are trying to use for querying multiple collections "
