...
class SSLAnalyzer:
    ...
    def get_certificate_info(self):
        ...
        return {
            ...
            "Valid From": self.cert.not_valid_before.strftime("%Y-%m-%dT%H:%M:%S%z"),
            "Valid Until": self.cert.not_valid_after.strftime("%Y-%m-%dT%H:%M:%S%z"),
    ...
    def analyze(self, output_json=False):
        ...
        return json.dumps(details, indent=4) if output_json else self.format_output(details)

    def format_output(self, cert_details):
