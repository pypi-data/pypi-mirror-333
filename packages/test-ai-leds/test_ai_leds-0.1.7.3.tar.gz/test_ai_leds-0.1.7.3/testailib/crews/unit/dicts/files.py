...
def process_test_and_related_files(found_paths: list):
    ...
    if found_paths and "Test" in found_paths[-1]:
        ...
        enconding = detect_encoding(test_file_path)
        with open(test_file_path, "r", encoding=enconding, errors="ignore") as f:
    ...
    for related_file in found_paths:
        ...
        enconding = detect_encoding(related_file)
        with open(related_file, "r", encoding=enconding, errors="ignore") as f:
