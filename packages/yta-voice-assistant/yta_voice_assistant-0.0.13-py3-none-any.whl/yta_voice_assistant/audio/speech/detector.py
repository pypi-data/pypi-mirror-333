...
class WebSpeechDetector(SpeechDetector):
    ...
    def reset_transcription(
        ...
        """
        Reset the transcription manually, that will
        remove the previous speech history but keep
        recognizing the user speech with the microphone
        on.
        """
        return self.transcriptor.reset_transcription()
    ...
    def get_temp_transcription(
        ...
        """
        return self.transcriptor.get_temp_transcription()
    
    def get_transcription(
        self
    ) -> str:
        """
        Get the text that has been transcripted as a
        definitive transcription.
        """
        return self.transcriptor.get_transcription()
    ...
    def empty_transcription(
        ...
        string.
        """
        return self.transcriptor.empty_transcription()
    ...
    def is_text_in_transcription(
        ...
        """
        Check if the given 'text' has been said by
        looking for in the temporary and definitive
        transcription.
        """
        return self.transcriptor.is_text_in_transcription(text)
    ...
    def is_text_in_temporary_transcription(
        ...
        """
        Check if the given 'text' has been said by
        looking for in the temporary transcription.
        """
        return self.transcriptor.is_text_in_temporary_transcription(text)
    ...
    def is_text_in_definitive_transcription(
        ...
        """
        Check if the given 'text' has been said by
        looking for in the definitive transcription.
        """
        return self.transcriptor.is_text_in_definitive_transcription(text)
...
class WitSpeechDetector(SpeechDetector):
    """
    Class able to detect the user speech by using
    a the Wit platform speech detection engine, and
    the system microphone to detect the input.
