...
def _process_single_event(request: EventRequest, registry, runtime):
    """
...
def trigger_event(request, config_json: Optional[Dict[str, Any]] = None):
    """
    ...
    try:
        ...
        # Process the event using the shared helper function
        return _process_single_event(normalized_request, registry, runtime)
...
def trigger_events(requests, config_json: Optional[Dict[str, Any]] = None):
    """
    ...
    try:
        ...
        for req_item in requests:
            ...
            # Process using the shared helper function
            result = _process_single_event(normalized_request, registry, runtime)
