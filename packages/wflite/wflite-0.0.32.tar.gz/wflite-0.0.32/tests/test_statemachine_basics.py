...
src_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'wflite', 'src'))
sys.path.insert(0, src_path)

from core.statemachine_core import State, Event, Action, Transition, StateMachine
