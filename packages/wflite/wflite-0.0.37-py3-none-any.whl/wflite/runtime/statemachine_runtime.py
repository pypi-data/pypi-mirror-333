...
class StateMachineRuntime:
    ...
    def get_customers_context(self, customer_ids: List[str]) -> Dict[str, Dict]:
        """
        Get the context data for multiple customers at once.
        
        Args:
            customer_ids: List of customer IDs to retrieve contexts for
            
        Returns:
            Dictionary mapping customer IDs to their context data
        """
        result = {}
