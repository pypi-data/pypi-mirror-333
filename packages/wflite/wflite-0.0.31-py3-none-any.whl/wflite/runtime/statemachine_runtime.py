...
class StateMachineRuntime:
    ...
    def trigger_event(self, instance_id: str, event_name: str, template_data: dict, event_details: dict = None) -> tuple[bool, list]:
        """Trigger an event for a state machine instance"""
        ...
        try:
            ...
            success = machine.send_event(event, action_handler=self)
