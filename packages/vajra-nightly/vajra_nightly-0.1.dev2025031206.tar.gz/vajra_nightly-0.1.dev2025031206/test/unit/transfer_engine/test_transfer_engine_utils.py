...
def test_get_matching_other_global_ranks_parameterized(
    ...
    model_config.override_num_layers = num_layers
...
def test_get_matching_other_global_ranks_many_replicas(
    model_config, global_rank, other_replica_id, world_size, mocker
):
    ...
    mocker.patch("torch.distributed.init_process_group")
    mocker.patch("torch.distributed.destroy_process_group")
