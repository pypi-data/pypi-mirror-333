...
struct SequenceParams {
  SequenceParams(const std::string seq_id_param, const std::string prompt_param,
                 const std::vector<std::size_t> prompt_token_ids_param,
                 const std::size_t block_size_param,
                 const std::size_t eos_token_id_param,
...
class Sequence {
 public:
  ...
  inline const std::vector<std::size_t>& GetPromptTokenIds() const {
    return prompt_token_ids_;
  }

  inline const std::vector<std::size_t>& GetOutputTokenIds() const {
  ...
  void AppendTokenId(std::size_t token_id /*[in]*/);
  ...
  std::vector<std::size_t> GetLastNTokenIds(std::size_t n /*[in]*/,
 ...
 private:
  ...
  void AppendTokensToBlocks(const std::vector<std::size_t>& token_ids /*[in]*/);

  std::vector<std::size_t> prompt_token_ids_;
  std::vector<std::size_t> output_token_ids_;
...
class SequenceWithPriority {
 public:
  SequenceWithPriority(std::pair<double, double> priority,
  ...
  std::shared_ptr<Sequence> GetSequence() const { return seq_; }
