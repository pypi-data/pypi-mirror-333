...
Sequence::Sequence(const std::string seq_id_param,
  ...
  AppendTokensToBlocks(prompt_token_ids_param);
}
...
void Sequence::AppendTokenId(std::size_t token_id /*[in]*/) {
  ...
  AppendTokensToBlocks(std::vector<std::size_t>{token_id});
...
std::vector<std::size_t> Sequence::GetLastNTokenIds(
  ...
  if (n <= GetOutputLength()) {
    return std::vector<std::size_t>(output_token_ids_.end() - n,
...
void Sequence::Reset() {
  ...
  prompt_token_ids_.insert(prompt_token_ids_.end(), output_token_ids_.begin(),
                           output_token_ids_.end());
...
void Sequence::AppendTokensToBlocks(
