...
void InitDatatypesPybindSubmodule(py::module_& pm) {
  ...
  py::class_<vajra::SequenceParams>(m, "SequenceParams")
      .def(py::init<std::string, std::string, std::vector<std::size_t>,
                    std::size_t, std::size_t, double, vajra::SamplingParams>(),
      ...
      .def(py::pickle(
          ...
          [](py::tuple t) {  // __setstate__
            ...
            return vajra::SequenceParams(
                ...
                t[2].cast<std::vector<std::size_t>>(), t[3].cast<std::size_t>(),
                t[4].cast<std::size_t>(), t[5].cast<double>(),
                t[6].cast<vajra::SamplingParams>());
          }));
  //==============================================================================
  ...
  //==============================================================================
  py::class_<vajra::SchedulerOutput>(m, "SchedulerOutput")
      .def(py::init<std::size_t, std::vector<std::string>,
                    std::vector<std::string>,
                    std::vector<vajra::SequenceScheduleMetadata>>(),
      ...
      .def(py::pickle(
          ...
          [](py::tuple t) {
            ...
            return vajra::SchedulerOutput(
                ...
                t[3].cast<std::vector<vajra::SequenceScheduleMetadata>>());
          }));
  //==============================================================================
