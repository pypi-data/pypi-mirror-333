...
class BlockSpaceManager {
 public:
   ...
   */
  void Allocate(const std::shared_ptr<Sequence> seq /*[in]*/,
                int num_blocks /*[in]*/);
   ...
   */
  void AllocateDelta(const std::shared_ptr<Sequence> seq /*[in]*/,
   ...
   */
  [[nodiscard]] bool AppendSlot(const std::shared_ptr<Sequence> seq /*[in]*/,
   ...
   */
  void Free(const std::shared_ptr<Sequence> seq /*[in]*/);
