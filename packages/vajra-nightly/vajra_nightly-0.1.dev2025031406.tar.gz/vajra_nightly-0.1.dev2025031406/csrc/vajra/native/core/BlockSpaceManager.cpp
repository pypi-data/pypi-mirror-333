...
void BlockSpaceManager::Allocate(const std::shared_ptr<Sequence> seq /*[in]*/,
                                 int num_blocks /*[in]*/) {
...
void BlockSpaceManager::AllocateDelta(
...
bool BlockSpaceManager::AppendSlot(const std::shared_ptr<Sequence> seq /*[in]*/,
...
void BlockSpaceManager::Free(const std::shared_ptr<Sequence> seq /*[in]*/) {
...
const BlockTablePtr BlockSpaceManager::GetBlockTable(
    const std::shared_ptr<Sequence> seq /*[in]*/) const {
  auto it = block_tables_.find(seq->seq_id);
...
bool BlockSpaceManager::IsAllocated(
    const std::shared_ptr<Sequence> seq /*[in]*/) const {
