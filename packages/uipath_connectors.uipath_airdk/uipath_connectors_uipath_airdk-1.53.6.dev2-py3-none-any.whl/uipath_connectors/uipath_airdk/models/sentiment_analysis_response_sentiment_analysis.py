...
class SentimentAnalysisResponseSentimentAnalysis(BaseModel):
    ...
    sentiment_breakdown_str: Optional[str] = None
    confidence_level: Optional[int] = None
    overall_sentiment_str: Optional[str] = None
    key_phrases_str: Optional[list[str]] = None
    undertones_str: Optional[list[str]] = None
