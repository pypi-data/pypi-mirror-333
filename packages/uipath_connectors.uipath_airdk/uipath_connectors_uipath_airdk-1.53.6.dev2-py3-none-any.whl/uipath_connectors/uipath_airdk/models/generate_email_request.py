...
class GenerateEmailRequest(BaseModel):
    ...
    need_sign_off: bool
    email_content: str
    salutation_string: Optional[GenerateEmailRequestSalutation] = None
    sign_off_string: Optional[GenerateEmailRequestSignOff] = None
    sign_off_name: Optional[str] = None
    total_words: Optional[int] = None
    example: Optional[str] = None
    output_format: Optional[GenerateEmailRequestOutputFormat] = None
    emailContent: Optional[str] = None
    style: Optional[GenerateEmailRequestStyle] = None
    detect_input_language: Optional[bool] = None
    output_language: Optional[GenerateEmailRequestOutputLanguage] = None
