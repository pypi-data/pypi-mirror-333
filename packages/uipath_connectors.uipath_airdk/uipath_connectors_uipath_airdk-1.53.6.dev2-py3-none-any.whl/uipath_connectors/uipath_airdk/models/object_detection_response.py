...
class ObjectDetectionResponse(BaseModel):
    ...
    choices: Optional[list["ObjectDetectionResponseChoicesArrayItemRef"]] = None
    usage: Optional["ObjectDetectionResponseUsage"] = None
    ...
    detected_object_names: Optional[list[str]] = None
    detected_objects_string: Optional[str] = None
