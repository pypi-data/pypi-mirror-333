...
class ContentGenerationRequest(BaseModel):
    ...
    is_pii_enabled: Optional[bool] = None
    is_filter_pii_enabled: Optional[bool] = None
    language_code: Optional[ContentGenerationRequestPIILanguage] = None
    pii_entity_categories: Optional[list[ContentGenerationRequestPIIPHICategory]] = None
    confidence_threshold: Optional[float] = None
    context_grounding: Optional[ContentGenerationRequestContextGrounding] = None
