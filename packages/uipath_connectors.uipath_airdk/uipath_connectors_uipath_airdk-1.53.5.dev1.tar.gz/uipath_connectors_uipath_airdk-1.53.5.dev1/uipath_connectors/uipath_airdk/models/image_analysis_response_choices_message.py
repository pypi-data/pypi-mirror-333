...
T = TypeVar("T", bound="ImageAnalysisResponseChoicesMessage")


@_attrs_define
class ImageAnalysisResponseChoicesMessage:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        image_analysis_response_choices_message = cls(
            content=content,
            role=role,
        )

        image_analysis_response_choices_message.additional_properties = d
        return image_analysis_response_choices_message
