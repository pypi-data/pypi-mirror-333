...
T = TypeVar("T", bound="ImageAnalysisResponseUsage")


@_attrs_define
class ImageAnalysisResponseUsage:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        image_analysis_response_usage = cls(
            total_tokens=total_tokens,
            prompt_tokens=prompt_tokens,
            completion_tokens=completion_tokens,
        )

        image_analysis_response_usage.additional_properties = d
        return image_analysis_response_usage
