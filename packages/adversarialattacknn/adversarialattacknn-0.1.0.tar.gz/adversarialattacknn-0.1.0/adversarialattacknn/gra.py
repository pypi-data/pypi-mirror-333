...
from adversarialattacknn.utils import *  
from adversarialattacknn.attack import Attack
class GRA(Attack):
    """
    GRA Attack
    ...
    Example script:
        ...
        python main.py --input_dir ./path/to/data --output_dir adv_data/gra/resnet18 --eval
    """
