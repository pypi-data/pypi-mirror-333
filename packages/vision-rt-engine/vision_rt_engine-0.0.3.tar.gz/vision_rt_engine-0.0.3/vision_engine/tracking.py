...
def run_image(predictor, im_path):
...
def run_video(predictor, media) -> None:
    ...
    while video_cap.isOpened():
        ...
        cv.imwrite(f'./results/img_{str(ic+1).zfill(4)}.jpg', im_viz)
        ic = ic + 1
...
@click.option('--predictor', type=str, default='auto')
def main(media, model: str, predictor: str) -> None:
