...
####################################################
    ...
    for i in chelt_app.found_payments_from_planned:
        print(i)
    print(100*'Ö')
    for i in chelt_app.not_found_payments_from_planned:
        print(i)
    # print(type(not_found_payments_from_planned), not_found_payments_from_planned.shape)
    # unplanned_real_expenses = chelt_app.find_unplanned_real_expenses(15)
    # for i in unplanned_real_expenses:
    #     print(i)
    ...
    # app_plan.prepareTablePlan(currentConto, selectedStartDate.date(), selectedEndDate.date(), True)
...
################################################################################
    ...
    # print(app_reale.check_1_row_from_chelt_plan(163))
    # realExpenses, realIncome = app_reale.prepareTableReal(currentConto, selectedStartDate, selectedEndDate, True)
    # for rex in realExpenses:
    #     print(rex)
    # print(100*'+')
    # print(realExpenses.shape)
    # print(100 * '-')
    # app_reale.prepareTableReal_new(currentConto, selectedStartDate, selectedEndDate, True)
    # for rex in app_reale.realExpenses:
    #     print(rex)
    # print(100*'+')
