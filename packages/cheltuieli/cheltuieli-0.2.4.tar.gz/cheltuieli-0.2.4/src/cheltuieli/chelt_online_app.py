...
from cheltuieli.chelt_plan import CheltuieliPlanificate, Income, CheltPlusIncome
    ...
    try:
        ...
        try:
            if isinstance(dataFrom, datetime):
                ...
                #ch = CheltPlusIncome(ini_file, conto, dataFrom.date(), dataBis.date())
                ...
                #ch = CheltPlusIncome(ini_file, conto, dataFrom, dataBis)
