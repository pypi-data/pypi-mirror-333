...
class NITFHeader(NITFElement):
    ...
    CLEVEL = _IntegerDescriptor(
        ...
        "accordance with complexity levels established in Table A-10.",
    )  # type: int
    STYPE = _StringDescriptor(
        ...
        "NITF02.10 is intended to be registered as a profile of ISO/IEC IS 12087-5.",
    )  # type: str
    ...
    FDT = _StringDescriptor(
        ...
        "origination in the format `YYYYMMDDhhmmss`.",
    )  # type: str
    FTITLE = _StringDescriptor(
        ...
        80,
        default_value="",
        docstring="File Title. This field shall contain the title of the file.",
    )  # type: str
    ...
    FSCOP = _IntegerDescriptor(
        ...
        5,
        default_value=0,
        docstring="File Copy Number. This field shall contain the copy number of the file.",
    )  # type: int
    ...
    OPHONE = _StringDescriptor(
        ...
        "for the operator who originated the file.",
    )  # type: str
