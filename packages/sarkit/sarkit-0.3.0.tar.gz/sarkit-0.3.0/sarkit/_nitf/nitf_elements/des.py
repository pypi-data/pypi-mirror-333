...
class XMLDESSubheader(NITFElement):
    ...
    DESSHFT = _StringDescriptor(
        ...
        "Examples :code:`XSD, XML, DTD, XSL, XSLT`.",
    )  # type: str
    DESSHDT = _StringDescriptor(
        ...
        "origination in the format :code:`YYYY-MM-DDThh:mm:ssZ`.",
    )  # type: str
    DESSHRP = _StringDescriptor(
        ...
        "organization responsible for the content of the DES.",
    )  # type: str
    ...
    DESSHSV = _StringDescriptor(
        ...
        10,
        default_value="",
        docstring="Specification Version. Version or edition of the specification.",
    )  # type: str
    DESSHSD = _StringDescriptor(
        ...
        "in the format :code:`YYYY-MM-DDThh:mm:ssZ`.",
    )  # type: str
    DESSHTN = _StringDescriptor(
        ...
        "designated within the XML data content.",
    )  # type: str
    ...
    DESSHLPT = _StringDescriptor(
        ...
        25,
        default_value="",
        docstring="Location - Point. Single geographic point applicable to the DES.",
    )  # type: str
    DESSHLI = _StringDescriptor(
        ...
        "Namespace URI shall also be recorded.",
    )  # type: str
    ...
    DESSHABS = _StringDescriptor(
        ...
        200,
        default_value="",
        docstring="Abstract. Brief narrative summary of the content of the DES.",
    )  # type: str
    ...
    @DESSHL.setter
    def DESSHL(self, value):  # noqa N802
        self._DESSHL = 773

    @property
    def DESCRC(self):  # noqa N802
        """
    ...
    @DESCRC.setter
    def DESCRC(self, value):  # noqa N802
        self._DESCRC = 99999
...
class DataExtensionHeader(NITFElement):
    ...
    @DESID.setter
    def DESID(self, value):  # noqa N802
    ...
    @DESOFLW.setter
    def DESOFLW(self, value):  # noqa N802
    ...
    @DESITEM.setter
    def DESITEM(self, value):  # noqa N802
    ...
    def _parse_attribute(cls, fields, attribute, value, start):
        if attribute == "UserHeader":
            ...
            return super(DataExtensionHeader, cls)._parse_attribute(
