...
class TextSegmentHeader(NITFElement):
    ...
    TXTALVL = _IntegerDescriptor(
        ...
        "indicates the attachment level of the text.",
    )  # type: int
    TXTDT = _StringDescriptor(
        ...
        "of the text in the format :code:`YYYYMMDDhhmmss`",
    )  # type: str
    TXTITL = _StringDescriptor(
        ...
        80,
        default_value="",
        docstring="Text Title. This field shall contain the title of the text item.",
    )  # type: str
    ...
    TXTFMT = _StringEnumDescriptor(
        ...
        ":code:`U8S` to indicate U8S text formatting.",
    )  # type: str
