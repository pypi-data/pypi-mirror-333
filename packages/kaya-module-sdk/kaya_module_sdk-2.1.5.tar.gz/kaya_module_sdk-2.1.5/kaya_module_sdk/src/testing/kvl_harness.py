...
class KVL:
    ...
    @pysnooper.snoop()
    def check_rules(self, module: str, dump_report: bool = False, **kwargs) -> dict:
        """
    ...
    @pysnooper.snoop()
    def check_meta(self, module: str, dump_report: bool = False, **kwargs) -> dict:
        """
    ...
    @pysnooper.snoop()
    def check_source(self, file_path: str = "", dump_report: bool = False, **kwargs) -> dict:
        """
