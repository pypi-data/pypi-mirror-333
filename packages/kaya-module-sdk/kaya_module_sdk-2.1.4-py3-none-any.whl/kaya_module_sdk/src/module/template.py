...
class Module(ABC):
    ...
    def _extract_manifest(self) -> dict[str, Any]:
        ...
        type_hints = self._get_type_hints(main_method)
        params_metadata = self._get_params_metadata(main_method, type_hints)
        metadata = self._build_metadata(params_metadata)
        return metadata

    def _get_type_hints(self, method) -> dict:
        """Return the type hints of the method."""
    ...
    def _build_metadata(self, params_metadata: dict) -> dict:
