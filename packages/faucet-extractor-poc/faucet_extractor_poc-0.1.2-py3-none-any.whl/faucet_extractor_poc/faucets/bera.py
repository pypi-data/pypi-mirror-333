...
Classes:
    BeraFaucet: A class to handle the interaction with the Monad faucet.
Functions:
    BeraFaucet.claim(address): Sends a POST request to the faucet with the given address and handles
    the response.
...
class BeraFaucet:
    FAUCET_NAME = "Bera"
    TICKER = "BERA"
    FAUCET_URL = os.getenv("BERA_FAUCET_URL")
