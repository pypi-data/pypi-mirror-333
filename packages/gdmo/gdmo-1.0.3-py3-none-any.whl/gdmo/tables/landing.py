...
class Landing:
    ...
    def put_bronze(self):
        ...
        file_readers = {
            ...
            '.xlsx': lambda path, sheet_name: self._spark.read.format('com.crealytics.spark.excel')
                .option("header", "true")
                .option("useHeader", "true")
                .option("inferSchema", "true")
                .option("sheetName", sheet_name)  # Specify the sheet name here
                .load(path),
            '.xls': lambda path, sheet_name: self._spark.read.format('com.crealytics.spark.excel')
                .option("useHeader", "true")
                .option("inferSchema", "true")
                .option("sheetName", sheet_name)  # Specify the sheet name here
                .load(path)
