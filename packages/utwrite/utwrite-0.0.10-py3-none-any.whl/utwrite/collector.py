...
def get_tests(*tests, test_suite=None):
    ...
    if not (test_suite or tests):
        raise RuntimeError(
            ...
            ' Pass a <TestSuite> sute, directories or tests'
        )
    ...
    for p in test_paths:
        ...
        try:
            ...
            d = loader.discover(p, top_level_dir=top_dir) # this auto adds top_dir to PATH env
        if d.countTestCases():
