...
class MeshClient:
    ...
    def _authenticate_backend_driven(self) -> bool:
        ...
        This method obtains the auth URL from the backend, automatically opens the browser,
        and spawns a local HTTP server on the configured callback port to capture the authorization code.
        It then exchanges the code for token data and stores the token.
        """
    ...
    def _ensure_authenticated(self) -> bool:
        ...
        This method will check if we have a valid token, and if not,
        it will try to authenticate using the backend-driven flow.
