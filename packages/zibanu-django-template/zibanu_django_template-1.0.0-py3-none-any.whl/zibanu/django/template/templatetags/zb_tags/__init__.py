...
register.simple_tag(func=zb_concat, name='zb_concat')
register.filter(name="zb_divide", function=zb_divide)
register.filter(name="zb_multiply", function=zb_multiply)
register.simple_tag(func=zb_query_filter, name='zb_query_filter')
register.tag(name='zb_static_uri', compile_function=zb_static_uri)
register.simple_tag(func=zb_subtotal_dict, name='zb_subtotal_dict')
register.simple_tag(func=zb_sum_dict, name='zb_sum_dict')
