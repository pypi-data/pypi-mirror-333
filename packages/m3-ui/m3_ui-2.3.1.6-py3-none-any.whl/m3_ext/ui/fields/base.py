...
class BaseExtField(ExtUIComponent):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Минимальные длина поля и текст ошибки, если длина не была достигнута
    ...
    def render_base_config(self):
        ...
        for args in (
            ...
            ('contextMenu', self.t_render_context_menu, self.context_menu),
        ):
    ...
    def t_render_context_menu(self):
        """Возвращает рендер контекстного меню"""
        render = None
        ctx_menu = self.context_menu
        if ctx_menu:
            render = self.context_menu.render()
