...
Ext.m3.Window = Ext.extend(Ext.Window, {
	constructor: function(baseConfig, params){
        ...
        if (params && params.helpQtip) {
            this.m3helpQtip = params.helpQtip;
        }
    ...
    initTools: function(){
        if (this.m3HelpTopic){
            ...
            var helpParams = {id: 'help', handler:function(){ showHelpWindow(m3HelpTopic); }};

            if (this.m3helpQtip) {
                helpParams.qtip = this.m3helpQtip;
            }

            this.addTool(helpParams);
        }
