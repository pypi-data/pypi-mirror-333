...
class InitializeJoggingRequest(BaseModel):
    ...
    pause_on_io: Optional[StrictStr] = Field(default=None, description="Defines an I/O that is listened to during the movement. Execution pauses if the defined comparator evaluates to `true`. ")
