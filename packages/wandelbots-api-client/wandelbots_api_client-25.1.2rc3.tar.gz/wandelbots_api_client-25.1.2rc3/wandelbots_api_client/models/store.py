...
STORE_ANY_OF_SCHEMAS = ["ArrayOutput", "Capture", "PointCloud", "PyjectoryDatatypesSerializerOrientation", "PyjectoryDatatypesSerializerPose", "PyjectoryDatatypesSerializerPosition", "bool", "bytearray", "float", "int", "str"]
...
class Store(BaseModel):
    ...
    # data type: bytearray
    anyof_schema_5_validator: Optional[Union[StrictBytes, StrictStr]] = None
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Store.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Store with anyOf schemas: ArrayOutput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Store with anyOf schemas: ArrayOutput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
