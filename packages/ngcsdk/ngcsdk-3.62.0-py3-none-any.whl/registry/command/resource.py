...
class ResourceSubCommand(RegistryCommand):  # noqa: D101
    ...
    @CLICommand.arguments("--sign", help=SIGN_ARG_HELP, action="store_true", feature_tag=PUBLISH_TYPE)
    ...
    @CLICommand.command(name="sign", help=SIGN_HELP, description=SIGN_HELP, feature_tag=PUBLISH_TYPE)
