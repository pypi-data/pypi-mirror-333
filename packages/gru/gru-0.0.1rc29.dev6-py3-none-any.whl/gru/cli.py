...
class MemoryCommands(object):
    def insert(self, agent_name: str, file: str):
        ...
        correlation_id = create_correlation_id()
        print("##############################")
        print("Inside Insert creating correlation id")
        ...
        try:
            ...
            print("##############################")
            print("Printing result after memory insert")
            print(result)
            print("##############################")
            return str(result)
        except FileNotFoundError:
    ...
    def update(self, agent_name: str, file: str):
        ...
        correlation_id = create_correlation_id()
        print("##############################")
        print("Inside Update creating correlation id")
        print(correlation_id)
        print("##############################")
        try:
            auth_token = read_token()
    ...
    def delete(self, agent_name: str, memory_id: str, collection: str):
        ...
        correlation_id = create_correlation_id()
        print("##############################")
        print("Inside Delete creating correlation id")
        print(correlation_id)
        print("##############################")
        try:
            auth_token = read_token()
