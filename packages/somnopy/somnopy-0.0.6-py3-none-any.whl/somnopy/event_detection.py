...
def SP_detection(raw: Raw, stage, target_stage=('N2', 'SWS'), method: str = "Hahn2020",
                 l_freq: float = 10, h_freq: float = 16, dur_lower: float = 0.5, dur_upper: float = math.inf,
...
def swa(raw: Raw, file_name = 'id', l_freq=0.5, h_freq=4):
    """
    ...
    df = pd.DataFrame([data_dict], index=[file_name])
