...
class KsFutuMarketApi(BaseMarketApi):
    ...
    def _is_interval_ing(self, exchange: KsExchange, interval: KsInterval, extended_time: bool = True):
        ...
        if interval == KsInterval.DAILY:
            ...
            ret, days = self.quote_ctx.request_trading_days(my_exchange, start=today_str, end=today_str)
            ...
            ret, week_days = self.quote_ctx.request_trading_days(my_exchange, start=start_of_week.strftime(DATE_FMT), end=end_of_week.strftime(DATE_FMT))
            ...
            ret, month_days = self.quote_ctx.request_trading_days(my_exchange, start=start_of_month.strftime(DATE_FMT), end=end_of_month.strftime(DATE_FMT))
