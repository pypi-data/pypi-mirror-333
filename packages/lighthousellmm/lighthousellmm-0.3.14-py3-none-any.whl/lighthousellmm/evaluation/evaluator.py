...
from lighthousellmm.schemas import SCORE_TYPE, VALUE_TYPE, Example, Run
...
class DynamicRunEvaluator(RunEvaluator):
    ...
    def __init__(
        ...
        wraps(func)(self)
        from lighthousellmm import run_helpers  # type: ignore
    ...
    def evaluate_run(
        ...
        result = self.func(
            run,
            example,
            lighthousellmm_extra={"run_id": evaluator_run_id, "metadata": metadata},
        )
...
class DynamicComparisonRunEvaluator:
    ...
    def compare_runs(
        ...
        result = self.func(
            runs,
            example,
            lighthousellmm_extra={"run_id": source_run_id, "tags": tags},
        )
