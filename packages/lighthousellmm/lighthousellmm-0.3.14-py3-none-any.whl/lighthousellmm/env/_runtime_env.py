...
from lighthousellmm.utils import get_docker_compose_command
from lighthousellmm.env._git import exec_git
...
def get_runtime_environment() -> dict:
    ...
    from lighthousellmm import __version__

    shas = get_release_shas()
    return {
        "sdk": "lighthousellmm-py",
        "sdk_version": __version__,
        "library": "lighthousellmm",
...
def get_langchain_env_var_metadata() -> dict:
    ...
    excluded = {
        ...
        "LANGCHAIN_PROJECT",
        "LANGCHAIN_SESSION",
        "lighthousellmm_RUNS_ENDPOINTS",
    }
    langchain_metadata = {
        k: v
        for k, v in os.environ.items()
        if (k.startswith("LANGCHAIN_") or k.startswith("lighthousellmm_"))
