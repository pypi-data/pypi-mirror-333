...
class Attachment(NamedTuple):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from lighthousellmm.schemas import Attachment
...
class lighthousellmmInfo(BaseModel):
    """Information about the lighthousellmm server."""

    version: str = ""
    """The version of the lighthousellmm server."""
...
class lighthousellmmSettings(BaseModel):
    """Settings for the lighthousellmm tenant."""
