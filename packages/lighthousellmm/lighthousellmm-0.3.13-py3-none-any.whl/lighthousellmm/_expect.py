...
"expectation" feedback to lighthousellmm.
...
Example usage:
    .. code-block:: python
        ...
        def test_output_semantically_close():
            ...
            # Apply an assertion and log 'expectation' feedback to lighthousellmm
...
if TYPE_CHECKING:
    from lighthousellmm._internal._edit_distance import EditDistanceConfig
    from lighthousellmm._internal._embedding_distance import EmbeddingConfig
...
class _Expect:
    ...
    def embedding_distance(
        ...
        *,
        ...
        This logs the embedding distance to lighthousellmm and returns a `_Matcher` instance
        ...
        Examples:
            ...
            ... ).to_be_less_than(1.0)
        """  # noqa: E501
        from lighthousellmm._internal._embedding_distance import EmbeddingDistance
    ...
    def edit_distance(
        ...
        *,
        ...
        This logs the string distance (Damerau-Levenshtein) to lighthousellmm and returns
        ...
        """
        from lighthousellmm._internal._edit_distance import EditDistance
    ...
    def score(
        ...
        *,
        ...
        """Log a numeric score to lighthousellmm.
        ...
        Examples:
            ...
            <lighthousellmm._expect._Matcher object at ...>
