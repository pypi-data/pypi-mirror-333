...
class TracingMiddleware:
    """Middleware for propagating distributed tracing context using lighthousellmm.

    This middleware checks for the 'lighthousellmm-trace' header and propagates the
    ...
    def __init__(self, app):
        ...
        from lighthousellmm.run_helpers import tracing_context  # type: ignore
    ...
    async def __call__(self, scope: dict, receive, send):
        ...
        If the request is HTTP and contains the 'lighthousellmm-trace' header,
        ...
        if scope["type"] == "http" and "headers" in scope:
            ...
            if b"lighthousellmm-trace" in headers:
