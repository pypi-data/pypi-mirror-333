...
from lighthousellmm.evaluation.evaluator import DynamicRunEvaluator
...
class LangChainStringEvaluator:
    ...
    Examples:
        ...
        >>> from lighthousellmm.evaluation import LangChainStringEvaluator, evaluate
    ...
    def as_run_evaluator(
        ...
        This is the object used in the lighthousellmm `evaluate` API.
