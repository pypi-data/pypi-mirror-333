...
from lighthousellmm import run_trees, schemas
...
async def aevaluate(
    ...
    **kwargs: Any,
    ...
    Examples:
        ...
        >>> from lighthousellmm import Client, aevaluate
...
async def aevaluate_existing(
    ...
    Examples:
        ...
        >>> from lighthousellmm import aevaluate, aevaluate_existing
        >>> dataset_name = "Evaluate Examples"
        >>> async def apredict(inputs: dict) -> dict:
        ...     # This can be any async function or just an API call to your app.
        ...     await asyncio.sleep(0.1)
...
async def _aforward(
    fn: rh.SupportslighthousellmmExtra[[dict], Awaitable],
...
def _ensure_async_traceable(
    target: ATARGET_T,
) -> rh.SupportslighthousellmmExtra[[dict], Awaitable]:
