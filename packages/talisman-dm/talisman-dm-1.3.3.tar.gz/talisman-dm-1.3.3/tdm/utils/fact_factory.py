...
from tdm.datamodel.domain import AtomValueType, ComponentValueType, DocumentType, PropertyType, RelationPropertyType, RelationType
...
def build_prop_fact_factory(type_: AbstractDomainType, fact_type: _PropertyType) -> LinkFactsFactory:
...
def _(type_: PropertyType):
    return build_prop_fact_factory(type_, PropertyFact)


@link_fact_factory.register(RelationPropertyType)
def _(type_: RelationPropertyType):
    return build_prop_fact_factory(type_, RelationPropertyFact)


@link_fact_factory.register(ComponentValueType)
def _(type_: ComponentValueType):
    return build_prop_fact_factory(type_, ComponentFact)
