...
const extension = {
    ...
    activate: async (app, themeManager, notebookTracker, toolbarRegistry, restorer) => {
        ...
        // Replace logo
        setTimeout(() => (0,_services_theme_manager__WEBPACK_IMPORTED_MODULE_10__.replaceLogo)(_style_enverge_svg__WEBPACK_IMPORTED_MODULE_14__), 2000);
...
const updateLogoColors = (svgElement, themeManager) => {
    ...
    // Find all text elements in the SVG and update their fill color
    const textElements = svgElement.querySelectorAll('text, path:not([fill="#00A3E0"])');
...
//# sourceMappingURL=lib_index_js.c720ee30c5039b99c404.js.map