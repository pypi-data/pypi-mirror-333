...
if __name__ == '__main__':
    test_dir_path = Path("I:/5.6专案/酒店住宿记录")
    file_path = test_dir_path.joinpath("郑州市管城回族区悦诗风酒店.xls")
    output_path = test_dir_path.joinpath("郑州市管城回族区悦诗风酒店.xlsx")
    format_excel_file(file_path, output_path)
