...
.u      add other functions ... CHMI weather, goog, webcont, CALENDAR
...
tool_setMeetingRecord = {
                    ...
                    "function": {
                        ...
                        "description": "record the meeting date, name and content, date in the form %Y%m%d ",
                        "parameters": {
                            "type": "object",
                            "properties": {
                                "date_": {
                ...
                #                 "name": "date",
                #                 "type": "string",
                #                 "description": "date in the format %Y%m%d",
                #             },
                #             {
                #                 "name": "hint",
                #                 "type": "string",
                #                 "description": "one or few words/name that characterize the meeting",
                #             },
                #             {
                #                 "name": "content",
                #                 "type": "string",
                #                 "description": "full information on the meeting, also links if present",
                #             },
                #         ],
                #     }
                # }
