...
tool_setMeetingRecord = {
                    ...
                    "function": {
                        ...
                        "description": "For a future meeting/event/task/deadline record the date, name and content to a calendar.",
                        "parameters": {
                            "type": "object",
                            "properties": {
                                "date_": {
