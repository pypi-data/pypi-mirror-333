...
class ApiIntegrationModel():
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from an APIIntegration.
    ...
    def from_dict(cls, obj: dict) -> ApiIntegrationModel:
        ...
        This method constructs an APIIntegration object from a dictionary with the key-value pairs of its properties.
        ...
        _______
        ApiIntegration
            an APIIntegration object created using the input dictionary; this will fail if the required properties are missing.
        """
