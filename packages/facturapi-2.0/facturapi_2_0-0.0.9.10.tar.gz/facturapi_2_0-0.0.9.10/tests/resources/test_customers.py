...
def test_create_customer():
    ...
    customer = Customer.create(data=customer_request)
    print(customer)
    assert customer.id
...
def test_retrieve_customer():
    ...
    retrieved_customer = Customer.retrieve(id=customer.id)
...
def test_query_customer_one():
    customer = Customer.one(q='Remedios')
    assert customer.id
...
def test_query_customer_first_none():
    customer = Customer.first(q='Diego Rivera')
