...
def extract_playwright_instruction(
    source: str,
) -> list[tuple[str, tuple[list[str | float | int], dict[str, str | float | int]]]]:
...
def extract_python_arguments(source_arguments: str) -> tuple[list[str | float | int], dict[str, str | float | int]]:
