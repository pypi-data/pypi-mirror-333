const __vite__fileDeps=["./vega-embed.module.uKrolT3e.js","./vega-tooltip.module.O7l2FxoC.js","./2.BUksOkfw.js","./preload-helper.DpQnamwV.js","./stores.C1obKUVA.js","./client.D0D9u9ac.js","../assets/2.CK2n6Tfl.css","./dsv.CKxpOsHB.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { B as Block, q as BlockTitle, S as Static } from "./2.BUksOkfw.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await __vitePreload(() => import("./vega-embed.module.uKrolT3e.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0, import.meta.url)).default;
    }
