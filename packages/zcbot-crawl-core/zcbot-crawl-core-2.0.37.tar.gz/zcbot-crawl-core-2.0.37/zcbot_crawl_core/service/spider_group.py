...
def get_spider_group_list(group_code: str = None, plat_codes: List[str] = None, enable: int = None, auth_user_name: str = None):
    row = auth_user_spider_group_dao.get_spider_group(auth_user_name=auth_user_name, group_code=group_code, plat_code=plat_code, enable=enable)
    if not row:
