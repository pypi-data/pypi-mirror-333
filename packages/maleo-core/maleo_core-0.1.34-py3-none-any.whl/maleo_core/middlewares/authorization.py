...
class AuthorizationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request:Request, call_next:RequestResponseEndpoint):
        ...
        print("URL's Path:", request.url.path)
        print("Path Parameters:", request.path_params)
        print("URL's Query:", request.url.query)
        ...
        if allowed_role_ids == "*":
            ...
            response = await self._authenticate_and_authorize(request, allowed_role_ids, call_next)
