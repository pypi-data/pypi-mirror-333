"""
Simple example showing the magical integration of OpenAPI-MCP with a FastAPI app.
"""
...
app = FastAPI(
    title="Example API",
    description="A simple example API with automatic MCP integration",
    version="0.1.0",
)
...
# The magic happens here - just one line to add a fully functional MCP server!
# OpenAPI-MCP automatically converts all your FastAPI endpoints to MCP tools
...
if __name__ == "__main__":
    ...
    print("\n✨ MAGIC IN ACTION ✨")
    print("Starting FastAPI app with automatic MCP integration")
    print("The OpenAPI specification is available at: http://localhost:8000/openapi.json")
    print("The MCP server is available at: http://localhost:8000/mcp")
    print("All your API endpoints are automatically available as MCP tools!")
    print("Connect to this MCP server in Claude to access the API\n")
