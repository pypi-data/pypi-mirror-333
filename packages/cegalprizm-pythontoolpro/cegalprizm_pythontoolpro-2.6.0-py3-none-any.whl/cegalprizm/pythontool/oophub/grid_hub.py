...
from cegalprizm.pythontool.grpc.petrelinterface_pb2 import PetrelObjectRef, ProtoBool, AxesRange, Primitives
from cegalprizm.pythontool.grpc.petrelinterface_pb2 import Grid_VerticesPositions_Reply, Grid_GetIjk_Response
from cegalprizm.pythontool.grpc.petrelinterface_pb2 import Grid_GetPositions_Response, Grid_GetProperties_Response
from cegalprizm.pythontool.grpc.petrelinterface_pb2 import Grid_GetDictionaryProperties_Response, Grid_GetNumberOfGridProperties_Response
from cegalprizm.pythontool.grpc.petrelinterface_pb2 import Grid_GetZones_Response, Grid_GetNumberOfZones_Response
from cegalprizm.pythontool.grpc.petrelinterface_pb2 import Grid_GetSegments_Response, Grid_GetNumberOfSegments_Response
