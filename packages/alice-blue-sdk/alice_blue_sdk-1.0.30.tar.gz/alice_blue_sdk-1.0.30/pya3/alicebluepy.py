...
class Aliceblue:
    ...
    def get_session_id(self, data=None):
        ...
        res ="eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICIyam9lOFVScGxZU3FTcDB3RDNVemVBQkgxYkpmOE4wSDRDMGVVSWhXUVAwIn0..ESsIk02RAaYXjD0zbzLPZWoMrcOHeB9fwAB0xGiYEiF-IcXN2X4gZUVzFkoeRBMxYRI97ZVCu47fJ8gxbmym4NSVCvuLuT9Go40Uha8AqKFmMVbhHDyByqD1uDN5vaOuFBt6P3lbHARvrpGZ8gURjA1WjUFw4eHl4eBGdeKOayG3Ei1bNvvroSrevB3TQwjhZKC-xfWPfusmFfLcTkBriGnhprJaa9k0AcGMU5mYETyEUctZcy9BCsIG-Z6bNzCaRvBZ2R0mllH3sWy2uQRSqdKQBOJKaH4wyo8ajarrAwbgSYad7ig_C2k3Y57MHBqusWj8_Sz2ms1NnJVS6QN9HA"
        return res
    ...
    def place_order(self, instrumentId, exchange, transaction_type, quantity, product_type, orderComplexity, order_type,validity,                    is_ioc=False
        ...
        if exchange is None:
            raise TypeError("Required parameter exchange not of type Exchange")
        ...
        if orderComplexity is None:
            raise TypeError("Required parameter product_type not of type OrderComplexity")
