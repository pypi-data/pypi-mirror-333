...
/* Define to 1 if you have the <aff4/libaff4-c.h> header file. */
/* #undef HAVE_AFF4_LIBAFF4_C_H */
...
/* Define to 1 if you have the 'aff4' library (-laff4). */
/* #undef HAVE_LIBAFF4 */
...
#define PACKAGE_STRING "sleuthkit 4.13.0"
