...
def extractVectors(values: gtsam.gtsam.Values, c: str) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
    ...
def insertBackprojections(values: gtsam.gtsam.Values, c: gtsam.gtsam.PinholeCameraCal3_S2, J: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], Z: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], depth: float) -> None:
    ...
def insertProjectionFactors(graph: gtsam.gtsam.NonlinearFactorGraph, i: int, J: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, 1]"], Z: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], model: gtsam.gtsam.noiseModel.Base, K: gtsam.gtsam.Cal3_S2, body_P_sensor: gtsam.gtsam.Pose3 = ...) -> None:
    ...
@typing.overload
