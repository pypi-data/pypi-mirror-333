...
class UsersApiMock:
    ...
    def __init__(self):
        ...
        self.mock_create_support_user = MagicMock()
    ...
    def create_support_user(self, *args, **kwargs):
        """
        This method mocks the original api UsersApi.create_support_user with MagicMock.
        """
        return self.mock_create_support_user(self, *args, **kwargs)
