...
[**create_support_user**](UsersApi.md#create_support_user) | **POST** /v1/support_users | Create a support user
...
[**delete_support_user**](UsersApi.md#delete_support_user) | **DELETE** /v1/support_users/{support_user_id} | Delete a support user
...
[**get_support_user**](UsersApi.md#get_support_user) | **GET** /v1/support_users/{support_user_id} | Get a support user
...
[**update_support_user**](UsersApi.md#update_support_user) | **PUT** /v1/support_users/{support_user_id} | Update a support user&#39;s expiry
...
# **create_support_user**
> SupportUser create_support_user(support_user)
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a support user
        api_response = api_instance.create_support_user(support_user)
        pprint(api_response)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->create_support_user: %s\n" % e)
```
...
# **delete_support_user**
> delete_support_user(support_user_id)
...
with agilicus_api.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = users_api.UsersApi(api_client)
    support_user_id = "1234" # str | support_user_id path
    org_id = "1234" # str | Organisation Unique identifier (optional)

    # example passing only required values which don't have defaults set
    try:
        # Delete a support user
        api_instance.delete_support_user(support_user_id)
    except agilicus_api.ApiException as e:
    ...
    try:
        # Delete a support user
        api_instance.delete_support_user(support_user_id, org_id=org_id)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->delete_support_user: %s\n" % e)
```
...
# **get_support_user**
> SupportUser get_support_user(support_user_id)
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a support user
        api_response = api_instance.get_support_user(support_user_id)
        pprint(api_response)
    except agilicus_api.ApiException as e:
    ...
    try:
        # Get a support user
        api_response = api_instance.get_support_user(support_user_id, org_id=org_id)
        pprint(api_response)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->get_support_user: %s\n" % e)
```
...
# **update_support_user**
> SupportUser update_support_user(support_user_id)
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a support user's expiry
        api_response = api_instance.update_support_user(support_user_id)
        pprint(api_response)
    except agilicus_api.ApiException as e:
    ...
    try:
        # Update a support user's expiry
        api_response = api_instance.update_support_user(support_user_id, support_user=support_user)
        pprint(api_response)
    except agilicus_api.ApiException as e:
        print("Exception when calling UsersApi->update_support_user: %s\n" % e)
```
