    ...
    if not isinstance(fields, list):
        errors.append(
            Error(
                ...
                id=f"product_workflow.E002_{config_name}",
            )
        )
        ...
        errors.append(
            Error(
                ...
                id=f"product_workflow.E003_{config_name}",
            )
        )
    else:
        ...
        if invalid_fields:
            errors.append(
                Error(
                    ...
                    id=f"product_workflow.E004_{config_name}",
                )
            )
    ...
    if not isinstance(setting_value, str):
        errors.append(
            Error(
                ...
                id=f"product_workflow.E009_{setting_name}",
            )
        )
        return errors
    ...
    try:
        ...
        errors.append(
            Error(
                ...
                id=f"product_workflow.E010_{setting_name}",
            )
        )
    ...
    if not isinstance(setting_value, list):
        errors.append(
            Error(
                ...
                id=f"product_workflow.E011_{setting_name}",
            )
        )
        return errors
        ...
        if not isinstance(path, str):
            errors.append(
                Error(
                    ...
                    id=f"product_workflow.E012_{setting_name}",
                )
            )
        else:
            ...
            try:
                ...
                errors.append(
                    Error(
                        ...
                        id=f"product_workflow.E013_{setting_name}",
                    )
                )
