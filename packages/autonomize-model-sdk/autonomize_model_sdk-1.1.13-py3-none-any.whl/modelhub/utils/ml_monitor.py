"""Utility for generating model metrics and reports using Evidently AI."""
...
class EvidentlyMonitor:
    """Utility for working with Evidently AI for model monitoring and metrics."""
    ...
    def __init__(self, mlflow_client=None):
        """
        Initialize the EvidentlyMonitor.
    ...
    def create_column_mapping(
        ...
        Returns:
            An Evidently column mapping configuration.
        """
    ...
    def _create_report(
        ...
        **kwargs,
        ...
        Args:
            report_type: Type of report to create ('data_drift', 'regression', etc.)
            reference_data: Reference dataset
    ...
    def generate_report(
        ...
        Args:
            ...
            reference_data: Reference dataset
            current_data: Current dataset
            target_column: Target column name (for performance reports)
            prediction_column: Prediction column name (for performance reports)
        ...
        try:
            ...
            if save_json or report_name or log_to_mlflow:
                ...
                if log_to_mlflow:
                    self.log_report_directly(report, report_name, artifact_path, run_id)
    ...
    def log_report_directly(
        ...
        """
        Log Evidently report as MLflow artifact with a clean, direct structure.
