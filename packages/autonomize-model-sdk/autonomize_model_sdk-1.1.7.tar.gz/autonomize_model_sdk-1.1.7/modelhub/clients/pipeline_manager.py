...
class PipelineManager(BaseClient):
    ...
    def __init__(self, base_url=None, sa_client_id=None, sa_client_secret=None, token=None, genesis_client_id: Optional[int] = None,genesis_copilot_id: Optional[UUID] = None):
        """
