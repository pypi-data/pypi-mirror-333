...
/* harmony export */   APP_VA_ENDPOINT: () => (/* binding */ APP_VA_ENDPOINT),
/* harmony export */   BOT_VA_ENDPOINT: () => (/* binding */ BOT_VA_ENDPOINT),
/* harmony export */   HELP_VA_ENDPOINT: () => (/* binding */ HELP_VA_ENDPOINT),
/* harmony export */   VA_ENDPOINT: () => (/* binding */ VA_ENDPOINT)
/* harmony export */ });
// src/globals.ts
const VA_ENDPOINT = "https://voiceatlas.com";
const APP_VA_ENDPOINT = "https://app.voiceatlas.com";
const HELP_VA_ENDPOINT = "https://help.voiceatlas.com";
const BOT_VA_ENDPOINT = "https://bot.voiceatlas.com/v1/chatlas.js";
...
/* harmony import */ var _widgets_AboutVoiceAtlas__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./widgets/AboutVoiceAtlas */ "./lib/widgets/AboutVoiceAtlas.js");
/* harmony import */ var _widgets_ChatlasDropdownMenuWidget__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./widgets/ChatlasDropdownMenuWidget */ "./lib/widgets/ChatlasDropdownMenuWidget.js");
/* harmony import */ var _widgets_EditSettingsWidget__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./widgets/EditSettingsWidget */ "./lib/widgets/EditSettingsWidget.js");
...
async function activate(app, settingRegistry, mainMenu, notebookTracker, panel) {
    ...
    commands.addCommand(createNewAtlas, {
        ...
        execute: () => {
            const url = _globals__WEBPACK_IMPORTED_MODULE_10__.APP_VA_ENDPOINT;
            window.open(url);
        }
    });
    commands.addCommand(aboutVoiceAtlas, {
        ...
        execute: async () => {
            const { aboutBody, aboutTitle } = (0,_widgets_AboutVoiceAtlas__WEBPACK_IMPORTED_MODULE_11__.aboutVoiceAtlasDialog)();
    ...
    commands.addCommand(helpVoiceAtlas, {
        ...
        caption: 'Help.',
        execute: () => {
            const url = _globals__WEBPACK_IMPORTED_MODULE_10__.HELP_VA_ENDPOINT;
            window.open(url);
        }
    });
    ...
    notebookTracker.currentChanged.connect(async (_, panel) => {
        ...
        if (panel) {
            ...
            panel.context.ready.then(async () => {
                ...
                globalApp = app;
                const chatlasDropdownMenu = new _widgets_ChatlasDropdownMenuWidget__WEBPACK_IMPORTED_MODULE_12__.ChatlasDropdownWidget(atlasId);
                ...
                chatlasDropdownMenu.menuOptionChanged.connect(async (_, menuOption) => {
                    ...
                    if (lodash_isequal__WEBPACK_IMPORTED_MODULE_4___default()(menuOption, 'set')) {
                        const newAtlasID = await (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showDialog)({
                            body: new _widgets_EditSettingsWidget__WEBPACK_IMPORTED_MODULE_13__["default"](atlasId || ""),
...
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../globals */ "./lib/globals.js");
...
function aboutVoiceAtlasDialog() {
    ...
    const externalLinks = (react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "jp-About-externalLinks" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", { href: _globals__WEBPACK_IMPORTED_MODULE_2__.VA_ENDPOINT, target: "_blank", rel: "noopener noreferrer", className: "jp-Button-flat" }, "About Voice Atlas")));
...
class ChatlasWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    ...
    static createChatlasWidget(atlasId, notebookName) {
        ...
        script.setAttribute("src", _globals__WEBPACK_IMPORTED_MODULE_1__.BOT_VA_ENDPOINT);
...
//# sourceMappingURL=lib_index_js.f07a0d932f2fae8cd872.js.map