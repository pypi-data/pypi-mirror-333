...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "pulp_last_updated", "content_guard", "pulp_labels", "name", "hidden", "prn", "base_url", "pulp_href", "base_path", "pulp_created"]
