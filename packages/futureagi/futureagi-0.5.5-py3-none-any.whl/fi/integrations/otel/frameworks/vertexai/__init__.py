...
from fi.integrations.otel.frameworks.vertexai.package import _instruments
from fi.integrations.otel.frameworks.vertexai.version import __version__
...
class VertexAIInstrumentor(BaseInstrumentor):  # type: ignore
    ...
    def _instrument(self, **kwargs: Any) -> None:
        ...
        from fi.integrations.otel.frameworks.vertexai._wrapper import _Wrapper
