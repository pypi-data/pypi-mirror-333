...
from fi.integrations.otel.frameworks.llama_index.package import _instruments
from fi.integrations.otel.frameworks.llama_index.version import __version__
...
class LlamaIndexInstrumentor(BaseInstrumentor):  # type: ignore
    ...
    def _instrument(self, **kwargs: Any) -> None:
        ...
        if self._use_legacy_callback_handler:
            ...
            from fi.integrations.otel.frameworks.llama_index._callback import (
                FiTraceCallbackHandler,
            )
...
def get_current_span() -> Optional[Span]:
    ...
    from fi.integrations.otel.frameworks.llama_index._handler import _SpanHandler
