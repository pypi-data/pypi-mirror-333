...
from fi.integrations.otel.frameworks.mistralai._chat_wrapper import (
    _AsyncChatWrapper,
    _AsyncStreamChatWrapper,
    _SyncChatWrapper,
)
from fi.integrations.otel.frameworks.mistralai.package import _instruments
from fi.integrations.otel.frameworks.mistralai.version import __version__
...
class MistralAIInstrumentor(BaseInstrumentor):  # type: ignore
    ...
    def _instrument(self, **kwargs: Any) -> None:
        ...
        wrap_function_wrapper(
            ...
            wrapper=_AsyncChatWrapper(
                "MistralAsyncClient.chat", self._tracer, mistralai
            ),
        )
        ...
        wrap_function_wrapper(
            ...
            wrapper=_AsyncChatWrapper(
                "MistralAsyncClient.agents", self._tracer, mistralai
            ),
        )
