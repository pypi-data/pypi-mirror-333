...
from fi.integrations.otel.frameworks.bedrock._wrappers import (
    _InvokeModelWithResponseStream,
)
from fi.integrations.otel.frameworks.bedrock.package import _instruments
from fi.integrations.otel.frameworks.bedrock.utils.anthropic import _extract_image_data
from fi.integrations.otel.frameworks.bedrock.version import __version__
