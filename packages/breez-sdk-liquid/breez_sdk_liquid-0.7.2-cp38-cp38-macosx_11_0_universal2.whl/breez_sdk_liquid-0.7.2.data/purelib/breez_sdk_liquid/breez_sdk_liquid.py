...
_UniffiConverterCallbackInterfaceEventListener = _UniffiCallbackInterfaceFfiConverter()
...
# The _UniffiConverter which transforms the Callbacks in to Handles to pass to Rust.
_UniffiConverterCallbackInterfaceLogger = _UniffiCallbackInterfaceFfiConverter()
...
class _UniffiTraitImplSigner:
    ...
    def xpub(
        ...
        uniffi_obj = _UniffiConverterCallbackInterfaceSigner._handle_map.get(uniffi_handle)
        def make_call():
            args = ()
    ...
    @_UNIFFI_CALLBACK_INTERFACE_FREE
    def _uniffi_free(uniffi_handle):
        _UniffiConverterCallbackInterfaceSigner._handle_map.remove(uniffi_handle)
...
# The _UniffiConverter which transforms the Callbacks in to Handles to pass to Rust.
_UniffiConverterCallbackInterfaceSigner = _UniffiCallbackInterfaceFfiConverter()
...
def connect_with_signer(req: "ConnectWithSignerRequest",signer: "Signer") -> "BindingLiquidSdk":
    ...
    _UniffiConverterCallbackInterfaceSigner.check_lower(signer)
