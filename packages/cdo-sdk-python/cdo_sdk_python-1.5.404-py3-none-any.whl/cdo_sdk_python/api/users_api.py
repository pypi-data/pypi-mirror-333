...
class UsersApi:
    ...
    def get_api_only_users(
        ...
        Get a list of API-only users associated with the Security Cloud Control Firewall Cloud Manager tenant.
    ...
    def get_users(
        ...
        Get a list of (non-API-only) users associated with the Security Cloud Control tenant. Note: This endpoint returns only human users, not API-only users.
