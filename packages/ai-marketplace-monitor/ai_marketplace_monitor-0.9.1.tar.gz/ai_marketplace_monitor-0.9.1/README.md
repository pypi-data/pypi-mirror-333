...
- **Commercial Users**: If you have a commercial license, detailed instructions on configuring the SMTP service we provide will be sent to you via email.
...
_AI Marketplace Monitor_ does support anonymous searching if you hold an active commercial license.
...
- 💖 [Become a sponsor](https://github.com/sponsors/BoPeng): upport the development and maintenance of this tool. Any contribution, no matter how small, is deeply appreciated.
...
- **SMTP service**: Send up to 20 email notifications per day.
...
- **AI Service**: Conduct up to 1,000 AI-based listing evaluations daily.
