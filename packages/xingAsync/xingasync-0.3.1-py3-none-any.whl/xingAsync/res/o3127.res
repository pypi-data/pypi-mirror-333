BEGIN_FUNCTION_MAP
	.Func,해외선물옵션관심종목조회(o3127)-API용,o3127,attr,block,svr=OVS,headtype=A;
	BEGIN_DATA_MAP
	o3127InBlock,기본입력,input;
	begin
		건수,nrec,nrec,long,4;
	end
	o3127InBlock1,기본입력1,input,occurs;
	begin
		시장구분,mktgb,mktgb,char,1;
		종목심볼,symbol,symbol,char,16;
	end
	o3127OutBlock,출력,output,occurs;
	begin
