BEGIN_FUNCTION_MAP
.Feed, 해외옵션 현재가체결(WOC), WOC, attr, svr=OVS, key=8, group=1;
    BEGIN_DATA_MAP
    InBlock,입력,input;
    begin
    ...
    begin
		...
		체결가격         , curpr      , curpr     , double ,   15.9;
		전일대비         , ydiffpr    , ydiffpr   , double ,   15.9;
		전일대비기호     , ydiffSign  , ydiffSign , char   ,   1;
		시가			 , open		  , open	  , double ,   15.9;
		고가			 , high		  , high	  , double ,   15.9;
		저가			 , low 		  , low 	  , double ,   15.9;
