...
class ElkDatastoreGenerator:
    ...
    def setVars(self,app,paas_name,sec_zone,phase,cid,reg,size):
        ...
        with open("C:/Users/sarao/Documents/Amadeus_Workplace/nosql-paas-inventory/tools/nosql_bulk_automation_package_tst/fileGenerator/sizings/cb_sizing.yaml", 'r') as file:
