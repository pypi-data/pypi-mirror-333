...
class ACNGenerator:
    ...
    def acnGenerator(self,datastore,app,paas_name,sec_zone,phase,cid,reg,LZ,size):
        ...
        if datastore=='Elasticsearch':
            ...
            C:\Users\sarao\Documents\Amadeus_Workplace\nosql-bulk-automation-package-tst\nosql_bulk_automation_package_tst\fileGenerator\sizings\acn_sizing.yaml
            with open("nosql_bulk_automation_package_tst/fileGenerator/sizings/acn_sizing.yaml", 'r') as file:
