...
class CouchbaseDatastoreGenerator:
    ...
    def setVars(self,k8s,phase,cid,reg,size):
        ...
        size_dict={}
        # if size=='S':
        #     size_dict={ 'memoryLimit':'220Mi',
        #                 'memoryRequest':'170Mi',
        #                 'cpuRequest':'20m'}
        # elif size=='M':
        #     size_dict={ 'memoryLimit':'440Mi',
        #                 'memoryRequest':'200Mi',
        #                 'cpuRequest':'50m'}
        # else :
        #     size_dict={ 'memoryLimit':'650Mi',
        #                 'memoryRequest':'300Mi',
        #                 'cpuRequest':'100m'}
        # new_dict.update(size_dict)
    

        # tools/nosql_bulk_automation_package_tst/fileGenerator/sizings/cb_sizing.yaml
        # with open("../sizing/cb_sizing.yaml", 'r') as file:

        # exit(0)
        with open("nosql_bulk_automation_package_tst/fileGenerator/sizings/cb_sizing.yaml", 'r') as file:
