...
T = TypeVar("T", bound="SearchIssuebyJQLFieldsCreatorAvatarUrls")


@_attrs_define
class SearchIssuebyJQLFieldsCreatorAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_fields_creator_avatar_urls = cls(
        ...
        search_issueby_jql_fields_creator_avatar_urls.additional_properties = d
        return search_issueby_jql_fields_creator_avatar_urls
