...
T = TypeVar("T", bound="GetIssueResponseFieldsAssignee")


@_attrs_define
class GetIssueResponseFieldsAssignee:
    """
    Attributes:
        account_id (Union[Unset, str]):
        account_type (Union[Unset, str]):
        active (Union[Unset, bool]):
        avatar_urls (Union[Unset, GetIssueResponseFieldsAssigneeAvatarUrls]):
    ...
    avatar_urls: Union[Unset, "GetIssueResponseFieldsAssigneeAvatarUrls"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = GetIssueResponseFieldsAssigneeAvatarUrls.from_dict(
                _avatar_urls
            )
        ...
        get_issue_response_fields_assignee = cls(
        ...
        get_issue_response_fields_assignee.additional_properties = d
        return get_issue_response_fields_assignee
