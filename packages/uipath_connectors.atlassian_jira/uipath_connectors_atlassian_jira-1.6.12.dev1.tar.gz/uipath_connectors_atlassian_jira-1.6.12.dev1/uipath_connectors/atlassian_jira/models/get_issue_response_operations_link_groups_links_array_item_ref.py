...
T = TypeVar("T", bound="GetIssueResponseOperationsLinkGroupsLinksArrayItemRef")


@_attrs_define
class GetIssueResponseOperationsLinkGroupsLinksArrayItemRef:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_operations_link_groups_links_array_item_ref = cls(
            href=href,
        ...
        get_issue_response_operations_link_groups_links_array_item_ref.additional_properties = d
        return get_issue_response_operations_link_groups_links_array_item_ref
