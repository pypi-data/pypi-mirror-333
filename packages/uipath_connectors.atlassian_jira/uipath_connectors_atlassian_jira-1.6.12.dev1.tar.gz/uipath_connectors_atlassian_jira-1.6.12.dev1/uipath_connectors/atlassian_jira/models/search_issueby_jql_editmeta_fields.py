...
T = TypeVar("T", bound="SearchIssuebyJQLEditmetaFields")


@_attrs_define
class SearchIssuebyJQLEditmetaFields:
    """
    Attributes:
        ...
        schema (Union[Unset, SearchIssuebyJQLEditmetaFieldsSchema]):
    """
    ...
    schema: Union[Unset, "SearchIssuebyJQLEditmetaFieldsSchema"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_schema, Unset):
            ...
            schema = SearchIssuebyJQLEditmetaFieldsSchema.from_dict(_schema)

        search_issueby_jql_editmeta_fields = cls(
        ...
        search_issueby_jql_editmeta_fields.additional_properties = d
        return search_issueby_jql_editmeta_fields
