...
T = TypeVar("T", bound="GetIssueResponseOperationsLinkGroupsGroupsHeader")


@_attrs_define
class GetIssueResponseOperationsLinkGroupsGroupsHeader:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_operations_link_groups_groups_header = cls(
            href=href,
        ...
        get_issue_response_operations_link_groups_groups_header.additional_properties = d
        return get_issue_response_operations_link_groups_groups_header
