...
T = TypeVar("T", bound="SearchIssuebyJQLChangelogHistoriesHistoryMetadataCause")


@_attrs_define
class SearchIssuebyJQLChangelogHistoriesHistoryMetadataCause:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_changelog_histories_history_metadata_cause = cls(
        ...
        search_issueby_jql_changelog_histories_history_metadata_cause.additional_properties = d
        return search_issueby_jql_changelog_histories_history_metadata_cause
