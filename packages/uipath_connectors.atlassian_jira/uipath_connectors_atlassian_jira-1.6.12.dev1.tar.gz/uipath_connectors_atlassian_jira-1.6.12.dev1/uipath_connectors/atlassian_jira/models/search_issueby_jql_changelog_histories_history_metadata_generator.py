...
T = TypeVar("T", bound="SearchIssuebyJQLChangelogHistoriesHistoryMetadataGenerator")


@_attrs_define
class SearchIssuebyJQLChangelogHistoriesHistoryMetadataGenerator:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_changelog_histories_history_metadata_generator = cls(
        ...
        search_issueby_jql_changelog_histories_history_metadata_generator.additional_properties = d
        return search_issueby_jql_changelog_histories_history_metadata_generator
