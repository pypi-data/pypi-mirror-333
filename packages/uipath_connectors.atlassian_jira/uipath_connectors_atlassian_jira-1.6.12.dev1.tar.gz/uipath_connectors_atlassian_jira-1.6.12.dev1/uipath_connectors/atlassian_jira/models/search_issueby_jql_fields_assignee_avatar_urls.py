...
T = TypeVar("T", bound="SearchIssuebyJQLFieldsAssigneeAvatarUrls")


@_attrs_define
class SearchIssuebyJQLFieldsAssigneeAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_fields_assignee_avatar_urls = cls(
        ...
        search_issueby_jql_fields_assignee_avatar_urls.additional_properties = d
        return search_issueby_jql_fields_assignee_avatar_urls
