...
T = TypeVar("T", bound="GetIssueResponseHistoryMetadataCause")


@_attrs_define
class GetIssueResponseHistoryMetadataCause:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_history_metadata_cause = cls(
        ...
        get_issue_response_history_metadata_cause.additional_properties = d
        return get_issue_response_history_metadata_cause
