...
T = TypeVar("T", bound="GetIssueResponseFieldsProjectAvatarUrls")


@_attrs_define
class GetIssueResponseFieldsProjectAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_fields_project_avatar_urls = cls(
        ...
        get_issue_response_fields_project_avatar_urls.additional_properties = d
        return get_issue_response_fields_project_avatar_urls
