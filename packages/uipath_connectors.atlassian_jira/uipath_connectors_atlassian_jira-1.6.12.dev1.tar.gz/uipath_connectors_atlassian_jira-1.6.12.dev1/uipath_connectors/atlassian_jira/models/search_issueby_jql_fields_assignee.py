...
T = TypeVar("T", bound="SearchIssuebyJQLFieldsAssignee")


@_attrs_define
class SearchIssuebyJQLFieldsAssignee:
    """
    Attributes:
        account_id (Union[Unset, str]):
        account_type (Union[Unset, str]):
        active (Union[Unset, bool]):
        avatar_urls (Union[Unset, SearchIssuebyJQLFieldsAssigneeAvatarUrls]):
    ...
    avatar_urls: Union[Unset, "SearchIssuebyJQLFieldsAssigneeAvatarUrls"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = SearchIssuebyJQLFieldsAssigneeAvatarUrls.from_dict(
                _avatar_urls
            )
        ...
        search_issueby_jql_fields_assignee = cls(
        ...
        search_issueby_jql_fields_assignee.additional_properties = d
        return search_issueby_jql_fields_assignee
