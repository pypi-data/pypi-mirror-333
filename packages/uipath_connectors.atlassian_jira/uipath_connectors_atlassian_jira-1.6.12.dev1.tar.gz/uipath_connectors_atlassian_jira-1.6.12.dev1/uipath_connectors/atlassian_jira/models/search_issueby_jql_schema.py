...
T = TypeVar("T", bound="SearchIssuebyJQLSchema")


@_attrs_define
class SearchIssuebyJQLSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_schema.additional_properties = d
        return search_issueby_jql_schema
