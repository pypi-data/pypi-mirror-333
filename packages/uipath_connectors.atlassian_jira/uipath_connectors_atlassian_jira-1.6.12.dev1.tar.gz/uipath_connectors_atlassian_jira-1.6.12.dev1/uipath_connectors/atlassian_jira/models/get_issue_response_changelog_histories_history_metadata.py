...
T = TypeVar("T", bound="GetIssueResponseChangelogHistoriesHistoryMetadata")


@_attrs_define
class GetIssueResponseChangelogHistoriesHistoryMetadata:
    """
    Attributes:
        ...
        actor (Union[Unset, GetIssueResponseChangelogHistoriesHistoryMetadataActor]):
        cause (Union[Unset, GetIssueResponseChangelogHistoriesHistoryMetadataCause]):
        ...
        email_description_key (Union[Unset, str]): The description key of the email address associated the history
            record
        generator (Union[Unset, GetIssueResponseChangelogHistoriesHistoryMetadataGenerator]):
    ...
    generator: Union[
        Unset, "GetIssueResponseChangelogHistoriesHistoryMetadataGenerator"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_actor, Unset):
            ...
            actor = GetIssueResponseChangelogHistoriesHistoryMetadataActor.from_dict(
                _actor
            )
        ...
        if isinstance(_cause, Unset):
            ...
            cause = GetIssueResponseChangelogHistoriesHistoryMetadataCause.from_dict(
                _cause
            )
        ...
        if isinstance(_generator, Unset):
            ...
            generator = (
                GetIssueResponseChangelogHistoriesHistoryMetadataGenerator.from_dict(
                    _generator
                )
            )
        ...
        get_issue_response_changelog_histories_history_metadata = cls(
        ...
        get_issue_response_changelog_histories_history_metadata.additional_properties = d
        return get_issue_response_changelog_histories_history_metadata
