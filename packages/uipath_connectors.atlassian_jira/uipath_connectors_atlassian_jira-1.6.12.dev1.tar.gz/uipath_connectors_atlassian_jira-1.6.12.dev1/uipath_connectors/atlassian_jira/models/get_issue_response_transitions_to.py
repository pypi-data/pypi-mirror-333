...
T = TypeVar("T", bound="GetIssueResponseTransitionsTo")


@_attrs_define
class GetIssueResponseTransitionsTo:
    """
    Attributes:
        ...
        status_category (Union[Unset, GetIssueResponseTransitionsToStatusCategory]):
    """
    ...
    status_category: Union[Unset, "GetIssueResponseTransitionsToStatusCategory"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_status_category, Unset):
            ...
            status_category = GetIssueResponseTransitionsToStatusCategory.from_dict(
                _status_category
            )

        get_issue_response_transitions_to = cls(
        ...
        get_issue_response_transitions_to.additional_properties = d
        return get_issue_response_transitions_to
