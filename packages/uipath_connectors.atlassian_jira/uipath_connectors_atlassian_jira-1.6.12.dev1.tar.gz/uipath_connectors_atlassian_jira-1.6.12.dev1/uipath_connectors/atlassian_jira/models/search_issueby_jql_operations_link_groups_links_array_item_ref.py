...
T = TypeVar("T", bound="SearchIssuebyJQLOperationsLinkGroupsLinksArrayItemRef")


@_attrs_define
class SearchIssuebyJQLOperationsLinkGroupsLinksArrayItemRef:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_operations_link_groups_links_array_item_ref = cls(
            href=href,
        ...
        search_issueby_jql_operations_link_groups_links_array_item_ref.additional_properties = d
        return search_issueby_jql_operations_link_groups_links_array_item_ref
