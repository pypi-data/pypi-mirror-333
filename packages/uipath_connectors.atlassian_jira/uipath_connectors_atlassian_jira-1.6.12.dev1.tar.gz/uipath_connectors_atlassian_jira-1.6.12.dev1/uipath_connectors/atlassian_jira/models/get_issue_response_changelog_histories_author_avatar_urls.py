...
T = TypeVar("T", bound="GetIssueResponseChangelogHistoriesAuthorAvatarUrls")


@_attrs_define
class GetIssueResponseChangelogHistoriesAuthorAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_changelog_histories_author_avatar_urls = cls(
        ...
        get_issue_response_changelog_histories_author_avatar_urls.additional_properties = d
        return get_issue_response_changelog_histories_author_avatar_urls
