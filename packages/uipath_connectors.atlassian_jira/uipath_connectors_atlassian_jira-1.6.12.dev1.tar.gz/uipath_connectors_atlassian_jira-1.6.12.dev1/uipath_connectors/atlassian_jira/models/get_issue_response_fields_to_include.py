...
T = TypeVar("T", bound="GetIssueResponseFieldsToInclude")


@_attrs_define
class GetIssueResponseFieldsToInclude:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_fields_to_include = cls(
            actually_included=actually_included,
            excluded=excluded,
            included=included,
        )

        get_issue_response_fields_to_include.additional_properties = d
        return get_issue_response_fields_to_include
