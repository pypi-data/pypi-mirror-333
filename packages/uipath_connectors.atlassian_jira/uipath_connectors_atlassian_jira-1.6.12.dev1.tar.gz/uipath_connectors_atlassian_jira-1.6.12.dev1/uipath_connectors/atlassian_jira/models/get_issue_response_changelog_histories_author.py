...
T = TypeVar("T", bound="GetIssueResponseChangelogHistoriesAuthor")


@_attrs_define
class GetIssueResponseChangelogHistoriesAuthor:
    """
    Attributes:
        ...
        avatar_urls (Union[Unset, GetIssueResponseChangelogHistoriesAuthorAvatarUrls]):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = GetIssueResponseChangelogHistoriesAuthorAvatarUrls.from_dict(
                _avatar_urls
            )
        ...
        get_issue_response_changelog_histories_author = cls(
        ...
        get_issue_response_changelog_histories_author.additional_properties = d
        return get_issue_response_changelog_histories_author
