...
T = TypeVar("T", bound="GetIssueResponseFieldsReporter")


@_attrs_define
class GetIssueResponseFieldsReporter:
    """
    Attributes:
        account_id (Union[Unset, str]):
        account_type (Union[Unset, str]):
        active (Union[Unset, bool]):
        avatar_urls (Union[Unset, GetIssueResponseFieldsReporterAvatarUrls]):
    ...
    avatar_urls: Union[Unset, "GetIssueResponseFieldsReporterAvatarUrls"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = GetIssueResponseFieldsReporterAvatarUrls.from_dict(
                _avatar_urls
            )
        ...
        get_issue_response_fields_reporter = cls(
        ...
        get_issue_response_fields_reporter.additional_properties = d
        return get_issue_response_fields_reporter
