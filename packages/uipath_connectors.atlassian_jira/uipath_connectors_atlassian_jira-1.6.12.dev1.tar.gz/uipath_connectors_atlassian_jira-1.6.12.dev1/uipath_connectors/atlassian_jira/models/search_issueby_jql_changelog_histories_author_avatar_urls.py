...
T = TypeVar("T", bound="SearchIssuebyJQLChangelogHistoriesAuthorAvatarUrls")


@_attrs_define
class SearchIssuebyJQLChangelogHistoriesAuthorAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_changelog_histories_author_avatar_urls = cls(
        ...
        search_issueby_jql_changelog_histories_author_avatar_urls.additional_properties = d
        return search_issueby_jql_changelog_histories_author_avatar_urls
