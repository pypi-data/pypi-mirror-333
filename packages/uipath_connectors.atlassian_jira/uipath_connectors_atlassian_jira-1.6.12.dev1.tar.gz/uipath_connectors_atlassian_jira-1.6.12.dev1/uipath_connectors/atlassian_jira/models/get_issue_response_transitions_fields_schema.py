...
T = TypeVar("T", bound="GetIssueResponseTransitionsFieldsSchema")


@_attrs_define
class GetIssueResponseTransitionsFieldsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_transitions_fields_schema = cls(
            custom=custom,
            custom_id=custom_id,
            items=items,
            system=system,
        ...
        get_issue_response_transitions_fields_schema.additional_properties = d
        return get_issue_response_transitions_fields_schema
