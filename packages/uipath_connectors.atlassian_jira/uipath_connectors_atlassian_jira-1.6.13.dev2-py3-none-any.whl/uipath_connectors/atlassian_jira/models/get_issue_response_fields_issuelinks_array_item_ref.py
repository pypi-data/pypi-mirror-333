...
class GetIssueResponseFieldsIssuelinksArrayItemRef(BaseModel):
    ...
    outward_issue: Optional["GetIssueResponseFieldsIssuelinksOutwardIssue"] = None
    inward_issue: Optional["GetIssueResponseFieldsIssuelinksInwardIssue"] = None
    type_: Optional["GetIssueResponseFieldsIssuelinksType"] = None
