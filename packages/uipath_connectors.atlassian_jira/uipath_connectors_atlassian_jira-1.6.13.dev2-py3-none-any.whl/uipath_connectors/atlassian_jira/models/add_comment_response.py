...
class AddCommentResponse(BaseModel):
    ...
    author: Optional["AddCommentResponseAuthor"] = None
    created: Optional[datetime.datetime] = None
    update_author: Optional["AddCommentResponseUpdateAuthor"] = None
    visibility: Optional["AddCommentResponseVisibility"] = None
