...
class FindUserByEmail(BaseModel):
    ...
    account_type: Optional[FindUserByEmailAccountType] = None
    active: Optional[bool] = None
    application_roles: Optional["FindUserByEmailApplicationRoles"] = None
    avatar_urls: Optional["FindUserByEmailAvatarUrls"] = None
    display_name: Optional[str] = None
    email_address: Optional[str] = None
    expand: Optional[str] = None
    groups: Optional["FindUserByEmailGroups"] = None
