...
class GetIssueResponseTransition(BaseModel):
    ...
    error_collection: Optional["GetIssueResponseTransitionErrorCollection"] = None
    expand: Optional[str] = None
    fields: Optional["GetIssueResponseTransitionFields"] = None
    ...
    to: Optional["GetIssueResponseTransitionTo"] = None
