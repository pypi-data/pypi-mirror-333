...
class GetComments(BaseModel):
    ...
    author: Optional["GetCommentsAuthor"] = None
    body: Optional[str] = None
    created: Optional[datetime.datetime] = None
    id: Optional[str] = None
    jsd_public: Optional[bool] = None
    properties: Optional[list["GetCommentsPropertiesArrayItemRef"]] = None
    rendered_body: Optional[str] = None
    self_: Optional[str] = None
    update_author: Optional["GetCommentsUpdateAuthor"] = None
    updated: Optional[datetime.datetime] = None
    visibility: Optional["GetCommentsVisibility"] = None
