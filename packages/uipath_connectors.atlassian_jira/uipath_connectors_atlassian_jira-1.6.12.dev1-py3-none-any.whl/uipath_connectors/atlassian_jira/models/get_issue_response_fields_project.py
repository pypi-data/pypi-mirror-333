...
T = TypeVar("T", bound="GetIssueResponseFieldsProject")


@_attrs_define
class GetIssueResponseFieldsProject:
    """
    Attributes:
        avatar_urls (Union[Unset, GetIssueResponseFieldsProjectAvatarUrls]):
        id (Union[Unset, str]):
        key (Union[Unset, str]): Enter the project name or key to begin
    ...
    avatar_urls: Union[Unset, "GetIssueResponseFieldsProjectAvatarUrls"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = GetIssueResponseFieldsProjectAvatarUrls.from_dict(
                _avatar_urls
            )
        ...
        get_issue_response_fields_project = cls(
        ...
        get_issue_response_fields_project.additional_properties = d
        return get_issue_response_fields_project
