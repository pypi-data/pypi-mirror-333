...
T = TypeVar("T", bound="GetCommentsUpdateAuthor")


@_attrs_define
class GetCommentsUpdateAuthor:
    """
    Attributes:
        ...
        avatar_urls (Union[Unset, GetCommentsUpdateAuthorAvatarUrls]):
    ...
    avatar_urls: Union[Unset, "GetCommentsUpdateAuthorAvatarUrls"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = GetCommentsUpdateAuthorAvatarUrls.from_dict(_avatar_urls)
        ...
        get_comments_update_author = cls(
        ...
        get_comments_update_author.additional_properties = d
        return get_comments_update_author
