...
T = TypeVar("T", bound="SearchIssuebyJQLFieldsProjectAvatarUrls")


@_attrs_define
class SearchIssuebyJQLFieldsProjectAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_fields_project_avatar_urls = cls(
        ...
        search_issueby_jql_fields_project_avatar_urls.additional_properties = d
        return search_issueby_jql_fields_project_avatar_urls
