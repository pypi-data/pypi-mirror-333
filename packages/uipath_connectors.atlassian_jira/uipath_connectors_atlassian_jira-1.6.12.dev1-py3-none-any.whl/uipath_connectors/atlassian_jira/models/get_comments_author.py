...
T = TypeVar("T", bound="GetCommentsAuthor")


@_attrs_define
class GetCommentsAuthor:
    """
    Attributes:
        ...
        avatar_urls (Union[Unset, GetCommentsAuthorAvatarUrls]):
    ...
    avatar_urls: Union[Unset, "GetCommentsAuthorAvatarUrls"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = GetCommentsAuthorAvatarUrls.from_dict(_avatar_urls)
        ...
        get_comments_author.additional_properties = d
        return get_comments_author
