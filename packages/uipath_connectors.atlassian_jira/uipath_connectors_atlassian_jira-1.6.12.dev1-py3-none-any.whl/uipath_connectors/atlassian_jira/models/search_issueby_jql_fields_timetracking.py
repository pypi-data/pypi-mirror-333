...
T = TypeVar("T", bound="SearchIssuebyJQLFieldsTimetracking")


@_attrs_define
class SearchIssuebyJQLFieldsTimetracking:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_fields_timetracking = cls(
            original_estimate=original_estimate,
            remaining_estimate=remaining_estimate,
        )

        search_issueby_jql_fields_timetracking.additional_properties = d
        return search_issueby_jql_fields_timetracking
