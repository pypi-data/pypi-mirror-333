...
T = TypeVar("T", bound="AddAttachmentResponseAuthorAvatarUrls")


@_attrs_define
class AddAttachmentResponseAuthorAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        add_attachment_response_author_avatar_urls = cls(
        ...
        add_attachment_response_author_avatar_urls.additional_properties = d
        return add_attachment_response_author_avatar_urls
