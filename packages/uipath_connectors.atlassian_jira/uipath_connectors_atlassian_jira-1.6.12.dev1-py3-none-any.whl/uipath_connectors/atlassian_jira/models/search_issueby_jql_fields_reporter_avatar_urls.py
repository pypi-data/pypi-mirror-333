...
T = TypeVar("T", bound="SearchIssuebyJQLFieldsReporterAvatarUrls")


@_attrs_define
class SearchIssuebyJQLFieldsReporterAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_fields_reporter_avatar_urls = cls(
        ...
        search_issueby_jql_fields_reporter_avatar_urls.additional_properties = d
        return search_issueby_jql_fields_reporter_avatar_urls
