...
T = TypeVar("T", bound="GetIssueResponseFieldsCreatorAvatarUrls")


@_attrs_define
class GetIssueResponseFieldsCreatorAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_fields_creator_avatar_urls = cls(
        ...
        get_issue_response_fields_creator_avatar_urls.additional_properties = d
        return get_issue_response_fields_creator_avatar_urls
