...
T = TypeVar("T", bound="GetIssueResponseChangelogHistoriesItemsArrayItemRef")


@_attrs_define
class GetIssueResponseChangelogHistoriesItemsArrayItemRef:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_changelog_histories_items_array_item_ref = cls(
            field=field,
            field_id=field_id,
            fieldtype=fieldtype,
            from_=from_,
        ...
        get_issue_response_changelog_histories_items_array_item_ref.additional_properties = d
        return get_issue_response_changelog_histories_items_array_item_ref
