...
T = TypeVar("T", bound="GetIssueResponseHistoryMetadataActor")


@_attrs_define
class GetIssueResponseHistoryMetadataActor:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_history_metadata_actor = cls(
        ...
        get_issue_response_history_metadata_actor.additional_properties = d
        return get_issue_response_history_metadata_actor
