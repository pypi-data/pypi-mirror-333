...
T = TypeVar("T", bound="GetIssueResponseTransitionFields")


@_attrs_define
class GetIssueResponseTransitionFields:
    """
    Attributes:
        ...
        schema (Union[Unset, GetIssueResponseTransitionFieldsSchema]):
    """
    ...
    schema: Union[Unset, "GetIssueResponseTransitionFieldsSchema"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_schema, Unset):
            ...
            schema = GetIssueResponseTransitionFieldsSchema.from_dict(_schema)

        get_issue_response_transition_fields = cls(
        ...
        get_issue_response_transition_fields.additional_properties = d
        return get_issue_response_transition_fields
