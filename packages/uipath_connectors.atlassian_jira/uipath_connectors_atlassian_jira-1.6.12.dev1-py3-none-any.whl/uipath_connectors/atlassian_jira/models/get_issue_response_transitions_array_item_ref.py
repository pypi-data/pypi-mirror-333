...
T = TypeVar("T", bound="GetIssueResponseTransitionsArrayItemRef")


@_attrs_define
class GetIssueResponseTransitionsArrayItemRef:
    """
    Attributes:
        expand (Union[Unset, str]): Expand options that include additional transition details in the response
        fields (Union[Unset, GetIssueResponseTransitionsFields]):
        ...
        to (Union[Unset, GetIssueResponseTransitionsTo]):
    """

    expand: Union[Unset, str] = UNSET
    fields: Union[Unset, "GetIssueResponseTransitionsFields"] = UNSET
    ...
    to: Union[Unset, "GetIssueResponseTransitionsTo"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        from ..models.get_issue_response_transitions_to import (
        ...
        if isinstance(_fields, Unset):
            ...
            fields = GetIssueResponseTransitionsFields.from_dict(_fields)
        ...
        if isinstance(_to, Unset):
            ...
            to = GetIssueResponseTransitionsTo.from_dict(_to)

        get_issue_response_transitions_array_item_ref = cls(
            expand=expand,
            fields=fields,
        ...
        get_issue_response_transitions_array_item_ref.additional_properties = d
        return get_issue_response_transitions_array_item_ref
