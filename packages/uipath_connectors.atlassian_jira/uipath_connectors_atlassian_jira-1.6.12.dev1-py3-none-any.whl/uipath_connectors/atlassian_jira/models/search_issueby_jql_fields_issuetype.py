...
T = TypeVar("T", bound="SearchIssuebyJQLFieldsIssuetype")


@_attrs_define
class SearchIssuebyJQLFieldsIssuetype:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_fields_issuetype = cls(
            avatar_id=avatar_id,
        ...
        search_issueby_jql_fields_issuetype.additional_properties = d
        return search_issueby_jql_fields_issuetype
