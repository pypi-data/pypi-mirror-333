...
T = TypeVar("T", bound="GetIssueResponseFieldsVotes")


@_attrs_define
class GetIssueResponseFieldsVotes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_fields_votes = cls(
            has_voted=has_voted,
            self_=self_,
            votes=votes,
        )

        get_issue_response_fields_votes.additional_properties = d
        return get_issue_response_fields_votes
