...
T = TypeVar("T", bound="GetIssueResponseChangelogHistoriesHistoryMetadataActor")


@_attrs_define
class GetIssueResponseChangelogHistoriesHistoryMetadataActor:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_changelog_histories_history_metadata_actor = cls(
        ...
        get_issue_response_changelog_histories_history_metadata_actor.additional_properties = d
        return get_issue_response_changelog_histories_history_metadata_actor
