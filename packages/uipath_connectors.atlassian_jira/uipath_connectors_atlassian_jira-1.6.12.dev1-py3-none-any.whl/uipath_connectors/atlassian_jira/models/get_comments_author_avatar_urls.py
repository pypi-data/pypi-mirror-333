...
T = TypeVar("T", bound="GetCommentsAuthorAvatarUrls")


@_attrs_define
class GetCommentsAuthorAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_comments_author_avatar_urls = cls(
        ...
        get_comments_author_avatar_urls.additional_properties = d
        return get_comments_author_avatar_urls
