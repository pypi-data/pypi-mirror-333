...
T = TypeVar("T", bound="GetIssueResponseFieldsCreator")


@_attrs_define
class GetIssueResponseFieldsCreator:
    """
    Attributes:
        account_id (Union[Unset, str]):
        account_type (Union[Unset, str]):
        active (Union[Unset, bool]):
        avatar_urls (Union[Unset, GetIssueResponseFieldsCreatorAvatarUrls]):
    ...
    avatar_urls: Union[Unset, "GetIssueResponseFieldsCreatorAvatarUrls"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = GetIssueResponseFieldsCreatorAvatarUrls.from_dict(
                _avatar_urls
            )
        ...
        get_issue_response_fields_creator = cls(
        ...
        get_issue_response_fields_creator.additional_properties = d
        return get_issue_response_fields_creator
