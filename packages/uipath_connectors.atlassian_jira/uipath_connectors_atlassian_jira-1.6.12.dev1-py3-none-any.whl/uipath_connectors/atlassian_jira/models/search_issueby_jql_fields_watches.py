...
T = TypeVar("T", bound="SearchIssuebyJQLFieldsWatches")


@_attrs_define
class SearchIssuebyJQLFieldsWatches:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_fields_watches = cls(
            is_watching=is_watching,
            self_=self_,
            watch_count=watch_count,
        )

        search_issueby_jql_fields_watches.additional_properties = d
        return search_issueby_jql_fields_watches
