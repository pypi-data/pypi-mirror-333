...
T = TypeVar("T", bound="SearchIssuebyJQLTransitionsTo")


@_attrs_define
class SearchIssuebyJQLTransitionsTo:
    """
    Attributes:
        ...
        status_category (Union[Unset, SearchIssuebyJQLTransitionsToStatusCategory]):
    """
    ...
    status_category: Union[Unset, "SearchIssuebyJQLTransitionsToStatusCategory"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_status_category, Unset):
            ...
            status_category = SearchIssuebyJQLTransitionsToStatusCategory.from_dict(
                _status_category
            )

        search_issueby_jql_transitions_to = cls(
        ...
        search_issueby_jql_transitions_to.additional_properties = d
        return search_issueby_jql_transitions_to
