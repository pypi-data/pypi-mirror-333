...
T = TypeVar("T", bound="GetIssueResponseChangelogHistoriesHistoryMetadataGenerator")


@_attrs_define
class GetIssueResponseChangelogHistoriesHistoryMetadataGenerator:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_changelog_histories_history_metadata_generator = cls(
        ...
        get_issue_response_changelog_histories_history_metadata_generator.additional_properties = d
        return get_issue_response_changelog_histories_history_metadata_generator
