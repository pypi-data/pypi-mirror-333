...
T = TypeVar("T", bound="SearchIssuebyJQLFieldsReporter")


@_attrs_define
class SearchIssuebyJQLFieldsReporter:
    """
    Attributes:
        account_id (Union[Unset, str]):
        account_type (Union[Unset, str]):
        active (Union[Unset, bool]):
        avatar_urls (Union[Unset, SearchIssuebyJQLFieldsReporterAvatarUrls]):
    ...
    avatar_urls: Union[Unset, "SearchIssuebyJQLFieldsReporterAvatarUrls"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = SearchIssuebyJQLFieldsReporterAvatarUrls.from_dict(
                _avatar_urls
            )
        ...
        search_issueby_jql_fields_reporter = cls(
        ...
        search_issueby_jql_fields_reporter.additional_properties = d
        return search_issueby_jql_fields_reporter
