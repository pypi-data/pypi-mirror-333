...
T = TypeVar("T", bound="AddAttachmentResponseAuthor")


@_attrs_define
class AddAttachmentResponseAuthor:
    """
    Attributes:
        ...
        avatar_urls (Union[Unset, AddAttachmentResponseAuthorAvatarUrls]):
    ...
    avatar_urls: Union[Unset, "AddAttachmentResponseAuthorAvatarUrls"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_avatar_urls, Unset):
            ...
            avatar_urls = AddAttachmentResponseAuthorAvatarUrls.from_dict(_avatar_urls)
        ...
        add_attachment_response_author = cls(
        ...
        add_attachment_response_author.additional_properties = d
        return add_attachment_response_author
