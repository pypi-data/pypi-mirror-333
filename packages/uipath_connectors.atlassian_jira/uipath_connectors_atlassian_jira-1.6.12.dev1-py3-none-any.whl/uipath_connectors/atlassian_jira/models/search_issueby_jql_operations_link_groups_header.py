...
T = TypeVar("T", bound="SearchIssuebyJQLOperationsLinkGroupsHeader")


@_attrs_define
class SearchIssuebyJQLOperationsLinkGroupsHeader:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_operations_link_groups_header = cls(
            href=href,
        ...
        search_issueby_jql_operations_link_groups_header.additional_properties = d
        return search_issueby_jql_operations_link_groups_header
