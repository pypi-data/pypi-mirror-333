...
T = TypeVar("T", bound="GetIssueResponseTransitionsFields")


@_attrs_define
class GetIssueResponseTransitionsFields:
    """
    Attributes:
        ...
        schema (Union[Unset, GetIssueResponseTransitionsFieldsSchema]):
    """
    ...
    schema: Union[Unset, "GetIssueResponseTransitionsFieldsSchema"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_schema, Unset):
            ...
            schema = GetIssueResponseTransitionsFieldsSchema.from_dict(_schema)

        get_issue_response_transitions_fields = cls(
        ...
        get_issue_response_transitions_fields.additional_properties = d
        return get_issue_response_transitions_fields
