...
T = TypeVar("T", bound="GetIssueResponseSchema")


@_attrs_define
class GetIssueResponseSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_schema.additional_properties = d
        return get_issue_response_schema
