...
T = TypeVar("T", bound="SearchIssuebyJQLTransitionsFieldsSchema")


@_attrs_define
class SearchIssuebyJQLTransitionsFieldsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_transitions_fields_schema = cls(
            custom=custom,
            custom_id=custom_id,
            items=items,
            system=system,
        ...
        search_issueby_jql_transitions_fields_schema.additional_properties = d
        return search_issueby_jql_transitions_fields_schema
