...
T = TypeVar("T", bound="SearchIssuebyJQLChangelogHistoriesHistoryMetadataActor")


@_attrs_define
class SearchIssuebyJQLChangelogHistoriesHistoryMetadataActor:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        search_issueby_jql_changelog_histories_history_metadata_actor = cls(
        ...
        search_issueby_jql_changelog_histories_history_metadata_actor.additional_properties = d
        return search_issueby_jql_changelog_histories_history_metadata_actor
