...
T = TypeVar("T", bound="GetIssueResponseFieldsReporterAvatarUrls")


@_attrs_define
class GetIssueResponseFieldsReporterAvatarUrls:
    """
    Attributes:
        field_16x16 (Union[Unset, str]):
        field_24x24 (Union[Unset, str]):
        field_32x32 (Union[Unset, str]):
        field_48x48 (Union[Unset, str]):
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_issue_response_fields_reporter_avatar_urls = cls(
        ...
        get_issue_response_fields_reporter_avatar_urls.additional_properties = d
        return get_issue_response_fields_reporter_avatar_urls
