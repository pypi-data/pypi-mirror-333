...
T = TypeVar("T", bound="GetIssueResponseEditmetaFields")


@_attrs_define
class GetIssueResponseEditmetaFields:
    """
    Attributes:
        ...
        schema (Union[Unset, GetIssueResponseEditmetaFieldsSchema]):
    """
    ...
    schema: Union[Unset, "GetIssueResponseEditmetaFieldsSchema"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_schema, Unset):
            ...
            schema = GetIssueResponseEditmetaFieldsSchema.from_dict(_schema)

        get_issue_response_editmeta_fields = cls(
        ...
        get_issue_response_editmeta_fields.additional_properties = d
        return get_issue_response_editmeta_fields
