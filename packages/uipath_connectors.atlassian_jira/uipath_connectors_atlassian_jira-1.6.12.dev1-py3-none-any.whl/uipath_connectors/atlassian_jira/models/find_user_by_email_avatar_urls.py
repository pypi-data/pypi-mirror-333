...
T = TypeVar("T", bound="FindUserByEmailAvatarUrls")


@_attrs_define
class FindUserByEmailAvatarUrls:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        find_user_by_email_avatar_urls = cls(
        ...
        find_user_by_email_avatar_urls.additional_properties = d
        return find_user_by_email_avatar_urls
