...
from project.sparta_22da4d4238.qube_fbf3ee2fbe import timeout
from project.sparta_8f29384cd2.sparta_ccd7e0da68.qube_67447782f4 import convert_to_dataframe,sparta_85e1a912d2
from project.sparta_8f29384cd2.sparta_ccd7e0da68.qube_56413a793d import sparta_21526a056d
from project.logger_config import logger
B_DEBUG=_B
SEND_INTERVAL=.8
def sparta_cbda99e107():return conf_settings.DEFAULT_TIMEOUT
def sparta_a752bd97f2(file_path=_A,text=_A):
	A=file_path
...
class IPythonKernel:
	...
	async def initialize_kernel(B):
		...
		A+='django.setup()\n';D=sparta_f7d2e15968()['project'];E=sparta_f7d2e15968()['project/core/api'];A+=f'sys.path.insert(0, r"{str(D)}")\n';A+=f'sys.path.insert(0, r"{str(E)}")\n';A+=f'os.environ["api_key"] = "{B.api_key}"\n'
	...
	async def activate_venv(C,venv_name):
		def D():B=sparta_21526a056d();A=os.path.join(B,'sq_venv');A=os.path.normpath(A);os.makedirs(A,exist_ok=_C);return A
