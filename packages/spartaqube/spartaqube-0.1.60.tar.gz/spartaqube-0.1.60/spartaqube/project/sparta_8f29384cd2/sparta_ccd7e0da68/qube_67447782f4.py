...
main_api=sparta_f7d2e15968()['api']
...
def sparta_85e1a912d2(path):A=Path(path).resolve();return str(A)
def sparta_e17b9227bb(textOutputArr):
	A=textOutputArr
	...
	return A
def sparta_aedb1e8780(input2JsonEncode,dateFormat=None):
...
def sparta_7820f0cebb(file_path):
	A=file_path
