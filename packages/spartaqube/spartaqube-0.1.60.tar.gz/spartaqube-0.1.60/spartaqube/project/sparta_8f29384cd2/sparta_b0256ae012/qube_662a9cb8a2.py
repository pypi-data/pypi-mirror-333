...
def sparta_bd28d13e9a(json_data,userObj):
	B=json_data[_C]
	if int(B)==1:
	...
	try:G,H=sparta_0ac349227a(A,B);D={_A:1,_D:H,_E:G,_B:A}
	except:D={_A:-1,_F:_G}
	return D
def sparta_c073ec0b51(json_data,userObj):
	A=json_data
	try:D=A[_B];E=A[_C];B=os.path.dirname(D);F,G=sparta_0ac349227a(B,E);C={_A:1,_D:G,_E:F,_B:B}
	except:C={_A:-1,_F:_G}
	return C
def sparta_e4559ce4a4(json_data,userObj):
	A=json_data
	try:B=A[_B];D=A[_C];E,F=sparta_0ac349227a(B,D);C={_A:1,_D:F,_E:E,_B:B}
	except:C={_A:-1,_F:_G}
	return C
def sparta_0ac349227a(currentPath,typeexplorer=None):
...
def sparta_4da8421052(currentPath):
