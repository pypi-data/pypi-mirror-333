...
from project.sparta_8f29384cd2.sparta_47f0106b48.qube_2d0baaf631 import sparta_b3071b9c26
from project.sparta_8f29384cd2.sparta_ccd7e0da68.qube_67447782f4 import convert_to_dataframe,convert_dataframe_to_json
...
class Spartaqube:
	...
	def sparta_7954e517a8(A,widget_id):B={_D:'get_widget_data',_B:widget_id};return sparta_b3071b9c26(B,A.user_obj)
	def sparta_69ef32d776(A,widget_id):B={_D:'has_widget_id',_B:widget_id};return sparta_b3071b9c26(B,A.user_obj)
	...
	def plot(V,*W,**A):
		...
		if E is _A:
			L=sparta_9de0f4d9c8(b_return_type_id=_C)
	...
	def sparta_56fe976f41(B,*C,**A):
		if _B in A:return B.plot(*C,**A)
		raise Exception('Missing widget_id')
	def sparta_007a28fce2(A,connector_id):B={_D:'get_connector_tables',_H:connector_id};return sparta_b3071b9c26(B,A.user_obj)
	def sparta_8d5f2b348b(I,connector_id,table=_A,sql_query=_A,output_format=_A,dynamic_inputs=_A):
		...
		A['dynamic_inputs']=H;B=sparta_b3071b9c26(A,I.user_obj);C=False
		if F is _A:C=_C
		...
		return B
	def apply_method(B,method_name,*D,**C):A=C;A[_D]=method_name;return sparta_b3071b9c26(A,B.user_obj)
