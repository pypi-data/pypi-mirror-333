...
def sparta_aa5c12f7bb(user_obj):
	B=user_obj
	...
	return A
def sparta_42768b2fb7(json_data,user_obj):
...
def sparta_24ee420c21(json_data,user_obj):
...
def sparta_b4a99f4a1c(json_data,user_obj):
	...
	return{_C:1}
def sparta_fe241211ae(json_data,user_obj):
