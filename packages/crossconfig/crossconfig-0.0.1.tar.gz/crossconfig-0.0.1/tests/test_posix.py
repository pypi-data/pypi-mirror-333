...
@unittest.skipIf(platform.system() == "Windows", "Skipping POSIX tests on Windows system")
class TestPosix(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        if os.path.exists(f"{os.path.expanduser('~')}/.config/{cls.app_name}/settings.json"):
            os.remove(f"{os.path.expanduser('~')}/.config/{cls.app_name}/settings.json")
        if os.path.exists(f"{os.path.expanduser('~')}/.config/{cls.app_name}"):
            os.rmdir(f"{os.path.expanduser('~')}/.config/{cls.app_name}")
