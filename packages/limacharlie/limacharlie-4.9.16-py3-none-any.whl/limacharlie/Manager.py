...
class Manager( object ):
    ...
    def generateDRRule( self, query ):
        '''Generate a DR rule for an organization.

        Args:
            query (str): the query to generate a DR rule for.
        '''
        return self._apiCall( 'ai/dr', POST, { 'query': query } )

    def generateSensorSelector( self, query ):
        '''Generate a sensor selector for an organization.

        Args:
            query (str): the query to generate a sensor selector for.
        '''
        return self._apiCall( 'ai/sensor_selector', POST, { 'query': query } )
    
    def generateLCQL( self, query ):
        '''Generate a LCQL query for an organization.

        Args:
            query (str): the query to generate a LCQL query for.
        '''
        return self._apiCall( 'ai/lcql', POST, { 'query': query } )
