...
class Minesweeper:
    ...
    def __init__(self, height = ADVANCED[0], width = ADVANCED[1], mines = ADVANCED[2]):
        ...
        class _MinesweeperValues(_tc.Enum): # 0.3.41
            NO_MINE = 0
            MINE = 1
...
class Minecraft:
    ...
    To 0.3.41 `MC_ENCHANTS` in class `~.games.Games`
    """
    ...
    def enchBook(
        ...
        *,
        ...
        _params = [k for k in self.enchBook.__code__.co_varnames if k not in ("self", "return")][:5]
        ...
        # 0.3.41: replaced with __annotations__
        _enchantments = [k for k in self.enchBook.__code__.co_varnames][5:]
...
class Sudoku:
    ...
    def __init__(self):
        ...
        def _shuffle(s: _tc.Sequence[int], /):
...
class TicTacToe:
    ...
    def __init__(self, p1c = X, p2c = O, firstPlayer: _tc.Optional[_tc.Literal[1, 2]] = None):
