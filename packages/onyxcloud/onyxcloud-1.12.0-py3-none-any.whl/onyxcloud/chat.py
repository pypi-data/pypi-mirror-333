...
def chat(max_length=50, temperature=0.4, top_k=1):
    ...
    while True:
        try:
            ...
            print(Fore.RED + Style.BRIGHT + "\n⚠️  An error occurred! Please try again." + Style.RESET_ALL)
            print(Fore.RED + "Details:" + Style.RESET_ALL, str(e))
            if input(Fore.YELLOW + "Do you want to see the full traceback? (y/n): ").strip().lower() == 'y':
                traceback.print_exc()
