...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    match name:
        ...
        case HchTools.SERVICE_DETAILS_INFO:
            service_details_info = get_service_details_info(arguments["service"])
            return [
                TextContent(
                    type="text",
        ...
        case HchTools.SERVICE_PRICE_INFO:
            price_info = get_service_price_info(arguments["service"])
            return [
                TextContent(
                    type="text",
                    text=f"{price_info}",
