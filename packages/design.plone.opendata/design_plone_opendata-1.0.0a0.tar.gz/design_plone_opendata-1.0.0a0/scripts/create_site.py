...
from design.plone.opendata.interfaces import IBrowserLayer
...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-design.plone.opendata:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile(
            "profile-design.plone.opendata:initial"
        )
        transaction.commit()
    app._p_jar.sync()
