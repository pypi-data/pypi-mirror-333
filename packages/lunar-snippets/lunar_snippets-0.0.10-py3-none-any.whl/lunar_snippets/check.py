...
class Check:
    ...
    def _make_assertion(
        ...
        try:
            serialized_value = str(actual_value) # We don't care about the actual value, we just want to make sure its serializable at submission time
        except Exception as e:
            serialized_value = f"<error converting {type(actual_value).__name__}: {e}>"
