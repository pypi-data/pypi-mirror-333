...
class SCIMProviderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "property_mappings", "property_mappings_group", "url", "verify_certificates", "token", "exclude_users_service_account", "filter_group", "dry_run"]
