...
class DefaultTaskFile(flow.SessionObject):
    ...
    def compute_child_value(self, child_value):
        ...
        if child_value is self.target_kitsu_task_type:
            ...
            if (cache_child_value is None or cache_child_value in ['', []]) and existing:
                self._map.edits[self.name()].target_kitsu_task_type.set(existing.task_patterns.get())
                return child_value.set(existing.task_patterns.get())
