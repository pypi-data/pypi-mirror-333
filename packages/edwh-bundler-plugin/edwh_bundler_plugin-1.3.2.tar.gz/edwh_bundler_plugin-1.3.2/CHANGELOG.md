...
* **build:** Set `hookable` to False to explicitly prevent calling `build` after `edwh build` ([`227d59d`](https://github.com/educationwarehouse/edwh-bundler-plugin/commit/227d59d115a43e6136c8768ff4a8cf7a3196ddd8))
