...
def hakisto_file(
    *param_decls: str, default: bool = None, show_default: bool = True, cls: Type[click] | None = None, **attrs: Any
) -> Callable[[FC], FC]:
    ...
    return make_decorator(cls=cls or click.Option, param_decls=param_decls or ("--log-file/--no-log-file",), **attrs)
