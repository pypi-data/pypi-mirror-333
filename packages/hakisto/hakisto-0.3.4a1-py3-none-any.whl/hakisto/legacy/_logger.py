...
class LegacyLogger(BaseLogger):
    ...
    def _convert_legacy_message(msg, args) -> str:
        if all((args, len(args) == 1, isinstance(args[0], collections.abc.Mapping), args[0])):
            args = args[0]
        args = args
        if args:
            msg = str(msg) % args
    ...
    def log(self, level, msg, *args, **kwargs):
        ...
        """
        self._logger.log(level_to_severity.get(level, 0), self._convert_legacy_message(msg, args), **kwargs)
