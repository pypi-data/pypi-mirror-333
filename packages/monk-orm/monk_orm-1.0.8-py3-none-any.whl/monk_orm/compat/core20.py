...
class MonkDBCompilerSA20(MonkDBCompiler):
    def visit_update(self, update_stmt, **kw):
        ...
        # MonkDB patch.
        if not compile_state._dict_parameters and not hasattr(update_stmt, "_monkdb_specific"):
...
def _get_crud_params(
    ...
    **kw: Any,
    ...
    stmt_parameter_tuples: Optional[List[Tuple[Union[str,
                                                     ColumnClause[Any]], Any]]]
    ...
    if compiler.column_keys is None:
        ...
        parameters = {_column_as_key(
            key): REQUIRED for key in compiler.column_keys}
