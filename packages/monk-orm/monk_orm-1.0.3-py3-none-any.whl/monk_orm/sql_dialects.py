...
from .query_compiler import (
    MonkDBDDLCompiler,
    MonkDBIdentifierPreparer,
    MonkDBTypeCompiler
)
from .sql_alchemy_version import SQL_ALCHEMY_1_4, SQL_ALCHEMY_2_0, SQL_ALCHEMY_VERSION
from .supported_types import FloatVector, ObjectArray, ObjectType
...
try:
    ...
    TYPES_MAP["timestamp with time zone_array"] = ARRAY(
...
class Date(sqltypes.Date):
    ...
    def result_processor(self, dialect, coltype):
        def process(value):
            ...
            # MonkDB doesn't really have datetime or date types but a
...
if SQL_ALCHEMY_VERSION >= SQL_ALCHEMY_2_0:
    from .compat.core20 import MonkDBCompilerSA20

    statement_compiler = MonkDBCompilerSA20
elif SQL_ALCHEMY_VERSION >= SQL_ALCHEMY_1_4:
    from .compat.core14 import MonkDBCompilerSA14

    statement_compiler = MonkDBCompilerSA14
else:
    from .compat.core10 import MonkDBCompilerSA10

    statement_compiler = MonkDBCompilerSA10


class MonkDialect(default.DefaultDialect):
    name = "monkdb"
    driver = "monkdb-python"
    default_paramstyle = "qmark"
    statement_compiler = statement_compiler
    ddl_compiler = MonkDBDDLCompiler
    type_compiler = MonkDBTypeCompiler
    preparer = MonkDBIdentifierPreparer
    ...
    def __init__(self, **kwargs):
        ...
        # MonkDB does not need `OBJECT` types to be serialized as JSON.
    ...
    def do_rollback(self, connection):
        ...
        # attempts to do a rollback monkdb doesn't support rollbacks.
    ...
    def get_foreign_keys(
        ...
        # MonkDB doesn't support Foreign Keys, so this stays empty
        return []
    ...
    def _create_column_info(self, row):
        return {
            ...
            # In MonkDB every column is nullable except PK
