...
class DataExtractionAgent:
    ...
    async def _pipeline_with_mutable_stream(self, data, source_stream_name, target_stream_name, ids):
        await PayloadExtractionAgent.register(
            self.runtime,
            type=payload_extraction_topic,
            factory=lambda: PayloadExtractionAgent(model_client=self.client),
        ...
        await TargetMutableStreamSchemaInferenceAgent.register(
            ...
            factory=lambda: TargetMutableStreamSchemaInferenceAgent(model_client=self.client),
        )
    ...
    def pipeline_with_mutable_stream(self, data, source_stream_name, target_stream_name, ids):
        return asyncio.run(self._pipeline_with_mutable_stream(data, source_stream_name, target_stream_name, ids))
