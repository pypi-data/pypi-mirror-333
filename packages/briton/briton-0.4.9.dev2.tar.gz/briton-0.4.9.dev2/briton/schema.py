...
class ModelInput(BaseModel):
    ...
    @model_validator(mode="after")
    def force_logprobs_false(cls, values):
        values.logprobs = False
        return values
    ...
    def _create_tools_schema(
        ...
        for tool in tools:
            # Disable strict mode if any function doesn't have it.
            # This may not be entirely in-line with OpenAI's strict parameter, where it can be enabled per-function.
