...
class UpdateCalendarEventResponse(BaseModel):
    ...
    show_as: Optional[UpdateCalendarEventResponseShowAs] = None
    visibility: Optional[UpdateCalendarEventResponseVisibility] = None
    created: Optional[datetime.datetime] = None
    creator: Optional["UpdateCalendarEventResponseCreator"] = None
    end: Optional["UpdateCalendarEventResponseEnd"] = None
    ...
    organizer: Optional["UpdateCalendarEventResponseOrganizer"] = None
    reminders: Optional["UpdateCalendarEventResponseReminders"] = None
    sequence: Optional[int] = None
    start: Optional["UpdateCalendarEventResponseStart"] = None
