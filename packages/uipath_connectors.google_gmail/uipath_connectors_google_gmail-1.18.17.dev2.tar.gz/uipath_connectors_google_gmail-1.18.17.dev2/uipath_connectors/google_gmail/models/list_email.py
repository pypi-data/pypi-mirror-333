...
class ListEmail(BaseModel):
    ...
    from_: Optional["ListEmailFrom"] = None
    to: Optional[list["ListEmailToArrayItemRef"]] = None
    subject: Optional[str] = None
    cc: Optional[list["ListEmailCCArrayItemRef"]] = None
    bcc: Optional[list["ListEmailBCCArrayItemRef"]] = None
    has_attachments: Optional[bool] = None
    parent_folders: Optional[list["ListEmailParentFoldersArrayItemRef"]] = None
    categories: Optional[list["ListEmailCategoriesArrayItemRef"]] = None
    type_: Optional[ListEmailType] = None
