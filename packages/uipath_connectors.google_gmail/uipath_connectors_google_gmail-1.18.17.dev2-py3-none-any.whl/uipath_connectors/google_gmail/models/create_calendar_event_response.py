...
class CreateCalendarEventResponse(BaseModel):
    ...
    show_as: Optional[CreateCalendarEventResponseShowAs] = None
    visibility: Optional[CreateCalendarEventResponseVisibility] = None
    created: Optional[datetime.datetime] = None
    creator: Optional["CreateCalendarEventResponseCreator"] = None
    end: Optional["CreateCalendarEventResponseEnd"] = None
    ...
    organizer: Optional["CreateCalendarEventResponseOrganizer"] = None
    reminders: Optional["CreateCalendarEventResponseReminders"] = None
    sequence: Optional[int] = None
    start: Optional["CreateCalendarEventResponseStart"] = None
