...
T = TypeVar("T", bound="CreateCalendarEventResponseEnd")


@_attrs_define
class CreateCalendarEventResponseEnd:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_calendar_event_response_end = cls(
            date_time=date_time,
            time_zone=time_zone,
        )

        create_calendar_event_response_end.additional_properties = d
        return create_calendar_event_response_end
