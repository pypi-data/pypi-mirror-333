...
T = TypeVar("T", bound="CreateCalendarEventResponseStart")


@_attrs_define
class CreateCalendarEventResponseStart:
    """
    Attributes:
        date_time (Union[Unset, datetime.datetime]):  Example: 2023-01-11T16:30:00.0000000+05:30.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_calendar_event_response_start = cls(
            date_time=date_time,
            time_zone=time_zone,
        )

        create_calendar_event_response_start.additional_properties = d
        return create_calendar_event_response_start
