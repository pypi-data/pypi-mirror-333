...
T = TypeVar("T", bound="MarkEmailReadUnreadResponse")


@_attrs_define
class MarkEmailReadUnreadResponse:
    """
    Attributes:
        thread_id (Union[Unset, str]): Unique ID representing the email thread. Example: 19488b1d21aed8cf.
        snippet (Union[Unset, str]): A brief preview of the email content.
        history_id (Union[Unset, str]): Unique ID for tracking changes in the email. Example: 99347.
        label_ids (Union[Unset, list[str]]):  Example: IMPORTANT.
        id (Union[Unset, str]): Unique ID representing the specific email message. Example: 19488b1fa00ba1a8.
        size_estimate (Union[Unset, int]): Approximate size of the email in bytes. Example: 557.0.
        internal_date (Union[Unset, str]): The timestamp when the email was received. Example: 1737460152000.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        mark_email_read_unread_response = cls(
            thread_id=thread_id,
            snippet=snippet,
        ...
        mark_email_read_unread_response.additional_properties = d
        return mark_email_read_unread_response
