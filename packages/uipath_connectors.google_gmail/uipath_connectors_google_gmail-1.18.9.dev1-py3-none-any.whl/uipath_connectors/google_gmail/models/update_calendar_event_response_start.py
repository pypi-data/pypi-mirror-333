...
T = TypeVar("T", bound="UpdateCalendarEventResponseStart")


@_attrs_define
class UpdateCalendarEventResponseStart:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_calendar_event_response_start = cls(
            date_time=date_time,
            time_zone=time_zone,
        )

        update_calendar_event_response_start.additional_properties = d
        return update_calendar_event_response_start
