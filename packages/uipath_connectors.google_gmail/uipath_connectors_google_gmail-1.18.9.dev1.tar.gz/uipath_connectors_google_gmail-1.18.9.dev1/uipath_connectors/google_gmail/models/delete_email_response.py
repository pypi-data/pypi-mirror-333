...
T = TypeVar("T", bound="DeleteEmailResponse")
...
class DeleteEmailResponse:
    """
    Attributes:
        thread_id (Union[Unset, str]): Unique identifier for the email thread. Example: 1949140817e1249d.
        label_ids (Union[Unset, list[str]]):  Example: Label_6094343900192509552.
        id (Union[Unset, str]): Unique identifier for the specific email message. Example: 1949140817e1249d.
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        delete_email_response = cls(
            thread_id=thread_id,
            label_ids=label_ids,
            id=id,
        )

        delete_email_response.additional_properties = d
        return delete_email_response
