...
class GoogleGmail:
    ...
    def update_calendar_event(
        ...
        *,
        ...
        add_conference_data: Union[Unset, bool] = UNSET,
        calendar: Union[Unset, str] = UNSET,
        send_notifications: Union[Unset, str] = "All",
    ...
    def reply_to_email(
        ...
        *,
        ...
        save_as_draft: Union[Unset, bool] = UNSET,
    ...
    def delete_email(
        self,
        *,
        permanently_delete: Union[Unset, bool] = False,
        id: str,
    ...
    def get_email_by_id(
        ...
        id: str,
        *,
        format_: Union[Unset, GetEmailByIDFormat] = UNSET,
        metadata_headers: Union[Unset, str] = UNSET,
    ...
    def download_attachment(
        ...
        id: str,
        *,
        exclude_inline_attachment: Union[Unset, bool] = False,
    ...
    def create_calendar_event(
        ...
        *,
        ...
        add_conference_data: Union[Unset, bool] = False,
        calendar: Union[Unset, str] = UNSET,
        send_notifications: Union[Unset, str] = UNSET,
