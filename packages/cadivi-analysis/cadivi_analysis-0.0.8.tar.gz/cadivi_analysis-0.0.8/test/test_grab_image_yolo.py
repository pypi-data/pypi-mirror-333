...
from cadivi_analysis.settings import (
    camera99_yolo_consumer,
    camera27_yolo_consumer,
    camera55_yolo_consumer,
)
from cadivi_analysis.utils.camera_utils import CameraUtils


def test_grab_image_yolo():
