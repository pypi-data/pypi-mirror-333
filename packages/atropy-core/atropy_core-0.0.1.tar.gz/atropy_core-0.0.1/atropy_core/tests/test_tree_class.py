...
from atropy_core.examples.models.kinetic.bax import reaction_system as bax_model
from atropy_core.examples.models.kinetic.lambda_phage import reaction_system as lp_model
