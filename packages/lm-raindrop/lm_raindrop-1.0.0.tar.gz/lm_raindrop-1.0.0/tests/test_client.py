...
class TestRaindrop:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                "/v1/search",
                body=cast(
                    object, maybe_transform(dict(input="REPLACE_ME", request_id="REPLACE_ME"), SearchPerformParams)
                ),
    ...
    def test_retries_taken(
        ...
        response = client.search.with_raw_response.perform(input="input", request_id="request_id")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.search.with_raw_response.perform(
            input="input", request_id="request_id", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.search.with_raw_response.perform(
            input="input", request_id="request_id", extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncRaindrop:
    ...
    async def test_retries_taken(
        ...
        response = await client.search.with_raw_response.perform(input="input", request_id="request_id")
