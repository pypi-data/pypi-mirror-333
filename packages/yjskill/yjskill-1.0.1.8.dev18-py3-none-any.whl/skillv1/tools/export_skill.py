...
def run():
    ...
    try:
        ...
        if export_kind == EXPORT_SKILL_TEMPLATE_KIND:
            ...
            output_uri = f"s3://{bucket}/{job.name}/export/{skill.local_name}_{artifact_name.version}.json"
        ...
        report_success(job, job_client, skill, artifact_name.version, tracker, export_kind)
