...
Condicion : AliasDeTipo = Llamable[[Opcional[Flask], Opcional[_AppCtxGlobals], Opcional[Solicitud]],bool]

def registarCondicion(condicion : Llamable[[Opcional[Flask], Opcional[_AppCtxGlobals], Opcional[Solicitud],...],Cualquiera],*posicionales,**nominales) -> Condicion:
