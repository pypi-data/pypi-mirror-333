...
async def serve(endpoint: str, access_key: str, spec_path: Path) -> None:
    ...
    async def call_tool(name: str, arguments: dict) -> list[TextContent]:
        ...
        print(f":::: zmp_api_wrapper: {zmp_api_wrapper}")
        ...
        # return [TextContent(type="text", text=f"endpoint: {endpoint}, access_key: {access_key}, spec_path: {spec_path}, operation: {operation}, zmp_api_wrapper: {zmp_api_wrapper}")]
