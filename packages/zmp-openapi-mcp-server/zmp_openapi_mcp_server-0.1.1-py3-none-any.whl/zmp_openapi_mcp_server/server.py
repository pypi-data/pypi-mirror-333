...
def get_alert_manager_agent(endpoint: str, access_key: str):
    # with (
    #     importlib.resources.files("zmp_openapi_mcp_server.openapi")
    #     .joinpath("agent_apis_for_zcp_alert_manager.json")
    #     .open("r") as f
    # ):
    #     spec_path = str(f.name)

    mixed_api_spec_config = MixedAPISpecConfig.from_mixed_spec_file(
        file_path="openapi/agent_apis_for_zcp_alert_manager.json"
    )
