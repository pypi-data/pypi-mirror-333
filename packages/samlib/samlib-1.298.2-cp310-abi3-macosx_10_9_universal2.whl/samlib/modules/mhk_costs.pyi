...
class Data(ssc.DataDict):
    ...
    structural_assembly_cost_method: float = INPUT(label='Structural assembly cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value,3=Use itemized costs in $')
    structural_assembly_cost_input: float = INPUT(label='Structural assembly cost', units='$', type='NUMBER', group='MHKCosts', required='*')
    power_takeoff_system_cost_method: float = INPUT(label='Power take-off system cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value,3=Use itemized costs in $')
    power_takeoff_system_cost_input: float = INPUT(label='Power take-off system cost', units='$', type='NUMBER', group='MHKCosts', required='*')
    mooring_found_substruc_cost_method: float = INPUT(label='Mooring, foundation, and substructure cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value,3=Use itemized costs in $')
    ...
    development_cost_method: float = INPUT(label='Development cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value,3=Enter in itemized costs')
    development_cost_input: float = INPUT(label='Development cost', units='$', type='NUMBER', group='MHKCosts', required='*')
    eng_and_mgmt_cost_method: float = INPUT(label='Engineering and management cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value,3=Enter in itemized costs')
    eng_and_mgmt_cost_input: float = INPUT(label='Engineering and management cost', units='$', type='NUMBER', group='MHKCosts', required='*')
    assembly_and_install_cost_method: float = INPUT(label='Assembly and installation cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value')
    ...
    other_infrastructure_cost_method: float = INPUT(label='Other infrastructure cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value')
    other_infrastructure_cost_input: float = INPUT(label='Other infrastructure cost', units='$', type='NUMBER', group='MHKCosts', required='*')
    array_cable_system_cost_method: float = INPUT(label='Array cable system cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value')
    array_cable_system_cost_input: float = INPUT(label='Array cable system cost', units='$', type='NUMBER', group='MHKCosts', required='*')
    export_cable_system_cost_method: float = INPUT(label='Export cable system cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value')
    export_cable_system_cost_input: float = INPUT(label='Export cable system cost', units='$', type='NUMBER', group='MHKCosts', required='*')
    onshore_substation_cost_method: float = INPUT(label='Onshore substation cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value')
    onshore_substation_cost_input: float = INPUT(label='Onshore substation cost', units='$', type='NUMBER', group='MHKCosts', required='*')
    offshore_substation_cost_method: float = INPUT(label='Offshore substation cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value')
    offshore_substation_cost_input: float = INPUT(label='Offshore substation cost', units='$', type='NUMBER', group='MHKCosts', required='*')
    other_elec_infra_cost_method: float = INPUT(label='Other electrical infrastructure cost method', units='0/1/2', type='NUMBER', group='MHKCosts', required='*', constraints='MIN=0,MAX=4', meta='0=Enter in $/kW,1=Enter in $,2=Use modeled value')
