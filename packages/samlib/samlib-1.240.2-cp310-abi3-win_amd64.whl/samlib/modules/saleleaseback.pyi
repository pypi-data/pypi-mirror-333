...
class Data(ssc.DataDict):
    ...
    system_lifetime_recapitalize: Array = INPUT(label='Recapitalization boolean', type='ARRAY', group='Sale Leaseback', required='?=0')
    ...
    cf_length: Final[float] = OUTPUT(label='Number of periods in cashflow', type='NUMBER', group='Sale Leaseback', required='*', constraints='INTEGER')
    ppa_price: Final[float] = OUTPUT(label='Initial year PPA price', units='cents/kWh', type='NUMBER', group='Sale Leaseback', required='*')
    cf_energy_net: Final[Array] = OUTPUT(label='Energy produced', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_ppa_price: Final[Array] = OUTPUT(label='PPA price', units='cents/kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_energy_value: Final[Array] = OUTPUT(label='PPA revenue', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_om_fixed_expense: Final[Array] = OUTPUT(label='O&M fixed expense', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_om_production_expense: Final[Array] = OUTPUT(label='O&M production-based expense', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_om_capacity_expense: Final[Array] = OUTPUT(label='O&M capacity-based expense', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_om_fuel_expense: Final[Array] = OUTPUT(label='O&M fuel expense', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_property_tax_assessed_value: Final[Array] = OUTPUT(label='Property tax net assessed value', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_property_tax_expense: Final[Array] = OUTPUT(label='Property tax expense', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_insurance_expense: Final[Array] = OUTPUT(label='Insurance expense', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_sponsor_margin: Final[Array] = OUTPUT(label='Developer (lessee) operating margin', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_operating_expenses: Final[Array] = OUTPUT(label='Total operating expense', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_net_salvage_value: Final[Array] = OUTPUT(label='Salvage value', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_total_revenue: Final[Array] = OUTPUT(label='Total revenue', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_sponsor_operating_margin: Final[Array] = OUTPUT(label='Operating margin not including lease payment', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_reserve_leasepayment: Final[Array] = OUTPUT(label='Reserve lease payment reserve', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_reserve_leasepayment_interest: Final[Array] = OUTPUT(label='Reserve lease payment reserve interest', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_reserve_om: Final[Array] = OUTPUT(label='Reserve working capital', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_reserve_equip1: Final[Array] = OUTPUT(label='Reserve  major equipment 1', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_reserve_equip2: Final[Array] = OUTPUT(label='Reserve major equipment 2', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_reserve_equip3: Final[Array] = OUTPUT(label='Reserve major equipment 3', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_reserve_total: Final[Array] = OUTPUT(label='Reserve total except lease payment reserve', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_reserve_interest: Final[Array] = OUTPUT(label='Reserve interest on reserves except lease payment reserve', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_funding_leasepayment: Final[Array] = OUTPUT(label='Reserve funding lease payment', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_funding_om: Final[Array] = OUTPUT(label='Reserve funding working capital', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_funding_equip1: Final[Array] = OUTPUT(label='Reserve funding major equipment 1', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_funding_equip2: Final[Array] = OUTPUT(label='Reserve funding major equipment 2', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_funding_equip3: Final[Array] = OUTPUT(label='Reserve funding major equipment 3', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_disbursement_leasepayment: Final[Array] = OUTPUT(label='Reserve disbursement lease payment', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_disbursement_om: Final[Array] = OUTPUT(label='Reserve disbursement working capital', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_disbursement_equip1: Final[Array] = OUTPUT(label='Reserve disbursement major equipment 1', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_disbursement_equip2: Final[Array] = OUTPUT(label='Reserve disbursement major equipment 2', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_disbursement_equip3: Final[Array] = OUTPUT(label='Reserve disbursement major equipment 3', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_disbursement_merr: Final[Array] = OUTPUT(label='Reserve disbursement major equipment total', units='$', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
