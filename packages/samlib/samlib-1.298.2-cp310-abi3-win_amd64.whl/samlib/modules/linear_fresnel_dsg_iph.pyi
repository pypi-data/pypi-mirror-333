...
class Data(ssc.DataDict):
    ...
    ppa_price_input_heat_btu: Array = INPUT(label='PPA prices - yearly', units='$/MMBtu', type='ARRAY', group='Revenue')
    ...
    gen_heat: Final[Array] = OUTPUT(label='System net thermal power w/ avail. derate', units='kWt', type='ARRAY', group='system', required='*')
    gen: Final[Array] = OUTPUT(label='System net electrical power w/ avail. derate', units='kWe', type='ARRAY', group='system', required='*')
    gen_heat_btu: Final[Array] = OUTPUT(label='System net thermal power w/ avail. derate', units='MMBtu/hr', type='ARRAY', group='system', required='*')
    ...
    annual_energy: Final[float] = OUTPUT(label='Annual net thermal energy w/ avail. derate', units='kWht', type='NUMBER', group='Post-process', required='*')
    annual_energy_heat_btu: Final[float] = OUTPUT(label='Annual net thermal energy w/ avail. derate', units='MMBtu', type='NUMBER', group='Post-process', required='*')
    annual_field_energy: Final[float] = OUTPUT(label='Annual Gross Thermal Energy Production w/ avail derate', units='kWht', type='NUMBER', group='Post-process', required='*')
    annual_thermal_consumption: Final[float] = OUTPUT(label='Annual thermal freeze protection required', units='kWht', type='NUMBER', group='Post-process', required='*')
    annual_electricity_consumption: Final[float] = OUTPUT(label='Annual electricity consumptoin w/ avail derate', units='kWhe', type='NUMBER', group='Post-process', required='*')
    ...
    ppa_price_input: Final[Array] = OUTPUT(label='PPA prices - yearly', units='$/kWh', type='ARRAY', group='Revenue')
    nameplate: Final[float] = OUTPUT(label='Nameplate capacity', units='MWt', type='NUMBER', group='System Design', required='*')
