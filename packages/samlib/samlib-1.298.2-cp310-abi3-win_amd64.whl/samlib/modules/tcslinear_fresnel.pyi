...
class Data(ssc.DataDict):
    ...
    monthly_energy: Final[Array] = OUTPUT(label='Monthly AC energy in Year 1', units='kWh', type='ARRAY', group='Linear Fresnel', required='*', constraints='LENGTH=12')
    annual_energy: Final[float] = OUTPUT(label='Annual AC energy in Year 1', units='kWh', type='NUMBER', group='Linear Fresnel', required='*')
