...
class Data(ssc.DataDict):
    ...
    pressure: float = INPUT(label='Pressure', units='mbars', type='NUMBER', group='PVWatts', required='?')
    shaded_percent: float = INPUT(label='Percent of panels that are shaded', units='%', type='NUMBER', group='PVWatts', required='?=0', constraints='MIN=0,MAX=100')
    ...
    tcell: float = INOUT(label='Module temperature', units='C', type='NUMBER', group='PVWatts', meta='Output from last time step may be used as input')
    poa: float = INOUT(label='Plane of array irradiance', units='W/m2', type='NUMBER', group='PVWatts', meta='Output from last time step may be used as input')
