...
"""singleowner_heat - Single Owner Financial Model for Heat"""
...
DataDict = TypedDict('DataDict', {
    ...
    'ptc_sta_term': float,
    'ptc_sta_escal': float,
    'ptc_fed_amount_heat_btu': Array,
    'ptc_sta_amount_heat_btu': Array,
    'cbi_fed_amount_heat_btu': float,
    'cbi_sta_amount_heat_btu': float,
    'cbi_uti_amount_heat_btu': float,
    'cbi_oth_amount_heat_btu': float,
    'pbi_fed_amount_heat_btu': Array,
    'pbi_sta_amount_heat_btu': Array,
    'pbi_uti_amount_heat_btu': Array,
    'pbi_oth_amount_heat_btu': Array,
    ...
    'cf_om_elec_price_for_heat_techs': Array,
...
class Data(ssc.DataDict):
    ...
    ppa_soln_min: float = INPUT(label='PPA solution minimum ppa', units='cents/kWht', type='NUMBER', group='Revenue', required='?=0')
    ppa_soln_max: float = INPUT(label='PPA solution maximum ppa', units='cents/kWht', type='NUMBER', group='Revenue', required='?=100')
    ...
    ppa_price_input: Array = INPUT(label='PPA price in first year input', units='$/kWht', type='ARRAY', group='Revenue', required='*')
    ppa_escalation: float = INPUT(label='PPA escalation rate', units='%/year', type='NUMBER', group='Revenue', required='?=0')
    lppa_real: Final[float] = OUTPUT(label='LPPA Levelized PPA price real', units='cents/kWht', type='NUMBER', group='Metrics', required='*')
    lppa_nom: Final[float] = OUTPUT(label='LPPA Levelized PPA price nominal', units='cents/kWht', type='NUMBER', group='Metrics', required='*')
    ppa: Final[float] = OUTPUT(label='PPA price in Year 1', units='cents/kWht', type='NUMBER', group='Metrics', required='*')
    ...
    om_production_heat: Array = INPUT(label='Production-based O&M amount', units='$/MWht', type='ARRAY', group='System Costs', required='?=0.0')
    ...
    om_capacity_heat: Array = INPUT(label='Capacity-based O&M amount', units='$/kWt-yr', type='ARRAY', group='System Costs', required='?=0.0')
    ...
    om_elec_price_for_heat_techs: Array = INPUT(label='Electricity price for purchases in heat model', units='$/kWh', type='ARRAY', group='System Costs', required='?=0.0')
    om_elec_price_for_heat_techs_escal: float = INPUT(label='Escalation for electricity price for purchases in heat model', units='%/year', type='NUMBER', group='System Costs', required='?=0.0')
    ...
    ptc_fed_amount_heat_btu: Array = INPUT(label='Federal PTC amount', units='$/MMBtu', type='ARRAY', group='Tax Credit Incentives', required='?=0')
    ptc_sta_amount_heat_btu: Array = INPUT(label='State PTC amount', units='$/MMBtu', type='ARRAY', group='Tax Credit Incentives', required='?=0')
    cbi_fed_amount_heat_btu: float = INPUT(label='Federal CBI amount', units='$/(Btu/hr))', type='NUMBER', group='Payment Incentives', required='?=0.0')
    cbi_sta_amount_heat_btu: float = INPUT(label='State CBI amount', units='$/(Btu/hr))', type='NUMBER', group='Payment Incentives', required='?=0.0')
    cbi_uti_amount_heat_btu: float = INPUT(label='Utility CBI amount', units='$/(Btu/hr))', type='NUMBER', group='Payment Incentives', required='?=0.0')
    cbi_oth_amount_heat_btu: float = INPUT(label='Other CBI amount', units='$/(Btu/hr))', type='NUMBER', group='Payment Incentives', required='?=0.0')
    pbi_fed_amount_heat_btu: Array = INPUT(label='Federal PBI amount', units='$/MMBtu', type='ARRAY', group='Payment Incentives', required='?=0')
    pbi_sta_amount_heat_btu: Array = INPUT(label='State PBI amount', units='$/MMBtu', type='ARRAY', group='Payment Incentives', required='?=0')
    pbi_uti_amount_heat_btu: Array = INPUT(label='Utility PBI amount', units='$/MMBtu', type='ARRAY', group='Payment Incentives', required='?=0')
    pbi_oth_amount_heat_btu: Array = INPUT(label='Other PBI amount', units='$/MMBtu', type='ARRAY', group='Payment Incentives', required='?=0')
    ...
    lcoe_real: Final[float] = OUTPUT(label='LCOH Levelized cost of heat real', units='cents/kWht', type='NUMBER', group='Metrics', required='*')
    lcoe_nom: Final[float] = OUTPUT(label='LCOH Levelized cost of heat nominal', units='cents/kWht', type='NUMBER', group='Metrics', required='*')
    lcos_real: Final[float] = OUTPUT(label='LCOS Levelized cost of storage real', units='cents/kWht', type='NUMBER', group='Metrics', required='?')
    npv_energy_nom: Final[float] = OUTPUT(label='Present value of annual energy nominal', units='kWht', type='NUMBER', group='Metrics', required='*')
    npv_energy_real: Final[float] = OUTPUT(label='Present value of annual energy real', units='kWht', type='NUMBER', group='Metrics', required='*')
    ...
    lcoptc_fed_real: Final[float] = OUTPUT(label='Levelized federal PTC real', units='cents/kWht', type='NUMBER', group='Metrics', required='*')
    lcoptc_fed_nom: Final[float] = OUTPUT(label='Levelized federal PTC nominal', units='cents/kWht', type='NUMBER', group='Metrics', required='*')
    lcoptc_sta_real: Final[float] = OUTPUT(label='Levelized state PTC real', units='cents/kWht', type='NUMBER', group='Metrics', required='*')
    lcoptc_sta_nom: Final[float] = OUTPUT(label='Levelized state PTC nominal', units='cents/kWht', type='NUMBER', group='Metrics', required='*')
    ...
    revenue_gen: Final[Array] = OUTPUT(label='Thermal energy', units='kWht', type='ARRAY', group='System Output')
    gen_heat: Array = INPUT(label='Thermal power', units='kWt', type='ARRAY', group='System Output', required='*')
    ...
    annual_electricity_consumption: float = INPUT(label='Annual electricity consumption w/ avail derate', units='kWe-hr', type='NUMBER', group='Heat Model Output', required='?=0')
    utility_bill_w_sys: Array = INPUT(label='Electricity bill with system', units='$', type='ARRAY', group='Utility Bill')
    utility_bill_wo_sys: Array = INPUT(label='Electricity bill without system', units='$', type='ARRAY', group='Utility Bill')
    ...
    system_use_lifetime_output: float = INOUT(label='Lifetime hourly system outputs', units='0/1', type='NUMBER', group='Lifetime', required='*', constraints='INTEGER,MIN=0', meta='0=hourly first year,1=hourly lifetime')
    ...
    cost_financing: Final[float] = OUTPUT(label='Total financing cost', units='$', type='NUMBER', group='Intermediate Costs', required='*')
    ...
    cf_energy_net: Final[Array] = OUTPUT(label='Thermal energy', units='kWht', type='ARRAY', group='Cash Flow Electricity', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_energy_net_heat_btu: Final[Array] = OUTPUT(label='Thermal energy', units='MMBtu', type='ARRAY', group='Cash Flow Electricity', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_energy_sales: Final[Array] = OUTPUT(label='Thermal energy to grid', units='kWht', type='ARRAY', group='Cash Flow Electricity', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_energy_purchases: Final[Array] = OUTPUT(label='Thermal energy from grid', units='kWht', type='ARRAY', group='Cash Flow Electricity', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_energy_without_battery: Final[Array] = OUTPUT(label='Thermal energy generated without storage', units='kWht', type='ARRAY', group='Cash Flow Electricity', constraints='LENGTH_EQUAL=cf_length')
    cf_ppa_price: Final[Array] = OUTPUT(label='PPA price', units='cents/kWht', type='ARRAY', group='Cash Flow Revenues', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_ppa_price_heat_btu: Final[Array] = OUTPUT(label='PPA price', units='cents/MMBtu', type='ARRAY', group='Cash Flow Revenues', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_om_elec_price_for_heat_techs: Final[Array] = OUTPUT(label='Electricity expense in heat models', units='$', type='ARRAY', group='Cash Flow Expenses', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    monthly_energy: Array = INPUT(label='Monthly AC energy in Year 1', units='kWh', type='ARRAY', group='Monthly', constraints='LENGTH = 12')
