...
def find(env_vars: list[Flag] = None) -> list[str]:
    """
    Search for OneDrive folders across all drives (Windows only).

    Args:
        env_vars (list[Flag], optional): Provided Parameters for OneDrive, e.g., ONEDRIVE.BASIC, "ONEDRIVE.COMMERCIAL", "ONEDRIVE.CONSUMER" Defaults to None.
