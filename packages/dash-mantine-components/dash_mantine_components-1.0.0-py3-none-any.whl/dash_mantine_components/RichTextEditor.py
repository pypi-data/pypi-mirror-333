...
- extensions (list of a value equal to: 'StarterKit', 'Underline', 'Link', 'Superscript', 'SubScript', 'Highlight', 'TextAlign's; optional):
...
- format (a value equal to: 'html', 'json'; optional):
    Data format to bring back to Dash. If not specified, the editor
...
- toolbar (dict; optional):
    ...
    - controlsGroups (list of list of a value equal to: 'Underline', 'Link', 'Superscript', 'Highlight', 'Bold', 'Italic', 'Strikethrough', 'ClearFormatting', 'Code', 'H1', 'H2', 'H3', 'H4', 'Blockquote', 'Hr', 'BulletList', 'OrderedList', 'Subscript', 'Unlink', 'AlignLeft', 'AlignCenter', 'AlignJustify', 'AlignRight', 'Undo', 'Redo'ss; optional)
...
- value (string | dict; required):
    Editor content, be be input as an HTML string or a (ProseMirror)
    JSON object.
...
- w (string | number; optional):
    ...
    Toolbar = TypedDict(
        "Toolbar",
            ...
            "controlsGroups": NotRequired[typing.Sequence[typing.Sequence[Literal["Underline", "Link", "Superscript", "Highlight", "Bold", "Italic", "Strikethrough", "ClearFormatting", "Code", "H1", "H2", "H3", "H4", "Blockquote", "Hr", "BulletList", "OrderedList", "Subscript", "Unlink", "AlignLeft", "AlignCenter", "AlignJustify", "AlignRight", "Undo", "Redo"]]]]
        }
    )
    ...
    def __init__(
        self,
        value: typing.Optional[typing.Union[str, dict]] = None,
        format: typing.Optional[Literal["html", "json"]] = None,
        variant: typing.Optional[Literal["default", "subtle"]] = None,
        extensions: typing.Optional[typing.Sequence[Literal["StarterKit", "Underline", "Link", "Superscript", "SubScript", "Highlight", "TextAlign"]]] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'aria-*', 'bd', 'bg', 'bga', 'bgp', 'bgr', 'bgsz', 'bottom', 'c', 'className', 'classNames', 'darkHidden', 'data-*', 'debounce', 'display', 'extensions', 'ff', 'flex', 'format', 'fs', 'fw', 'fz', 'h', 'hiddenFrom', 'inset', 'left', 'lh', 'lightHidden', 'loading_state', 'lts', 'm', 'mah', 'maw', 'mb', 'me', 'mih', 'miw', 'ml', 'mod', 'mr', 'ms', 'mt', 'mx', 'my', 'n_blur', 'n_submit', 'opacity', 'p', 'pb', 'pe', 'pl', 'pos', 'pr', 'ps', 'pt', 'px', 'py', 'right', 'style', 'styles', 'ta', 'tabIndex', 'td', 'toolbar', 'top', 'tt', 'unstyled', 'value', 'variant', 'visibleFrom', 'w']
