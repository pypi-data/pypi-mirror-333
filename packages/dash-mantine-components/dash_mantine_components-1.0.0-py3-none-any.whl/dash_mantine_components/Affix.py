...
- zIndex (string | number; optional):
    ...
    Position = TypedDict(
        "Position",
            {
            "top": NotRequired[typing.Union[typing.Union[int, float, numbers.Number]]],
            "left": NotRequired[typing.Union[typing.Union[int, float, numbers.Number]]],
            "bottom": NotRequired[typing.Union[typing.Union[int, float, numbers.Number]]],
            "right": NotRequired[typing.Union[typing.Union[int, float, numbers.Number]]]
        }
    )
