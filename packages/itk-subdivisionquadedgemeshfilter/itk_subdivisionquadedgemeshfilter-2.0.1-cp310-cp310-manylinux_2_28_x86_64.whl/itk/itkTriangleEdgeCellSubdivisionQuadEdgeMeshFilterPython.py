...
class itkTriangleEdgeCellSubdivisionQuadEdgeMeshFilterQEMD2(itk.itkTriangleCellSubdivisionQuadEdgeMeshFilterPython.itkTriangleCellSubdivisionQuadEdgeMeshFilterQEMD2):
    ...
    def GetEdgesToBeSubdivided(self):
        r"""GetEdgesToBeSubdivided(self) -> std::list< itkGeometricalQuadEdgeULULBBF *,std::allocator< itkGeometricalQuadEdgeULULBBF * > > const &"""
    ...
    def SetCellsToBeSubdivided(self, EdgesList):
        ...
        Parameters
        ----------
        EdgesList: std::list< itkGeometricalQuadEdgeULULBBF *,std::allocator< itkGeometricalQuadEdgeULULBBF * > > const &
    ...
    def AddSubdividedEdge(self, edge):
        ...
        Parameters
        ----------
        edge: itkGeometricalQuadEdgeULULBBF *
