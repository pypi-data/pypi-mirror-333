...
- V2.1.2 : Allow for N_SECTORS=1 to get a single profile centered at a given
    PA. Use biweight mean instead of sigma-clipped mean. MC, Leiden, 30 April 2004
...
- V2.1.5 : Forces image to be positive when computing weighted radius to 
    prevent possible negative radii at large radii. 
    Thanks to Michael Williams for reporting the problem and the fix. 
...
class sectors_photometry_twist:
    ...
    n_sectors : int, optional
        ...
        major axis to the minor axis (one quadrant). Defaults to 36, which
    ...
    >>> s = mge.sectors_photometry_twist(img, eps, theta, xpeak, ypeak)
    ...
    def __init__(self, img, ang, xc, yc, badpixels=None,
        ...
        angGrid = linspace_open(-90, 90, n_sectors)       # Polar angle
