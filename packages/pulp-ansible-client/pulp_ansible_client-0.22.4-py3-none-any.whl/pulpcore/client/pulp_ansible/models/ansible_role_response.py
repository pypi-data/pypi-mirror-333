...
class AnsibleRoleResponse(object):
    ...
    def __init__(self, pulp_created=None, artifact=None, prn=None, pulp_last_updated=None, pulp_href=None, version=None, name=None, namespace=None, local_vars_configuration=None):  # noqa: E501
