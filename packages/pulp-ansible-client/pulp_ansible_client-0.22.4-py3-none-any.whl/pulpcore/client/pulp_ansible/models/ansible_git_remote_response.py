...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, rate_limit=None, client_cert=None, headers=None, prn=None, pulp_last_updated=None, connect_timeout=None, url=None, pulp_href=None, hidden_fields=None, sock_read_timeout=None, proxy_url=None, pulp_created=None, download_concurrency=None, name=None, sock_connect_timeout=None, total_timeout=None, ca_cert=None, max_retries=None, tls_validation=None, pulp_labels=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
