...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, rate_limit=None, password=None, client_cert=None, headers=None, connect_timeout=None, url=None, sock_read_timeout=None, proxy_url=None, download_concurrency=None, name=None, sock_connect_timeout=None, client_key=None, total_timeout=None, ca_cert=None, max_retries=None, proxy_password=None, username=None, tls_validation=None, pulp_labels=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
