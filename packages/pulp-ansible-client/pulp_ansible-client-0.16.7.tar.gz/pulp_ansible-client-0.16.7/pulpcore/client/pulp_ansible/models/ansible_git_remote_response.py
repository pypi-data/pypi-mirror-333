...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, max_retries=None, download_concurrency=None, connect_timeout=None, client_cert=None, ca_cert=None, tls_validation=None, rate_limit=None, total_timeout=None, sock_connect_timeout=None, hidden_fields=None, pulp_created=None, name=None, url=None, proxy_url=None, sock_read_timeout=None, headers=None, pulp_labels=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
