...
class AnsibleGitRemoteResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sock_connect_timeout", "ca_cert", "hidden_fields", "rate_limit", "url", "pulp_created", "connect_timeout", "headers", "tls_validation", "pulp_last_updated", "proxy_url", "pulp_href", "client_cert", "sock_read_timeout", "download_concurrency", "prn", "max_retries", "name", "total_timeout", "pulp_labels", "metadata_only", "git_ref"]
