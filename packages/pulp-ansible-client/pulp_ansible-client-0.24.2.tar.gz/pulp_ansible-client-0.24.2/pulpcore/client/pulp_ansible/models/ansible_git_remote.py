...
class AnsibleGitRemote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sock_connect_timeout", "ca_cert", "rate_limit", "url", "password", "proxy_password", "connect_timeout", "headers", "tls_validation", "proxy_url", "client_key", "client_cert", "sock_read_timeout", "download_concurrency", "max_retries", "name", "total_timeout", "username", "proxy_username", "pulp_labels", "metadata_only", "git_ref"]
