...
class AnsibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, download_concurrency=None, connect_timeout=None, client_key=None, client_cert=None, ca_cert=None, tls_validation=None, proxy_password=None, rate_limit=None, total_timeout=None, username=None, sock_connect_timeout=None, name=None, url=None, proxy_username=None, proxy_url=None, sock_read_timeout=None, password=None, headers=None, pulp_labels=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
