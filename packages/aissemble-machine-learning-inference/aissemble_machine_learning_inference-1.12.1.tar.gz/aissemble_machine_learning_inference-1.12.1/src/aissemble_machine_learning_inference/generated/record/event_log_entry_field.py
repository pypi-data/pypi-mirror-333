...
class EventLogEntryField(Enum):
    ...
    SOURCE_IP_ADDRESS = 0, None, None, None
    CREATED = 1, None, None, None
    KIND = 2, None, None, None
    CATEGORY = 3, None, None, None
    OUTCOME = 4, None, None, None
    ...
    @classmethod
    def get_fields_with_protection_policy(cls) -> List[EventLogEntryField]:
        """
