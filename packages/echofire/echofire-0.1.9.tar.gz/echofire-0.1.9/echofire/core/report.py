            ...
            <div>
                <template x-for="(group, groupName) in groupedTests" :key="groupName">
                    <div class="mb-2">
                        <div @click="toggleGroup(groupName)" class="flex items-center justify-between bg-gray-100 py-1.5 px-2 rounded-t-md border border-gray-200 cursor-pointer hover:bg-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center">
                                    <h2 class="text-base font-medium text-gray-800" x-text="groupName"></h2>
                                    <template x-if="group.length > 0 && group[0].is_ci === 'True'">
                                        <div class="ml-2 inline-flex items-center text-xs bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded-full">CI Environment</div>
                                    </template>
                        ...
                        <div x-show="expandedGroups[groupName]" x-cloak class="overflow-x-auto border-l border-r border-b border-gray-200 rounded-b-md">
                                            ...
                                            <td colspan="6" class="px-0 py-0 border-t border-gray-200">
                                                <div class="mx-3 my-2 p-3 rounded-md shadow-sm bg-white border border-gray-200" :class="{'border-red-200': !test.success}">
                                                    <div class="text-xs text-gray-700">
                                                        ...
                                                        <div class="mt-2">
                                                            <span class="font-semibold text-gray-800">CI Environment:</span>
                                                            <div class="ml-3 mt-1 inline-flex items-center">
                                                                <span x-text="test.is_ci === 'True' ? 'Running in CI' : 'Not running in CI'" 
                                                                    :class="test.is_ci === 'True' ? 'text-blue-600 font-medium' : 'text-gray-600'"></span>
                                                                <span x-show="test.is_ci === 'True'" class="ml-1 text-xs bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded-full">CI</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
