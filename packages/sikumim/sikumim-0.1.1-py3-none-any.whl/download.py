...
def download_files_from_github(course, output_path):
    # Locate the course directory (case-insensitive)
    api_url = "https://api.github.com/repos/Regev32/Sikumim/contents"
...
if __name__ == "__main__":
    ...
    download_files_from_github(args.course, args.path)