...
class ContainerContainerDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "pulp_href", "pulp_last_updated", "hidden", "base_path", "name", "content_guard", "pulp_labels", "no_content_change_since", "pulp_created", "repository", "repository_version", "registry_path", "remote", "namespace", "private", "description"]
