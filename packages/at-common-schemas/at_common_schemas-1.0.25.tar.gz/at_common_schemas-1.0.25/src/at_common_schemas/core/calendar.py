...
class Dividends(BaseSchema):
	...
	record_date: datetime = Field(..., description="Date by which investors must be on company records to receive the dividend")
	payment_date: datetime = Field(..., description="Date when the dividend payment is distributed to shareholders")
	declaration_date: datetime = Field(..., description="Date when the company's board announces the dividend")
