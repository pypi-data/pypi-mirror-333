...
from sdclient.responses import GetDepartmentParentHistoryResponse
...
class SDClient:
    ...
    def get_department_parent_history(
    ...
    ) -> GetDepartmentParentHistoryResponse:
        """
        ...
        return GetDepartmentParentHistoryResponse(
            parents=[
                DepartmentParentHistoryObj.parse_obj(obj) for obj in response.json()
            ]
        )
