# Generated by Django 5.2b1 on 2025-03-12 14:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='rn_tz_abbr_dst', to='vto_time.tzabbreviation')),
                ('std', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='rn_tz_abbr_std', to='vto_time.tzabbreviation')),
            ],
            options={
                'ordering': ['identifier'],
            },
