...
def init_mock_env(params, mock_tag, _logger):
    """初始化mock环境"""
    ...
    if params.get("target_arch") == "mips":
        mips_url = params.get("mips_url", "https://server.kylinos.cn:9031/integration_iso_files/auto_os/script/lorax/mips64el/lorax.cpio")
        cmds.append(
