...
@torch.library.custom_op(
    "cuequivariance_ops_torch::fused_tensor_product_bwd_primitive",
    mutates_args=(),
    device_types="cuda",
)
def _(
...
@torch.library.custom_op(
    "cuequivariance_ops_torch::fused_tensor_product_bwd_bwd_primitive",
    mutates_args=(),
    device_types="cuda",
)
def _(
...
def fused_tensor_product_fwd(*args):
    return torch.ops.cuequivariance_ops_torch.fused_tensor_product_fwd_primitive(*args)
...
def fused_tensor_product_bwd_bwd(ctx, grad_grads):
    ...
    grads = torch.ops.cuequivariance_ops_torch.fused_tensor_product_bwd_bwd_primitive(
        grad_grad_in0,
        grad_grad_in1,
        grad_grad_in2,
        grad_out,
...
def fused_tensor_product_bwd(ctx, grad_output):
    ...
    grads = torch.ops.cuequivariance_ops_torch.fused_tensor_product_bwd_primitive(
        grad_output,
        in0,
        in1,
        in2,
...
class FusedTensorProductOp4(nn.Module):
    ...
    def _opcheck(self, in0: torch.Tensor, in1: torch.Tensor, in2: torch.Tensor):
        torch.library.opcheck(
            torch.ops.cuequivariance_ops_torch.fused_tensor_product_fwd_primitive,
            (
                in0,
                in1,
                in2,
