...
def segmented_transpose_primitive_bwd(ctx, grad_output):
    (segment_info,) = ctx.saved_tensors
    grad_tensor = torch.ops.cuequivariance_ops_torch.segmented_transpose_primitive(
...
torch.library.register_autograd(
    "cuequivariance_ops_torch::segmented_transpose_primitive",
    segmented_transpose_primitive_bwd,
