...
# {
    ...
    # { #TODO this couls be tidier
        ...
        # { 
            if self.param.LCR is not None:
                #get the class specific member vars
                all_vars = self.param.LCR.classes.get('latent_class_1').get('mem_vars')
        ...
        # }
            ...
            while retries < max_retries:
                ...
                if self.param.LCR is not None:
                    all_vars = self.param.LCR.classes.get(f'latent_class_{pick+1}').get('mem_vars')
                ...
                # need a while loop somehow to go becak to pick = np.random.choice    
