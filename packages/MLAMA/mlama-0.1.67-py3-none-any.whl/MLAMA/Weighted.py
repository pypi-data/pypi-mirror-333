...
def find_optimal_weights(data, predictions, delay_list, observed_column_name, models):
    ...
    for length in predictions:
        for delay in delay_list:
            ...
            numeric_columns = combo_data.select_dtypes(include=['number']).columns.tolist()#I made sure in create_prediction_df that Wave is numeric
