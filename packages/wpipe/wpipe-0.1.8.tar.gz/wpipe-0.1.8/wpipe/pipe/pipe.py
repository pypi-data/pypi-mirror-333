        ...
        def ProgressBar(size: int):
            try:
                ...
                with progress_manager as progress_rich:
                    ...
                    # self.worker_name = f"[{self.worker_name}]{self.task_name}"

                    self.accumlate_count[self.worker_name] = 0
                    ...
                    while not progress_rich.finished:
                        ...
                        yield self.accumlate_count[self.worker_name], progress_rich

                        self.accumlate_count[self.worker_name] += 1
