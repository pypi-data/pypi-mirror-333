...
def test_recording_access_properties(valid_recording: Path) -> None:
...
def test_recording_get_meta_data(valid_recording: Recording) -> None:
...
def test_recording_get_track_ids_at_frame(valid_recording: Recording) -> None:
    # Valid frames
...
def test_recording_get_track(valid_recording: Recording) -> None:
    # Valid track_ids
...
def test_recording_get_track_batches(valid_recording: Recording) -> None:
...
def test_recording_get_background_image(valid_recording: Recording) -> None:
    assert valid_recording.get_background_image() is not None


def test_recording_plot_track(valid_recording: Recording) -> None:
    # One track_id
