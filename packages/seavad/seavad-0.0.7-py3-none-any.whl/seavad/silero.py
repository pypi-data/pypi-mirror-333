...
try:
    ...
    logger.warning(
        f"VAD_MODEL_PATH environment variable either not set or not found at {repr(settings.VAD_MODEL_PATH)}. "
        "Set VAD_MODEL_PATH before importing seavad to share the same onnx session between multiple SeaVAD instances."
    )
    ONNX_SESSION = None
