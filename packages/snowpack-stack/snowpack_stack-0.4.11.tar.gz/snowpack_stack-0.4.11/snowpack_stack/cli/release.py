...
def main():
    ...
    check_parser = subparsers.add_parser("check", help="Check if a version exists")
    ...
    if args.command == "release" and hasattr(args, "specific_version") and args.specific_version:
