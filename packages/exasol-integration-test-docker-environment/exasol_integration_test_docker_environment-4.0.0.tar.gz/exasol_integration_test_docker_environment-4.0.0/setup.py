...
['exasol_integration_test_docker_environment',
 ...
 'exasol_integration_test_docker_environment.lib.models',
 'exasol_integration_test_docker_environment.lib.models.config',
 'exasol_integration_test_docker_environment.lib.models.data',
...
{'': ['*'],
 'exasol_integration_test_docker_environment': ['certificate_resources/*',
                                                ...
                                                'docker_db_config/7.1.18/*',
                                                'docker_db_config/7.1.19/*',
                                                'docker_db_config/7.1.2/*',
                                                'docker_db_config/7.1.20/*',
                                                'docker_db_config/7.1.21/*',
                                                'docker_db_config/7.1.22/*',
                                                'docker_db_config/7.1.23/*',
                                                'docker_db_config/7.1.24/*',
                                                'docker_db_config/7.1.25/*',
                                                'docker_db_config/7.1.26/*',
                                                'docker_db_config/7.1.29/*',
                                                'docker_db_config/7.1.3/*',
                                                'docker_db_config/7.1.30/*',
                                                ...
                                                'docker_db_config/8.17.0/*',
                                                'docker_db_config/8.18.1/*',
                                                'docker_db_config/8.20.0/*',
                                                'docker_db_config/8.21.0/*',
                                                'docker_db_config/8.22.0/*',
                                                'docker_db_config/8.23.0/*',
                                                'docker_db_config/8.23.1/*',
                                                'docker_db_config/8.24.0/*',
                                                'docker_db_config/8.25.0/*',
                                                'docker_db_config/8.26.0/*',
                                                'docker_db_config/8.27.0/*',
                                                'docker_db_config/8.29.1/*',
                                                'docker_db_config/8.29.6/*',
                                                'docker_db_config/8.31.0/*',
                                                'templates/*']}
...
extras_require = \
{':sys_platform != "win32"': ['docker>=4.0.0,!=7.0.0']}
