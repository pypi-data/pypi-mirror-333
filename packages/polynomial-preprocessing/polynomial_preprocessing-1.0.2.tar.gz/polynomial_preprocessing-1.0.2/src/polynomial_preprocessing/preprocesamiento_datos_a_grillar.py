...
class PreprocesamientoDatosAGrillar:
	...
	def process_ms_file(self):
		...
		# Caso para cuando el pixel size es None o que el tamaño de pixel sea mayor a la teorica, 
		# porque sino se produce un error.
		if self.pixel_size is None:
			print("El valor de tamaño de pixel no ha sido ingresado o este es mayor al del archivo MS.")
			dx = dataset.theo_resolution / 7
			print("Se usará el valor dado por el archivo MS dividido entre 7: ", dx)
