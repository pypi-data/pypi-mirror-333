...
async def lifespan(app: FastAPI):
    host = os.getenv("HOST", "No definido")
    port = os.getenv("PORT", "No definido")  # Obtiene el puerto desde env
...
if __name__ == "__main__":
    ...
    host = str(host)
    port = int(port)  # O cualquier otro puerto que necesites
    os.environ["HOST"] = host
    os.environ["PORT"] = str(port)  # Guarda el puerto en env
