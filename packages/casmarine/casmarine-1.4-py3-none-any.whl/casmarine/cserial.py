...
Index = enum.IntEnum('Index', [
    ...
    'ControlDataP',
    'ControlTorpedo',
    'JoystickButtonWristRight',
    'JoystickButtonWristLeft',
    'JoystickButtonGripOn',
    'JoystickButtonGripOff',
    'JoystickButtonHome',
    'JoystickButtonPidOn',
    'JoystickButtonPidOff',
    'JoystickButtonControlModeOn',
    'JoystickButtonControlModeOff',
    'ConstantDepth',
    'Baudrate',
    'CRC',
    ], start=0
...
class Protocol():
    ...
    def __init__(self, baud=115200, port='/dev/ttyTHS1') -> None:
        ...
        self.variables = [
                ...
                _Data(Index.ControlTorpedo, 'B'),
                _Data(Index.JoystickButtonWristRight, 'B'),
                _Data(Index.JoystickButtonWristLeft, 'B'),
                _Data(Index.JoystickButtonGripOn, 'B'),
                _Data(Index.JoystickButtonGripOff, 'B'),
                _Data(Index.JoystickButtonHome, 'B'),
                _Data(Index.JoystickButtonPidOn, 'B'),
                _Data(Index.JoystickButtonPidOff, 'B'),
                _Data(Index.JoystickButtonControlModeOn,'B'),
                _Data(Index.JoystickButtonControlModeOff,'B'),
                _Data(Index.ConstantDepth, 'h'),
